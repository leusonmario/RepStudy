...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + (-1L) + "'", long6 == (-1L));
    ...
    public void test14005() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-25119");
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36051" + "'", str3, "HikariPool-36051");
...
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + (-1L) + "'", long19 == (-1L));
    ...
    public void test14009() throws Throwable {
        ...
        boolean boolean39 = hikariConfig18.isRegisterMbeans();
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer40 = null;
        hikariConfig18.connectionCustomizer = iConnectionCustomizer40;
        java.util.Properties properties42 = hikariConfig18.getDataSourceProperties();
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 100L + "'", long6 == 100L);
    ...
    public void test14012() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-1535");
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36075" + "'", str3, "HikariPool-36075");
        org.junit.Assert.assertNull(dataSource14);
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 32L + "'", long19 == 32L);
        org.junit.Assert.assertNotNull(properties20);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
...
// flaky:         org.junit.Assert.assertTrue("'" + long43 + "' != '" + 32L + "'", long43 == 32L);
    ...
    public void test14023() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-23484");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-23484' could not be loaded");
...
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + (-1L) + "'", long22 == (-1L));
    ...
    public void test14025() throws Throwable {
        ...
        hikariConfig0.catalog = "HikariPool-558";
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
    ...
    public void test14027() throws Throwable {
        ...
        boolean boolean16 = hikariConfig0.isReadOnly;
        hikariConfig0.setJdbcUrl("HikariPool-2982");
        javax.sql.DataSource dataSource19 = null;
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36097" + "'", str3, "HikariPool-36097");
        org.junit.Assert.assertNull(dataSource14);
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 32L + "'", long19 == 32L);
        org.junit.Assert.assertNotNull(properties20);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
    ...
    public void test14039() throws Throwable {
        ...
        long long36 = hikariConfig19.getMaxLifetime();
        ...
        java.util.Properties properties43 = hikariConfig19.dataSourceProperties;
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 32L + "'", long11 == 32L);
    ...
    public void test14042() throws Throwable {
        ...
        hikariConfig0.setAutoCommit(true);
        hikariConfig0.isIsolateInternalQueries = true;
        hikariConfig0.poolName = "HikariPool-4205";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertNotNull(properties9);
        org.junit.Assert.assertNull(str12);
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 100L + "'", long16 == 100L);
    ...
    public void test14048() throws Throwable {
        ...
        hikariConfig17.setDataSourceClassName("HikariPool-8555");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(iConnectionCustomizer6);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 32L + "'", long13 == 32L);
        org.junit.Assert.assertNull(str14);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-36123" + "'", str15, "HikariPool-36123");
        org.junit.Assert.assertNull(dataSource18);
    ...
    public void test14049() throws Throwable {
        ...
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "HikariPool-66" + "'", str33, "HikariPool-66");
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 100L + "'", long11 == 100L);
    ...
    public void test14051() throws Throwable {
        ...
        hikariConfig21.acquireIncrement = 0;
        long long25 = hikariConfig21.getLeakDetectionThreshold();
        long long26 = hikariConfig21.idleTimeout;
        long long27 = hikariConfig21.leakDetectionThreshold;
        hikariConfig21.setJdbc4ConnectionTest(false);
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer30 = null;
        hikariConfig21.connectionCustomizer = iConnectionCustomizer30;
        long long32 = hikariConfig21.idleTimeout;
        hikariConfig0.addDataSourceProperty("HikariPool-12366", (java.lang.Object) hikariConfig21);
        long long34 = hikariConfig21.idleTimeout;
        org.junit.Assert.assertNull(iConnectionCustomizer3);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-36131" + "'", str13, "HikariPool-36131");
        org.junit.Assert.assertNull(dataSource14);
...
// flaky:         org.junit.Assert.assertTrue("'" + long34 + "' != '" + (-1L) + "'", long34 == (-1L));
    ...
    public void test14052() throws Throwable {
        ...
        hikariConfig0.setJdbc4ConnectionTest(false);
        hikariConfig0.poolName = "HikariPool-2112";
    ...
    public void test14053() throws Throwable {
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-2235", (java.lang.Object) true);
        hikariConfig0.idleTimeout = 1L;
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(iConnectionCustomizer6);
        org.junit.Assert.assertNull(str7);
    ...
    public void test14055() throws Throwable {
        ...
        boolean boolean15 = hikariConfig0.isReadOnly;
        hikariConfig0.isRegisterMbeans = false;
        hikariConfig0.connectionInitSql = "HikariPool-12039";
        org.junit.Assert.assertNull(dataSource1);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
    ...
    public void test14056() throws Throwable {
        ...
        hikariConfig0.transactionIsolationName = "HikariPool-2385";
        org.junit.Assert.assertNull(str1);
    ...
    public void test14058() throws Throwable {
        ...
        long long30 = hikariConfig8.maxLifetime;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 60 + "'", int3 == 60);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 0L + "'", long4 == 0L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + (-1L) + "'", long22 == (-1L));
    ...
    public void test14066() throws Throwable {
        ...
        int int36 = hikariConfig35.getMinimumPoolSize();
        java.lang.String str37 = hikariConfig35.getConnectionCustomizerClassName();
        long long38 = hikariConfig35.getConnectionTimeout();
        int int39 = hikariConfig35.minPoolSize;
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 32L + "'", long12 == 32L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
    ...
    public void test14070() throws Throwable {
        ...
        boolean boolean4 = hikariConfig0.isAutoCommit;
        hikariConfig0.setTransactionIsolation("HikariPool-1172");
        boolean boolean7 = hikariConfig0.isInitializationFailFast();
        org.junit.Assert.assertNull(dataSource1);
// flaky:         org.junit.Assert.assertEquals("'" + str2 + "' != '" + "HikariPool-36168" + "'", str2, "HikariPool-36168");
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + (-1L) + "'", long6 == (-1L));
    ...
    public void test14072() throws Throwable {
        ...
        hikariConfig0.setUseInstrumentation(false);
        hikariConfig0.setConnectionInitSql("HikariPool-34197");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 10 + "'", int11 == 10);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 32L + "'", long12 == 32L);
    ...
    public void test14075() throws Throwable {
        ...
        hikariConfig0.acquireRetries = 0;
        boolean boolean7 = hikariConfig0.isInitializationFailFast();
        hikariConfig0.setJdbcUrl("HikariPool-3415");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + false + "'", boolean7 == false);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 100L + "'", long19 == 100L);
        org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-1067" + "'", str20, "HikariPool-1067");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long57 + "' != '" + 32L + "'", long57 == 32L);
    ...
    public void test14083() throws Throwable {
        ...
        long long35 = hikariConfig23.getMaxLifetime();
        ...
        hikariConfig23.connectionCustomizer = iConnectionCustomizer58;
        java.lang.String str60 = hikariConfig23.getJdbcUrl();
        hikariConfig23.setCatalog("HikariPool-491");
        hikariConfig23.setJdbc4ConnectionTest(true);
        hikariConfig23.idleTimeout = 97;
        java.util.Properties properties67 = hikariConfig23.dataSourceProperties;
        ...
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 60 + "'", int8 == 60);
        org.junit.Assert.assertNull(str9);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-36199" + "'", str10, "HikariPool-36199");
...
// flaky:         org.junit.Assert.assertTrue("'" + long27 + "' != '" + 100L + "'", long27 == 100L);
    ...
    public void test14085() throws Throwable {
        ...
        long long56 = hikariConfig0.maxLifetime;
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertNull(str18);
        org.junit.Assert.assertNull(dataSource24);
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
        org.junit.Assert.assertNotNull(properties10);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-36214" + "'", str14, "HikariPool-36214");
        org.junit.Assert.assertNull(str17);
        org.junit.Assert.assertNull(dataSource19);
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 32L + "'", long17 == 32L);
        org.junit.Assert.assertNull(str27);
        org.junit.Assert.assertEquals("'" + str32 + "' != '" + "HikariPool-73" + "'", str32, "HikariPool-73");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long4 + "' != '" + (-1L) + "'", long4 == (-1L));
    ...
    public void test14100() throws Throwable {
        ...
        javax.sql.DataSource dataSource22 = null;
        hikariConfig0.setDataSource(dataSource22);
        hikariConfig0.connectionCustomizerClassName = "HikariPool-5663";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 60 + "'", int12 == 60);
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + (-1L) + "'", long13 == (-1L));
    ...
    public void test14101() throws Throwable {
        ...
        boolean boolean37 = hikariConfig7.isIsolateInternalQueries();
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertNull(dataSource8);
...
// flaky:         org.junit.Assert.assertTrue("'" + long18 + "' != '" + (-1L) + "'", long18 == (-1L));
    ...
    public void test14104() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-7818");
...
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 100L + "'", long15 == 100L);
    ...
    public void test14105() throws Throwable {
        ...
        boolean boolean3 = hikariConfig0.isIsolateInternalQueries;
        hikariConfig0.maxPoolSize = 1;
        hikariConfig0.setPoolName("HikariPool-28489");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
    }
    ...
    public void test14107() throws Throwable {
        ...
        hikariConfig26.connectionCustomizer = iConnectionCustomizer33;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 60 + "'", int3 == 60);
// flaky:         org.junit.Assert.assertTrue("'" + long4 + "' != '" + (-1L) + "'", long4 == (-1L));
...
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + 32L + "'", long22 == 32L);
    ...
    public void test14108() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertNull(str10);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-36269" + "'", str13, "HikariPool-36269");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 100L + "'", long9 == 100L);
    ...
    public void test14119() throws Throwable {
        ...
        java.lang.String str14 = hikariConfig0.getPoolName();
        long long15 = hikariConfig0.getAcquireRetryDelay();
        hikariConfig0.setConnectionTestQuery("HikariPool-6641");
        org.junit.Assert.assertNull(dataSource4);
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
        org.junit.Assert.assertNotNull(properties10);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-36288" + "'", str14, "HikariPool-36288");
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 100L + "'", long15 == 100L);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long25 + "' != '" + 100L + "'", long25 == 100L);
    ...
    public void test14122() throws Throwable {
        ...
        hikariConfig13.transactionIsolationName = "hi!";
        hikariConfig13.connectionTestQuery = "HikariPool-184";
        com.zaxxer.hikari.HikariConfig hikariConfig23 = new com.zaxxer.hikari.HikariConfig();
        javax.sql.DataSource dataSource24 = hikariConfig23.getDataSource();
        hikariConfig23.setConnectionTestQuery("");
        hikariConfig23.connectionCustomizerClassName = "";
        ...
        hikariConfig23.acquireIncrement = 'a';
        ...
        int int51 = hikariConfig0.transactionIsolation;
        hikariConfig0.leakDetectionThreshold = 97L;
        org.junit.Assert.assertNull(iConnectionCustomizer3);
// flaky:         org.junit.Assert.assertTrue("'" + long8 + "' != '" + 100L + "'", long8 == 100L);
    ...
    public void test14123() throws Throwable {
        ...
        hikariConfig0.isIsolateInternalQueries = true;
        hikariConfig0.connectionTestQuery = "HikariPool-36065";
        org.junit.Assert.assertNull(iConnectionCustomizer3);
...
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 32L + "'", long15 == 32L);
    ...
    public void test14124() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-3259");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 32L + "'", long12 == 32L);
    ...
    public void test14127() throws Throwable {
        ...
        hikariConfig0.dataSourceClassName = "HikariPool-29352";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 60 + "'", int8 == 60);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + false + "'", boolean13 == false);
        org.junit.Assert.assertNull(str14);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-36304" + "'", str15, "HikariPool-36304");
// flaky:         org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-36304" + "'", str18, "HikariPool-36304");
        org.junit.Assert.assertNull(str19);
    }
    ...
    public void test14128() throws Throwable {
        ...
        hikariConfig7.jdbcUrl = "";
        hikariConfig7.setMaxLifetime(0L);
        hikariConfig7.setTransactionIsolation("HikariPool-48");
        com.zaxxer.hikari.HikariConfig hikariConfig17 = new com.zaxxer.hikari.HikariConfig();
        ...
        long long31 = hikariConfig30.acquireRetryDelay;
        java.util.Properties properties32 = hikariConfig30.getDataSourceProperties();
        hikariConfig0.setDataSourceProperties(properties32);
        hikariConfig0.setTransactionIsolation("HikariPool-655");
        int int36 = hikariConfig0.acquireRetries;
        org.junit.Assert.assertNull(iConnectionCustomizer3);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-36307" + "'", str10, "HikariPool-36307");
        org.junit.Assert.assertNull(dataSource21);
// flaky:         org.junit.Assert.assertTrue("'" + long26 + "' != '" + 32L + "'", long26 == 32L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long31 + "' != '" + 100L + "'", long31 == 100L);
    ...
    public void test14129() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertNull(str14);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-36321" + "'", str15, "HikariPool-36321");
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 32L + "'", long17 == 32L);
    ...
    public void test14132() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-3874");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(dataSource8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 1 + "'", int12 == 1);
    ...
    public void test14134() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertEquals("'" + str17 + "' != '" + "hi!" + "'", str17, "hi!");
// flaky:         org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-36327" + "'", str20, "HikariPool-36327");
        org.junit.Assert.assertNull(dataSource22);
    ...
    public void test14135() throws Throwable {
        ...
        long long27 = hikariConfig7.leakDetectionThreshold;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertNull(dataSource8);
...
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + 32L + "'", long21 == 32L);
    ...
    public void test14138() throws Throwable {
        ...
        hikariConfig31.poolName = "HikariPool-28739";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertNull(dataSource10);
        org.junit.Assert.assertNull(str17);
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36340" + "'", str3, "HikariPool-36340");
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 0L + "'", long10 == 0L);
        org.junit.Assert.assertNull(str11);
        org.junit.Assert.assertNull(str20);
    }
    ...
    public void test14140() throws Throwable {
        ...
        hikariConfig0.poolName = "HikariPool-3139";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 60 + "'", int8 == 60);
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 32L + "'", long11 == 32L);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + (-1L) + "'", long6 == (-1L));
    ...
    public void test14145() throws Throwable {
        ...
        hikariConfig0.transactionIsolationName = "HikariPool-11506";
        org.junit.Assert.assertNull(dataSource1);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
        org.junit.Assert.assertNull(dataSource12);
        org.junit.Assert.assertNull(str19);
    ...
    public void test14146() throws Throwable {
        ...
        long long25 = hikariConfig0.getAcquireRetryDelay();
        java.lang.String str26 = hikariConfig0.connectionCustomizerClassName;
        hikariConfig0.dataSourceClassName = "HikariPool-29694";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(dataSource9);
        org.junit.Assert.assertNull(str16);
        org.junit.Assert.assertNotNull(properties17);
// flaky:         org.junit.Assert.assertTrue("'" + long25 + "' != '" + 100L + "'", long25 == 100L);
    ...
    public void test14147() throws Throwable {
        ...
        boolean boolean67 = hikariConfig0.isJdbc4connectionTest;
        org.junit.Assert.assertNull(dataSource1);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
        org.junit.Assert.assertNotNull(properties7);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + true + "'", boolean8 == true);
...
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + (-1L) + "'", long21 == (-1L));
    ...
    public void test14153() throws Throwable {
        ...
        hikariConfig0.isRegisterMbeans = false;
        int int54 = hikariConfig0.minPoolSize;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 100L + "'", long16 == 100L);
    ...
    public void test14155() throws Throwable {
        ...
        hikariConfig0.connectionTestQuery = "HikariPool-10198";
        hikariConfig0.setUseInstrumentation(false);
        org.junit.Assert.assertNull(dataSource4);
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
        org.junit.Assert.assertNotNull(properties10);
        org.junit.Assert.assertNull(str12);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-36371" + "'", str13, "HikariPool-36371");
        org.junit.Assert.assertNull(str14);
    }
    ...
    public void test14156() throws Throwable {
        ...
        javax.sql.DataSource dataSource22 = null;
        hikariConfig0.setDataSource(dataSource22);
        hikariConfig0.setCatalog("HikariPool-8632");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(dataSource9);
        org.junit.Assert.assertNull(str16);
        org.junit.Assert.assertNotNull(properties17);
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 100L + "'", long14 == 100L);
    ...
    public void test14159() throws Throwable {
        ...
        hikariConfig0.poolName = "HikariPool-369";
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
    ...
    public void test14162() throws Throwable {
        ...
        long long17 = hikariConfig13.connectionTimeout;
...
// flaky:         org.junit.Assert.assertEquals("'" + str45 + "' != '" + "HikariPool-36388" + "'", str45, "HikariPool-36388");
    ...
    public void test14167() throws Throwable {
        ...
        hikariConfig0.connectionCustomizerClassName = "HikariPool-25644";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
        org.junit.Assert.assertNull(str8);
...
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-36393" + "'", str7, "HikariPool-36393");
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
    }
    ...
    public void test14170() throws Throwable {
        ...
        hikariConfig0.transactionIsolationName = "HikariPool-26676";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 60 + "'", int12 == 60);
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + (-1L) + "'", long13 == (-1L));
        org.junit.Assert.assertTrue("'" + long16 + "' != '" + 0L + "'", long16 == 0L);
    ...
    public void test14174() throws Throwable {
        ...
        javax.sql.DataSource dataSource12 = null;
        hikariConfig0.dataSource = dataSource12;
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-1425");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertNull(str8);
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 100L + "'", long10 == 100L);
    ...
    public void test14175() throws Throwable {
        ...
        hikariConfig7.idleTimeout = '#';
        boolean boolean35 = hikariConfig7.isReadOnly;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertNull(dataSource8);
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 32L + "'", long17 == 32L);
    ...
    public void test14176() throws Throwable {
        ...
        hikariConfig0.connectionTimeout = 0L;
        boolean boolean69 = hikariConfig0.isRegisterMbeans;
        java.lang.String str70 = hikariConfig0.getDataSourceClassName();
        org.junit.Assert.assertNull(dataSource4);
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
        org.junit.Assert.assertNotNull(properties10);
        org.junit.Assert.assertNull(str12);
...
// flaky:         org.junit.Assert.assertTrue("'" + long38 + "' != '" + 32L + "'", long38 == 32L);
    ...
    public void test14177() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-36412" + "'", str18, "HikariPool-36412");
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + 3 + "'", int19 == 3);
        org.junit.Assert.assertTrue("'" + boolean20 + "' != '" + false + "'", boolean20 == false);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 100L + "'", long12 == 100L);
    ...
    public void test14181() throws Throwable {
        ...
        hikariConfig0.setUseInstrumentation(true);
        hikariConfig0.isInitializationFailFast = true;
        hikariConfig0.setTransactionIsolation("HikariPool-591");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertNull(str6);
    }
    ...
    public void test14182() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + false + "'", boolean13 == false);
        org.junit.Assert.assertNull(str14);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-36423" + "'", str15, "HikariPool-36423");
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + 1 + "'", int19 == 1);
// flaky:         org.junit.Assert.assertTrue("'" + long24 + "' != '" + 32L + "'", long24 == 32L);
    ...
    public void test14183() throws Throwable {
        ...
        hikariConfig0.isAutoCommit = false;
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36427" + "'", str3, "HikariPool-36427");
        org.junit.Assert.assertNull(dataSource14);
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 32L + "'", long19 == 32L);
        org.junit.Assert.assertNotNull(properties20);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
    ...
    public void test14193() throws Throwable {
        ...
        hikariConfig7.dataSourceClassName = "HikariPool-30044";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertNull(dataSource8);
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 32L + "'", long17 == 32L);
    ...
    public void test14194() throws Throwable {
        ...
        java.lang.String str17 = hikariConfig0.getCatalog();
        hikariConfig0.acquireRetryDelay = (byte) -1;
        hikariConfig0.setJdbcUrl("HikariPool-4970");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertNotNull(properties9);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 10 + "'", int10 == 10);
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36458" + "'", str3, "HikariPool-36458");
        org.junit.Assert.assertNull(dataSource14);
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 32L + "'", long19 == 32L);
        org.junit.Assert.assertNotNull(properties20);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + (-1L) + "'", long10 == (-1L));
    ...
    public void test14199() throws Throwable {
        ...
        hikariConfig0.setIsolateInternalQueries(true);
        hikariConfig0.connectionInitSql = "HikariPool-16868";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 32L + "'", long12 == 32L);
    ...
    public void test14200() throws Throwable {
        ...
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertNull(str17);
// flaky:         org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-36467" + "'", str18, "HikariPool-36467");
        org.junit.Assert.assertTrue("'" + boolean21 + "' != '" + false + "'", boolean21 == false);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long45 + "' != '" + 100L + "'", long45 == 100L);
    ...
    public void test14202() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-538");
        boolean boolean12 = hikariConfig0.isInitializationFailFast();
        hikariConfig0.setDataSourceClassName("HikariPool-2947");
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + (-1L) + "'", long6 == (-1L));
    ...
    public void test14208() throws Throwable {
        ...
        hikariConfig12.setMaximumPoolSize(60);
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + (-1L) + "'", long11 == (-1L));
    ...
    public void test14212() throws Throwable {
        ...
        hikariConfig0.isRegisterMbeans = false;
        java.util.Properties properties15 = hikariConfig0.dataSourceProperties;
        hikariConfig0.poolName = "HikariPool-34807";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertNull(dataSource10);
    ...
    public void test14213() throws Throwable {
        ...
        hikariConfig0.isJdbc4connectionTest = false;
        hikariConfig0.setJdbcUrl("HikariPool-2482");
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36492" + "'", str3, "HikariPool-36492");
        org.junit.Assert.assertNull(dataSource14);
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 32L + "'", long19 == 32L);
        org.junit.Assert.assertNotNull(properties20);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
    ...
    public void test14214() throws Throwable {
        ...
        hikariConfig0.setInitializationFailFast(false);
        java.lang.String str39 = hikariConfig0.connectionInitSql;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertNull(dataSource8);
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 32L + "'", long17 == 32L);
        ...
        org.junit.Assert.assertEquals("'" + str39 + "' != '" + "HikariPool-593" + "'", str39, "HikariPool-593");
    }
    ...
    public void test14215() throws Throwable {
        ...
        hikariConfig0.transactionIsolationName = "HikariPool-389";
        hikariConfig0.isJdbc4connectionTest = false;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + (-1L) + "'", long6 == (-1L));
    ...
    public void test14216() throws Throwable {
        ...
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + true + "'", boolean13 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-36500" + "'", str14, "HikariPool-36500");
        org.junit.Assert.assertNull(str15);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 32L + "'", long17 == 32L);
    ...
    public void test14218() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + false + "'", boolean11 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-36503" + "'", str12, "HikariPool-36503");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 32L + "'", long7 == 32L);
    ...
    public void test14223() throws Throwable {
        ...
        hikariConfig0.poolName = "HikariPool-14785";
        hikariConfig0.dataSourceClassName = "HikariPool-2418";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 3 + "'", int4 == 3);
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36514" + "'", str3, "HikariPool-36514");
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 0L + "'", long10 == 0L);
        org.junit.Assert.assertNull(str11);
        org.junit.Assert.assertNull(str16);
        org.junit.Assert.assertNull(str17);
        ...
        org.junit.Assert.assertNull(str23);
// flaky:         org.junit.Assert.assertTrue("'" + long26 + "' != '" + 32L + "'", long26 == 32L);
// flaky:         org.junit.Assert.assertEquals("'" + str27 + "' != '" + "HikariPool-36514" + "'", str27, "HikariPool-36514");
    }
    ...
    public void test14225() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-20794");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 1 + "'", int7 == 1);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 1 + "'", int8 == 1);
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 32L + "'", long10 == 32L);
    ...
    public void test14227() throws Throwable {
        ...
        hikariConfig0.connectionInitSql = "HikariPool-1207";
        org.junit.Assert.assertNull(dataSource4);
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
        org.junit.Assert.assertNotNull(properties10);
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + false + "'", boolean12 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-36519" + "'", str13, "HikariPool-36519");
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
        org.junit.Assert.assertNotNull(properties10);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-36521" + "'", str14, "HikariPool-36521");
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + (-1) + "'", int17 == (-1));
        org.junit.Assert.assertNotNull(properties18);
        org.junit.Assert.assertNull(str19);
        org.junit.Assert.assertNull(str20);
    ...
    public void test14229() throws Throwable {
        ...
        int int8 = hikariConfig0.acquireIncrement;
        long long9 = hikariConfig0.acquireRetryDelay;
        hikariConfig0.setTransactionIsolation("HikariPool-26266");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 1 + "'", int8 == 1);
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 100L + "'", long9 == 100L);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 32L + "'", long7 == 32L);
    ...
    public void test14232() throws Throwable {
        ...
        hikariConfig0.leakDetectionThreshold = (byte) 0;
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-4326");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertNotNull(properties9);
        org.junit.Assert.assertNull(str12);
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 100L + "'", long16 == 100L);
    ...
    public void test14233() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig48.setAcquireIncrement((int) (short) -1);
...
// flaky:         org.junit.Assert.assertTrue("'" + long4 + "' != '" + 100L + "'", long4 == 100L);
    ...
    public void test14238() throws Throwable {
        ...
        hikariConfig0.dataSourceClassName = "HikariPool-10944";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertNull(str4);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + (-1) + "'", int5 == (-1));
        org.junit.Assert.assertNotNull(properties6);
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 32L + "'", long11 == 32L);
    ...
    public void test14249() throws Throwable {
        ...
        hikariConfig0.setDataSourceClassName("HikariPool-18069");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertTrue("'" + boolean22 + "' != '" + false + "'", boolean22 == false);
    ...
    public void test14250() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-33551");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-33551 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test14251() throws Throwable {
        ...
        hikariConfig0.setAcquireRetries((int) (short) 100);
        hikariConfig0.connectionInitSql = "HikariPool-440";
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 32L + "'", long11 == 32L);
    ...
    public void test14253() throws Throwable {
        ...
        hikariConfig0.minPoolSize = (short) 10;
        hikariConfig0.setDataSourceClassName("HikariPool-14340");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 1 + "'", int5 == 1);
    }
    ...
    public void test14254() throws Throwable {
        ...
        java.lang.String str53 = hikariConfig50.getPoolName();
        hikariConfig50.jdbcUrl = "";
        hikariConfig50.setMaxLifetime(0L);
        hikariConfig50.setTransactionIsolation("HikariPool-48");
        ...
        hikariConfig50.setDataSourceProperties(properties70);
        java.lang.String str73 = hikariConfig50.getJdbcUrl();
        javax.sql.DataSource dataSource74 = hikariConfig50.dataSource;
        java.util.Properties properties75 = hikariConfig50.dataSourceProperties;
        java.util.Properties properties76 = hikariConfig50.dataSourceProperties;
        hikariConfig50.addDataSourceProperty("HikariPool-1175", (java.lang.Object) "HikariPool-775");
        boolean boolean80 = hikariConfig50.isReadOnly;
        boolean boolean81 = hikariConfig50.isRegisterMbeans();
        hikariConfig50.connectionCustomizerClassName = "HikariPool-1422";
        hikariConfig42.addDataSourceProperty("HikariPool-86", (java.lang.Object) "HikariPool-1422");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertNull(iConnectionCustomizer2);
        org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-141" + "'", str7, "HikariPool-141");
        org.junit.Assert.assertNull(dataSource11);
        ...
        org.junit.Assert.assertNotNull(properties40);
// flaky:         org.junit.Assert.assertEquals("'" + str45 + "' != '" + "HikariPool-36575" + "'", str45, "HikariPool-36575");
        org.junit.Assert.assertTrue("'" + boolean48 + "' != '" + false + "'", boolean48 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str53 + "' != '" + "HikariPool-36576" + "'", str53, "HikariPool-36576");
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + (-1L) + "'", long13 == (-1L));
    ...
    public void test14257() throws Throwable {
        ...
        hikariConfig0.idleTimeout = 97L;
        hikariConfig0.setLeakDetectionThreshold((long) ' ');
        hikariConfig0.transactionIsolationName = "HikariPool-6643";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertNotNull(properties9);
        org.junit.Assert.assertNull(str12);
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 100L + "'", long16 == 100L);
    ...
    public void test14258() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-23880");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-23880 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36592" + "'", str3, "HikariPool-36592");
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 0L + "'", long10 == 0L);
        org.junit.Assert.assertNull(str11);
        org.junit.Assert.assertNull(str14);
    ...
    public void test14265() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig42.setConnectionTimeout((long) 10);
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 100L + "'", long10 == 100L);
        ...
        org.junit.Assert.assertTrue("'" + boolean25 + "' != '" + false + "'", boolean25 == false);
        org.junit.Assert.assertNull(str26);
// flaky:         org.junit.Assert.assertEquals("'" + str27 + "' != '" + "HikariPool-36594" + "'", str27, "HikariPool-36594");
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 100L + "'", long14 == 100L);
    ...
    public void test14273() throws Throwable {
        ...
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str6);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-36611" + "'", str11, "HikariPool-36611");
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 100L + "'", long9 == 100L);
    ...
    public void test14280() throws Throwable {
        ...
        hikariConfig0.connectionTestQuery = "HikariPool-3671";
        boolean boolean17 = hikariConfig0.isIsolateInternalQueries();
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36632" + "'", str3, "HikariPool-36632");
        org.junit.Assert.assertNull(dataSource14);
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 32L + "'", long19 == 32L);
        org.junit.Assert.assertNotNull(properties20);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
...
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 100L + "'", long10 == 100L);
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + true + "'", boolean17 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-36646" + "'", str18, "HikariPool-36646");
        org.junit.Assert.assertTrue("'" + boolean19 + "' != '" + false + "'", boolean19 == false);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
    ...
    public void test14295() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-499");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 60 + "'", int3 == 60);
// flaky:         org.junit.Assert.assertTrue("'" + long4 + "' != '" + 100L + "'", long4 == 100L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + 100L + "'", long21 == 100L);
    ...
    public void test14298() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-18679");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-18679 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36658" + "'", str3, "HikariPool-36658");
        org.junit.Assert.assertNull(dataSource14);
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 32L + "'", long19 == 32L);
        org.junit.Assert.assertNotNull(properties20);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
    ...
    public void test14301() throws Throwable {
        ...
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long12 + "' != '" + 97L + "'", long12 == 97L);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-36661" + "'", str15, "HikariPool-36661");
        org.junit.Assert.assertNotNull(properties16);
    }
    ...
    public void test14302() throws Throwable {
        ...
        hikariConfig0.connectionCustomizerClassName = "HikariPool-877";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertNull(str8);
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 100L + "'", long9 == 100L);
    ...
    public void test14303() throws Throwable {
        ...
        hikariConfig0.transactionIsolationName = "HikariPool-196";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 32L + "'", long12 == 32L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long37 + "' != '" + (-1L) + "'", long37 == (-1L));
    ...
    public void test14305() throws Throwable {
        ...
        hikariConfig0.setLeakDetectionThreshold((long) (short) 1);
        hikariConfig0.maxLifetime = 10L;
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36670" + "'", str3, "HikariPool-36670");
// flaky:         org.junit.Assert.assertTrue("'" + long4 + "' != '" + 32L + "'", long4 == 32L);
    ...
    public void test14306() throws Throwable {
        ...
        javax.sql.DataSource dataSource41 = hikariConfig0.getDataSource();
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-36674" + "'", str13, "HikariPool-36674");
        org.junit.Assert.assertNull(dataSource24);
// flaky:         org.junit.Assert.assertTrue("'" + long29 + "' != '" + 32L + "'", long29 == 32L);
    ...
    public void test14307() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-173");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-173' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertNull(dataSource1);
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
    ...
    public void test14315() throws Throwable {
        ...
        boolean boolean92 = hikariConfig0.isAutoCommit();
        hikariConfig0.isReadOnly = true;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 1 + "'", int5 == 1);
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 32L + "'", long11 == 32L);
    ...
    public void test14317() throws Throwable {
        ...
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer3 = hikariConfig0.connectionCustomizer;
        hikariConfig0.setDataSourceClassName("HikariPool-5150");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertNull(str2);
        org.junit.Assert.assertNull(iConnectionCustomizer3);
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-36713" + "'", str9, "HikariPool-36713");
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36714" + "'", str3, "HikariPool-36714");
        org.junit.Assert.assertNull(dataSource14);
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 32L + "'", long19 == 32L);
        org.junit.Assert.assertNotNull(properties20);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
    ...
    public void test14322() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-4613");
        int int24 = hikariConfig0.getMinimumPoolSize();
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
    ...
    public void test14326() throws Throwable {
        ...
        hikariConfig0.dataSourceClassName = "HikariPool-25300";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 60 + "'", int12 == 60);
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + (-1L) + "'", long13 == (-1L));
        org.junit.Assert.assertNull(dataSource14);
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 32L + "'", long12 == 32L);
    ...
    public void test14330() throws Throwable {
        ...
        hikariConfig0.connectionTestQuery = "HikariPool-1029";
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 32L + "'", long12 == 32L);
        ...
        org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-1092" + "'", str20, "HikariPool-1092");
    }
    ...
    public void test14332() throws Throwable {
        ...
        java.util.Properties properties9 = hikariConfig0.dataSourceProperties;
        hikariConfig0.isReadOnly = true;
        hikariConfig0.setDataSourceClassName("HikariPool-22601");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + (-1L) + "'", long6 == (-1L));
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 32L + "'", long14 == 32L);
    ...
    public void test14334() throws Throwable {
        ...
        hikariConfig0.setIdleTimeout(0L);
        boolean boolean11 = hikariConfig0.isInitializationFailFast;
        hikariConfig0.transactionIsolationName = "HikariPool-1172";
        boolean boolean14 = hikariConfig0.isAutoCommit;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long8 + "' != '" + 0L + "'", long8 == 0L);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + false + "'", boolean11 == false);
    ...
    public void test14335() throws Throwable {
        ...
        hikariConfig0.isInitializationFailFast = false;
        boolean boolean26 = hikariConfig0.isRegisterMbeans;
        hikariConfig0.setDataSourceClassName("HikariPool-29236");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertNotNull(properties9);
        org.junit.Assert.assertNull(str12);
...
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-36740" + "'", str7, "HikariPool-36740");
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 0L + "'", long10 == 0L);
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 1 + "'", int13 == 1);
        org.junit.Assert.assertTrue("'" + int16 + "' != '" + 60 + "'", int16 == 60);
...
// flaky:         org.junit.Assert.assertTrue("'" + long23 + "' != '" + (-1L) + "'", long23 == (-1L));
    ...
    public void test14338() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-2084");
...
// flaky:         org.junit.Assert.assertTrue("'" + long33 + "' != '" + (-1L) + "'", long33 == (-1L));
    ...
    public void test14339() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-36670");
        org.junit.Assert.assertNull(dataSource4);
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
        org.junit.Assert.assertNotNull(properties10);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + (-1L) + "'", long13 == (-1L));
    ...
    public void test14342() throws Throwable {
        ...
        java.lang.String str20 = hikariConfig0.dataSourceClassName;
        boolean boolean21 = hikariConfig0.isRegisterMbeans;
        hikariConfig0.jdbcUrl = "HikariPool-5741";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
    ...
    public void test14347() throws Throwable {
        ...
        int int21 = hikariConfig0.getTransactionIsolation();
        hikariConfig0.setUseInstrumentation(true);
        hikariConfig0.setJdbcUrl("HikariPool-24019");
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
    ...
    public void test14353() throws Throwable {
        ...
        hikariConfig0.poolName = "HikariPool-577";
        hikariConfig0.setTransactionIsolation("");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 32L + "'", long7 == 32L);
    ...
    public void test14354() throws Throwable {
        ...
        int int6 = hikariConfig0.maxPoolSize;
        hikariConfig0.setRegisterMbeans(false);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-30326");
        org.junit.Assert.assertNull(str1);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + (-1L) + "'", long6 == (-1L));
    ...
    public void test14357() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 1 + "'", int5 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-36772" + "'", str10, "HikariPool-36772");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 32L + "'", long15 == 32L);
    ...
    public void test14360() throws Throwable {
        ...
        hikariConfig0.connectionCustomizerClassName = "HikariPool-3362";
        java.lang.String str25 = hikariConfig0.connectionCustomizerClassName;
        hikariConfig0.connectionTestQuery = "HikariPool-22278";
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + (-1L) + "'", long22 == (-1L));
    ...
    public void test14361() throws Throwable {
        ...
        hikariConfig0.isInitializationFailFast = false;
        boolean boolean13 = hikariConfig0.isIsolateInternalQueries;
        hikariConfig0.setConnectionInitSql("HikariPool-25105");
        org.junit.Assert.assertNull(iConnectionCustomizer3);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-18" + "'", str9, "HikariPool-18");
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
...
// flaky:         org.junit.Assert.assertEquals("'" + str30 + "' != '" + "HikariPool-36779" + "'", str30, "HikariPool-36779");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + (-1L) + "'", long15 == (-1L));
    ...
    public void test14364() throws Throwable {
        ...
        hikariConfig9.acquireRetries = 32;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertNotNull(properties8);
...
// flaky:         org.junit.Assert.assertTrue("'" + long8 + "' != '" + 100L + "'", long8 == 100L);
    ...
    public void test14372() throws Throwable {
        ...
        java.lang.String str12 = hikariConfig0.jdbcUrl;
        hikariConfig0.acquireRetryDelay = (byte) 1;
        hikariConfig0.connectionCustomizerClassName = "HikariPool-4472";
        hikariConfig0.setConnectionInitSql("HikariPool-19053");
        hikariConfig0.connectionInitSql = "HikariPool-22023";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 32L + "'", long11 == 32L);
    ...
    public void test14379() throws Throwable {
        ...
        long long22 = hikariConfig19.getConnectionTimeout();
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertNotNull(properties18);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + (-1L) + "'", long6 == (-1L));
    ...
    public void test14381() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-4001");
        hikariConfig0.jdbcUrl = "HikariPool-9964";
        org.junit.Assert.assertNull(dataSource1);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
        org.junit.Assert.assertNotNull(properties7);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + true + "'", boolean8 == true);
...
// flaky:         org.junit.Assert.assertTrue("'" + long4 + "' != '" + (-1L) + "'", long4 == (-1L));
    ...
    public void test14389() throws Throwable {
        ...
        hikariConfig6.acquireRetries = 1;
        java.lang.String str12 = hikariConfig6.connectionInitSql;
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str4);
    ...
    public void test14390() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-1577");
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + (-1L) + "'", long22 == (-1L));
    ...
    public void test14391() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-194");
        hikariConfig0.minPoolSize = (byte) 100;
        // The following exception was thrown during execution in test generation
        try {
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
    ...
    public void test14393() throws Throwable {
        ...
        java.lang.String str87 = hikariConfig20.getCatalog();
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertNull(str16);
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + (-1L) + "'", long13 == (-1L));
        org.junit.Assert.assertTrue("'" + long20 + "' != '" + 0L + "'", long20 == 0L);
        org.junit.Assert.assertNull(properties21);
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + (-1L) + "'", long22 == (-1L));
    }
    ...
    public void test14395() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + false + "'", boolean13 == false);
        org.junit.Assert.assertNull(str14);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-36856" + "'", str15, "HikariPool-36856");
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + 1 + "'", int19 == 1);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 32L + "'", long9 == 32L);
        org.junit.Assert.assertNotNull(properties10);
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + false + "'", boolean12 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-36859" + "'", str13, "HikariPool-36859");
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
        org.junit.Assert.assertNull(str17);
        org.junit.Assert.assertTrue("'" + long18 + "' != '" + 0L + "'", long18 == 0L);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long43 + "' != '" + 32L + "'", long43 == 32L);
    ...
    public void test14399() throws Throwable {
        ...
        hikariConfig31.connectionCustomizerClassName = "hi!";
        hikariConfig31.setConnectionTestQuery("hi!");
        java.lang.String str54 = hikariConfig31.getJdbcUrl();
        java.lang.String str55 = hikariConfig31.getConnectionCustomizerClassName();
        long long56 = hikariConfig31.getAcquireRetryDelay();
        java.util.Properties properties57 = hikariConfig31.getDataSourceProperties();
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
    ...
    public void test14410() throws Throwable {
        ...
        hikariConfig0.connectionInitSql = "HikariPool-5527";
        java.lang.String str29 = hikariConfig0.connectionTestQuery;
        hikariConfig0.setTransactionIsolation("HikariPool-856");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 100L + "'", long5 == 100L);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 100L + "'", long10 == 100L);
        org.junit.Assert.assertNull(iConnectionCustomizer17);
        org.junit.Assert.assertTrue("'" + boolean20 + "' != '" + true + "'", boolean20 == true);
        org.junit.Assert.assertEquals("'" + str29 + "' != '" + "HikariPool-283" + "'", str29, "HikariPool-283");
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-36885" + "'", str3, "HikariPool-36885");
...
// flaky:         org.junit.Assert.assertTrue("'" + long34 + "' != '" + 32L + "'", long34 == 32L);
        org.junit.Assert.assertNotNull(properties35);
        org.junit.Assert.assertNull(dataSource39);
// flaky:         org.junit.Assert.assertEquals("'" + str40 + "' != '" + "HikariPool-36899" + "'", str40, "HikariPool-36899");
    ...
    public void test14422() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertNull(str14);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-36904" + "'", str15, "HikariPool-36904");
        org.junit.Assert.assertNull(str21);
        org.junit.Assert.assertTrue("'" + long22 + "' != '" + 0L + "'", long22 == 0L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 100L + "'", long6 == 100L);
    ...
    public void test14427() throws Throwable {
        ...
        hikariConfig0.dataSource = dataSource12;
        java.lang.String str14 = hikariConfig0.getPoolName();
        hikariConfig0.setConnectionInitSql("HikariPool-3673");
        int int17 = hikariConfig0.getAcquireRetries();
        int int18 = hikariConfig0.acquireRetries;
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(dataSource8);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 1 + "'", int11 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-36917" + "'", str14, "HikariPool-36917");
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 10 + "'", int17 == 10);
        org.junit.Assert.assertTrue("'" + int18 + "' != '" + 10 + "'", int18 == 10);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long18 + "' != '" + 32L + "'", long18 == 32L);
    ...
    public void test14430() throws Throwable {
        ...
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str4);
// flaky:         org.junit.Assert.assertEquals("'" + str5 + "' != '" + "HikariPool-36920" + "'", str5, "HikariPool-36920");
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
        org.junit.Assert.assertNull(str10);
        org.junit.Assert.assertNull(dataSource11);
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 32L + "'", long7 == 32L);
    ...
    public void test14435() throws Throwable {
        ...
        org.junit.Assert.assertNull(str11);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 10 + "'", int12 == 10);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-36929" + "'", str13, "HikariPool-36929");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 32L + "'", long17 == 32L);
    ...
    public void test14437() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-2478");
        org.junit.Assert.assertNull(iConnectionCustomizer3);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-18" + "'", str9, "HikariPool-18");
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
    ...
    public void test14438() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + (-1) + "'", int4 == (-1));
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 32L + "'", long5 == 32L);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-36933" + "'", str6, "HikariPool-36933");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 32L + "'", long5 == 32L);
        org.junit.Assert.assertNull(str12);
        org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-686" + "'", str13, "HikariPool-686");
    }
    ...
    public void test14441() throws Throwable {
        ...
        javax.sql.DataSource dataSource7 = hikariConfig0.getDataSource();
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer8 = hikariConfig0.connectionCustomizer;
        hikariConfig0.setConnectionTestQuery("HikariPool-4117");
        java.lang.String str11 = hikariConfig0.connectionInitSql;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 60 + "'", int3 == 60);
...
// flaky:         org.junit.Assert.assertTrue("'" + long23 + "' != '" + 32L + "'", long23 == 32L);
    ...
    public void test14443() throws Throwable {
        ...
        hikariConfig0.acquireRetries = (short) 1;
        hikariConfig0.setMinimumPoolSize((int) (byte) 0);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-20380");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 1 + "'", int5 == 1);
        org.junit.Assert.assertNull(str14);
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 100L + "'", long13 == 100L);
    ...
    public void test14448() throws Throwable {
        ...
        hikariConfig8.setLeakDetectionThreshold((long) 10);
        hikariConfig8.connectionTestQuery = "HikariPool-36671";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 60 + "'", int3 == 60);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 0L + "'", long4 == 0L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 100L + "'", long14 == 100L);
        org.junit.Assert.assertTrue("'" + int20 + "' != '" + 1 + "'", int20 == 1);
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + 100L + "'", long21 == 100L);
// flaky:         org.junit.Assert.assertEquals("'" + str22 + "' != '" + "HikariPool-36953" + "'", str22, "HikariPool-36953");
        org.junit.Assert.assertTrue("'" + int23 + "' != '" + 60 + "'", int23 == 60);
    }
    ...
    public void test14450() throws Throwable {
        ...
        int int34 = hikariConfig15.acquireRetries;
        hikariConfig0.addDataSourceProperty("HikariPool-3664", (java.lang.Object) hikariConfig15);
        javax.sql.DataSource dataSource36 = hikariConfig15.dataSource;
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 60 + "'", int3 == 60);
        org.junit.Assert.assertNull(str4);
...
// flaky:         org.junit.Assert.assertTrue("'" + long27 + "' != '" + 100L + "'", long27 == 100L);
    ...
    public void test14453() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-36959" + "'", str18, "HikariPool-36959");
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + 3 + "'", int19 == 3);
        org.junit.Assert.assertNull(str22);
        org.junit.Assert.assertTrue("'" + int23 + "' != '" + (-1) + "'", int23 == (-1));
        org.junit.Assert.assertNull(str24);
    ...
    public void test14455() throws Throwable {
        ...
        javax.sql.DataSource dataSource8 = hikariConfig0.getDataSource();
        hikariConfig0.dataSourceClassName = "HikariPool-15191";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertNull(str5);
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 100L + "'", long16 == 100L);
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + false + "'", boolean17 == false);
        org.junit.Assert.assertNotNull(properties19);
// flaky:         org.junit.Assert.assertEquals("'" + str24 + "' != '" + "HikariPool-36965" + "'", str24, "HikariPool-36965");
    }
    ...
    public void test14460() throws Throwable {
        ...
        hikariConfig0.acquireIncrement = '#';
        hikariConfig0.setConnectionInitSql("HikariPool-7978");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 32L + "'", long5 == 32L);
    ...
    public void test14463() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-2755");
        hikariConfig0.setInitializationFailFast(false);
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 60 + "'", int3 == 60);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + (-1L) + "'", long6 == (-1L));
    ...
    public void test14470() throws Throwable {
        ...
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-36980" + "'", str11, "HikariPool-36980");
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 10 + "'", int12 == 10);
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 3 + "'", int13 == 3);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
        org.junit.Assert.assertNull(dataSource17);
...
// flaky:         org.junit.Assert.assertTrue("'" + long4 + "' != '" + (-1L) + "'", long4 == (-1L));
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-36990" + "'", str7, "HikariPool-36990");
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
        org.junit.Assert.assertNull(str11);
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 32L + "'", long12 == 32L);
        org.junit.Assert.assertNull(str13);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-36990" + "'", str14, "HikariPool-36990");
    }
    ...
    public void test14475() throws Throwable {
        ...
        boolean boolean9 = hikariConfig0.isIsolateInternalQueries();
        boolean boolean10 = hikariConfig0.isAutoCommit();
        hikariConfig0.connectionCustomizerClassName = "HikariPool-28505";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 60 + "'", int3 == 60);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 0L + "'", long4 == 0L);
    ...
    public void test14476() throws Throwable {
        ...
        int int3 = hikariConfig0.getAcquireRetries();
        long long4 = hikariConfig0.getConnectionTimeout();
        hikariConfig0.poolName = "HikariPool-2359";
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 32L + "'", long11 == 32L);
    ...
    public void test14482() throws Throwable {
        ...
        com.zaxxer.hikari.HikariConfig hikariConfig8 = new com.zaxxer.hikari.HikariConfig();
        java.lang.String str9 = hikariConfig8.getConnectionInitSql();
        hikariConfig8.acquireIncrement = 0;
        hikariConfig8.maxLifetime = 100;
        long long14 = hikariConfig8.acquireRetryDelay;
        hikariConfig8.dataSourceClassName = "HikariPool-25";
        hikariConfig8.maxPoolSize = 3;
        int int19 = hikariConfig8.getMinimumPoolSize();
        hikariConfig8.acquireIncrement = (short) 100;
        hikariConfig8.setUseInstrumentation(true);
        java.lang.String str24 = hikariConfig8.jdbcUrl;
        java.lang.String str25 = hikariConfig8.connectionInitSql;
        int int26 = hikariConfig8.transactionIsolation;
        long long27 = hikariConfig8.getAcquireRetryDelay();
        hikariConfig0.addDataSourceProperty("HikariPool-33193", (java.lang.Object) hikariConfig8);
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-37001" + "'", str3, "HikariPool-37001");
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(str9);
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 100L + "'", long14 == 100L);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + 10 + "'", int19 == 10);
...
// flaky:         org.junit.Assert.assertTrue("'" + long27 + "' != '" + 100L + "'", long27 == 100L);
    ...
    public void test14483() throws Throwable {
        ...
        hikariConfig0.connectionCustomizerClassName = "HikariPool-415";
        hikariConfig0.setReadOnly(false);
        org.junit.Assert.assertNull(dataSource1);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 32L + "'", long6 == 32L);
        org.junit.Assert.assertNotNull(properties7);
...
// flaky:         org.junit.Assert.assertTrue("'" + long23 + "' != '" + 32L + "'", long23 == 32L);
        ...
        org.junit.Assert.assertNotNull(properties43);
// flaky:         org.junit.Assert.assertEquals("'" + str49 + "' != '" + "HikariPool-37003" + "'", str49, "HikariPool-37003");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long4 + "' != '" + 100L + "'", long4 == 100L);
    ...
    public void test14488() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-838");
        hikariConfig0.setAutoCommit(true);
        hikariConfig0.setJdbcUrl("HikariPool-401");
    ...
    public void test14490() throws Throwable {
        ...
        hikariConfig0.dataSourceProperties = properties63;
        hikariConfig0.transactionIsolation = (short) 10;
        java.lang.String str68 = hikariConfig0.transactionIsolationName;
        boolean boolean69 = hikariConfig0.isAutoCommit();
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 32L + "'", long12 == 32L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long37 + "' != '" + (-1L) + "'", long37 == (-1L));
    ...
    public void test14491() throws Throwable {
        ...
        hikariConfig0.setJdbc4ConnectionTest(true);
        java.lang.String str13 = hikariConfig0.transactionIsolationName;
        hikariConfig0.setTransactionIsolation("HikariPool-26750");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 0L + "'", long2 == 0L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertNull(str8);
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 32L + "'", long13 == 32L);
        org.junit.Assert.assertNull(str14);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-37019" + "'", str15, "HikariPool-37019");
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + (-1L) + "'", long12 == (-1L));
    ...
    public void test14497() throws Throwable {
        ...
        org.junit.Assert.assertNull(dataSource1);
        org.junit.Assert.assertNull(str8);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-37029" + "'", str11, "HikariPool-37029");
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 1 + "'", int12 == 1);
        org.junit.Assert.assertNotNull(properties13);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + (-1) + "'", int14 == (-1));
        org.junit.Assert.assertTrue("'" + int15 + "' != '" + 60 + "'", int15 == 60);
...
// flaky:         org.junit.Assert.assertTrue("'" + long8 + "' != '" + 32L + "'", long8 == 32L);
    ...
    public void test14500() throws Throwable {
        ...
        hikariConfig0.setMinimumPoolSize((int) '#');
        hikariConfig0.setIdleTimeout(0L);
        hikariConfig0.jdbcUrl = "HikariPool-30859";
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 32L + "'", long7 == 32L);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
