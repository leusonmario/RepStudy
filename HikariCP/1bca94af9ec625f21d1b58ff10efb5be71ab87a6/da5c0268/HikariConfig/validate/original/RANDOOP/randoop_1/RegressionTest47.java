...
public class RegressionTest47 {
    ...
    public void test23502() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-19293");
...
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-77922" + "'", str10, "HikariPool-77922");
    }
    ...
    public void test23511() throws Throwable {
        ...
        hikariConfig11.setMaximumPoolSize((int) (byte) 1);
        hikariConfig11.setAcquireIncrement((int) (short) 10);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertNull(dataSource7);
        org.junit.Assert.assertNotNull(properties10);
    ...
    public void test23513() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("");
        hikariConfig0.setPoolName("HikariPool-38894");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test23514() throws Throwable {
        ...
        hikariConfig18.setConnectionTimeout((long) (short) 100);
        hikariConfig18.setMaxLifetime((long) 100);
        boolean boolean26 = hikariConfig18.isInitializationFailFast();
        boolean boolean27 = hikariConfig18.isReadOnly();
        hikariConfig18.setConnectionTestQuery("HikariPool-370");
        hikariConfig18.setConnectionTimeout((long) (short) 100);
        ...
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-77934" + "'", str10, "HikariPool-77934");
...
// flaky:         org.junit.Assert.assertEquals("'" + str32 + "' != '" + "HikariPool-77936" + "'", str32, "HikariPool-77936");
    ...
    public void test23517() throws Throwable {
        ...
        long long9 = hikariConfig7.getAcquireRetryDelay();
        hikariConfig7.setConnectionCustomizerClassName("HikariPool-25895");
        ...
        hikariConfig14.addDataSourceProperty("HikariPool-1863", (java.lang.Object) true);
        javax.sql.DataSource dataSource37 = null;
        hikariConfig14.setDataSource(dataSource37);
        hikariConfig14.setJdbcUrl("HikariPool-3073");
        boolean boolean41 = hikariConfig14.isAutoCommit();
        java.lang.String str42 = hikariConfig14.getConnectionCustomizerClassName();
        java.lang.String str43 = hikariConfig14.getJdbcUrl();
        hikariConfig7.addDataSourceProperty("HikariPool-43747", (java.lang.Object) str43);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        ...
        org.junit.Assert.assertEquals("'" + str43 + "' != '" + "HikariPool-3073" + "'", str43, "HikariPool-3073");
    }
    ...
    public void test23520() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-12060");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-77957" + "'", str12, "HikariPool-77957");
    ...
    public void test23533() throws Throwable {
        ...
        hikariConfig0.setAutoCommit(false);
        hikariConfig0.setAutoCommit(true);
        hikariConfig0.setTransactionIsolation("HikariPool-30843");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
    ...
    public void test23535() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-46027");
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-70140");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
    ...
    public void test23538() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-77980" + "'", str7, "HikariPool-77980");
        org.junit.Assert.assertNull(str10);
        org.junit.Assert.assertTrue("'" + int15 + "' != '" + 1 + "'", int15 == 1);
    }
    ...
    public void test23539() throws Throwable {
        ...
        hikariConfig0.setConnectionTimeout(0L);
        hikariConfig0.setUseInstrumentation(false);
        hikariConfig0.setConnectionInitSql("HikariPool-77230");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertNull(dataSource10);
    ...
    public void test23542() throws Throwable {
        ...
        long long6 = hikariConfig4.getMaxLifetime();
        java.lang.String str7 = hikariConfig4.getDataSourceClassName();
        hikariConfig4.setIdleTimeout((long) (-1));
        java.lang.String str10 = hikariConfig4.getConnectionTestQuery();
        int int11 = hikariConfig4.getMaximumPoolSize();
        hikariConfig4.setAcquireRetryDelay((long) (byte) 0);
        java.util.Properties properties14 = hikariConfig4.getDataSourceProperties();
        hikariConfig4.setPoolName("HikariPool-447");
        hikariConfig4.setCatalog("HikariPool-1458");
        boolean boolean19 = hikariConfig4.isAutoCommit();
        long long20 = hikariConfig4.getConnectionTimeout();
        long long21 = hikariConfig4.getLeakDetectionThreshold();
        java.util.Properties properties22 = hikariConfig4.getDataSourceProperties();
    ...
    public void test23543() throws Throwable {
        ...
        hikariConfig0.setJdbc4ConnectionTest(false);
        hikariConfig0.setDataSourceClassName("HikariPool-77072");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
    ...
    public void test23547() throws Throwable {
        ...
        hikariConfig0.setMaximumPoolSize((int) (byte) 0);
        hikariConfig0.setJdbcUrl("HikariPool-25962");
        ...
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 60 + "'", int8 == 60);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-77991" + "'", str10, "HikariPool-77991");
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + true + "'", boolean16 == true);
    }
    ...
    public void test23549() throws Throwable {
        ...
        try {
            hikariConfig0.validate();
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Invalid transaction isolation value: HikariPool-6245");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
    ...
    public void test23552() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-47200");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-47200' could not be loaded");
    ...
    public void test23559() throws Throwable {
        ...
        org.junit.Assert.assertNull(str11);
        org.junit.Assert.assertNull(str12);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-78008" + "'", str13, "HikariPool-78008");
    ...
    public void test23561() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-19329");
        // The following exception was thrown during execution in test generation
        try {
    ...
    public void test23562() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-60813");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + (-1) + "'", int8 == (-1));
    ...
    public void test23564() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-8139");
        boolean boolean24 = hikariConfig0.isRegisterMbeans();
        hikariConfig0.setPoolName("HikariPool-74022");
        javax.sql.DataSource dataSource27 = hikariConfig0.getDataSource();
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 5000L + "'", long11 == 5000L);
    ...
    public void test23566() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-77308");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-77308' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
    ...
    public void test23571() throws Throwable {
        ...
        hikariConfig0.setAcquireIncrement(32);
        hikariConfig0.setPoolName("HikariPool-46464");
    ...
    public void test23574() throws Throwable {
        ...
        hikariConfig0.setReadOnly(true);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-34865");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertNull(str9);
    ...
    public void test23583() throws Throwable {
        ...
        long long11 = hikariConfig0.getLeakDetectionThreshold();
        hikariConfig0.setUseInstrumentation(true);
        hikariConfig0.setCatalog("HikariPool-54332");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
