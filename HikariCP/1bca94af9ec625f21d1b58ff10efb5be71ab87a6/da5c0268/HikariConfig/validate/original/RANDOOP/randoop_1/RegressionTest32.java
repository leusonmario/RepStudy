...
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-62754" + "'", str7, "HikariPool-62754");
        org.junit.Assert.assertNotNull(properties14);
    ...
    public void test16003() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-59154");
    ...
    public void test16006() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-38384");
    ...
    public void test16007() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-56299");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-56299 was not found.");
    ...
    public void test16010() throws Throwable {
        ...
        long long12 = hikariConfig7.getAcquireRetryDelay();
    ...
    public void test16014() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertNull(str6);
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-62777" + "'", str7, "HikariPool-62777");
    ...
    public void test16015() throws Throwable {
        ...
        java.lang.String str28 = hikariConfig22.getDataSourceClassName();
        ...
        hikariConfig9.setCatalog("HikariPool-5239");
        java.lang.String str44 = hikariConfig9.getCatalog();
        java.util.Properties properties45 = hikariConfig9.getDataSourceProperties();
        hikariConfig0.setDataSourceProperties(properties45);
        java.lang.Class<?> wildcardClass47 = properties45.getClass();
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-62780" + "'", str6, "HikariPool-62780");
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 60 + "'", int7 == 60);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        ...
        org.junit.Assert.assertEquals("'" + str44 + "' != '" + "HikariPool-5239" + "'", str44, "HikariPool-5239");
    ...
    public void test16020() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-62796" + "'", str6, "HikariPool-62796");
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + false + "'", boolean11 == false);
    ...
    public void test16026() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-29858");
        org.junit.Assert.assertNull(str5);
    ...
    public void test16027() throws Throwable {
        ...
        hikariConfig15.setAcquireRetryDelay((long) (short) 10);
        com.zaxxer.hikari.HikariConfig hikariConfig26 = new com.zaxxer.hikari.HikariConfig();
        ...
        boolean boolean35 = hikariConfig26.isInitializationFailFast();
        ...
        int int60 = hikariConfig59.getMaximumPoolSize();
        com.zaxxer.hikari.HikariConfig hikariConfig61 = new com.zaxxer.hikari.HikariConfig();
        hikariConfig61.setConnectionInitSql("");
        hikariConfig61.setConnectionInitSql("hi!");
        ...
        hikariConfig61.setDataSourceProperties(properties75);
        ...
        hikariConfig26.setDataSourceProperties(properties75);
        hikariConfig15.setDataSourceProperties(properties75);
    ...
    public void test16033() throws Throwable {
        ...
        hikariConfig0.setAutoCommit(true);
        hikariConfig0.setInitializationFailFast(false);
        hikariConfig0.setConnectionInitSql("HikariPool-45608");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test16034() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
        org.junit.Assert.assertNull(str11);
// flaky:         org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-62835" + "'", str18, "HikariPool-62835");
    ...
    public void test16035() throws Throwable {
        ...
        org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-2746" + "'", str15, "HikariPool-2746");
    }
    ...
    public void test16036() throws Throwable {
        ...
        int int12 = hikariConfig6.getAcquireRetries();
        java.lang.String str13 = hikariConfig6.getConnectionInitSql();
        ...
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str19 + "' != '" + "HikariPool-62839" + "'", str19, "HikariPool-62839");
    ...
    public void test16037() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-5333");
        ...
        javax.sql.DataSource dataSource22 = hikariConfig12.getDataSource();
    ...
    public void test16038() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
// flaky:         org.junit.Assert.assertEquals("'" + str8 + "' != '" + "HikariPool-62845" + "'", str8, "HikariPool-62845");
    ...
    public void test16039() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 10 + "'", int4 == 10);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-250" + "'", str10, "HikariPool-250");
    }
    ...
    public void test16041() throws Throwable {
        ...
        hikariConfig25.setPoolName("HikariPool-447");
        hikariConfig25.setCatalog("HikariPool-1458");
        hikariConfig25.setLeakDetectionThreshold(0L);
        ...
        java.lang.String str51 = hikariConfig43.getJdbcUrl();
        long long52 = hikariConfig43.getConnectionTimeout();
        java.util.Properties properties53 = hikariConfig43.getDataSourceProperties();
        hikariConfig25.addDataSourceProperty("HikariPool-2037", (java.lang.Object) hikariConfig43);
        hikariConfig1.addDataSourceProperty("", (java.lang.Object) hikariConfig25);
        javax.sql.DataSource dataSource56 = hikariConfig25.getDataSource();
        int int57 = hikariConfig25.getMaximumPoolSize();
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNotNull(properties10);
    ...
    public void test16042() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-2812");
    ...
    public void test16051() throws Throwable {
        ...
        javax.sql.DataSource dataSource7 = null;
        hikariConfig0.setDataSource(dataSource7);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-3746");
    ...
    public void test16053() throws Throwable {
        ...
        long long9 = hikariConfig0.getAcquireRetryDelay();
        hikariConfig0.setCatalog("HikariPool-53483");
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertTrue("'" + long9 + "' != '" + 750L + "'", long9 == 750L);
    }
    ...
    public void test16057() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + false + "'", boolean11 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-62878" + "'", str12, "HikariPool-62878");
    }
    ...
    public void test16060() throws Throwable {
        ...
        hikariConfig10.setCatalog("HikariPool-10645");
    ...
    public void test16061() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig8.setDriverClassName("HikariPool-11177");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-11177' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test16066() throws Throwable {
        ...
        boolean boolean9 = hikariConfig0.isRegisterMbeans();
        hikariConfig0.setAutoCommit(false);
        hikariConfig0.setPoolName("HikariPool-6955");
        int int14 = hikariConfig0.getTransactionIsolation();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
        org.junit.Assert.assertNull(str7);
    ...
    public void test16067() throws Throwable {
        ...
        hikariConfig0.setLeakDetectionThreshold((long) (byte) 100);
        java.lang.String str6 = hikariConfig0.getPoolName();
        hikariConfig0.setDataSourceClassName("HikariPool-3101");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-62902" + "'", str6, "HikariPool-62902");
    }
    ...
    public void test16068() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-20533");
...
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-62907" + "'", str12, "HikariPool-62907");
        org.junit.Assert.assertNull(str13);
    }
    ...
    public void test16074() throws Throwable {
        ...
        hikariConfig0.setInitializationFailFast(false);
        hikariConfig0.setConnectionTestQuery("HikariPool-23341");
    }
    ...
    public void test16075() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-23662");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 60 + "'", int4 == 60);
    ...
    public void test16076() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-16795");
        ...
        hikariConfig19.setTransactionIsolation("HikariPool-1143");
        javax.sql.DataSource dataSource23 = hikariConfig19.getDataSource();
        hikariConfig19.setConnectionTestQuery("HikariPool-10539");
        ...
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 750L + "'", long11 == 750L);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-62919" + "'", str12, "HikariPool-62919");
    ...
    public void test16083() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str8 + "' != '" + "HikariPool-62931" + "'", str8, "HikariPool-62931");
    ...
    public void test16084() throws Throwable {
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-9176", (java.lang.Object) properties19);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
    ...
    public void test16085() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-56908");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-56908' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test16088() throws Throwable {
        ...
        hikariConfig28.setConnectionTestQuery("HikariPool-21119");
        hikariConfig28.setAcquireIncrement((int) (short) 1);
    ...
    public void test16091() throws Throwable {
        ...
        java.lang.String str27 = hikariConfig14.getPoolName();
        hikariConfig14.setAcquireRetries((int) (byte) 0);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        ...
        org.junit.Assert.assertTrue("'" + int25 + "' != '" + 60 + "'", int25 == 60);
        org.junit.Assert.assertTrue("'" + long26 + "' != '" + 600000L + "'", long26 == 600000L);
// flaky:         org.junit.Assert.assertEquals("'" + str27 + "' != '" + "HikariPool-62949" + "'", str27, "HikariPool-62949");
    }
    ...
    public void test16092() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-62951" + "'", str11, "HikariPool-62951");
        org.junit.Assert.assertNull(str12);
    }
    ...
    public void test16095() throws Throwable {
        ...
        hikariConfig0.setDataSource(dataSource2);
        boolean boolean4 = hikariConfig0.isJdbc4ConnectionTest();
        hikariConfig0.setPoolName("HikariPool-1454");
        hikariConfig0.setMinimumPoolSize(0);
        java.lang.String str9 = hikariConfig0.getConnectionCustomizerClassName();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
    ...
    public void test16097() throws Throwable {
        ...
        hikariConfig0.setInitializationFailFast(true);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-14119");
        boolean boolean16 = hikariConfig0.isAutoCommit();
        com.zaxxer.hikari.HikariConfig hikariConfig18 = new com.zaxxer.hikari.HikariConfig();
        ...
        hikariConfig18.setMaxLifetime((long) 10);
        ...
        boolean boolean32 = hikariConfig18.isAutoCommit();
        hikariConfig0.addDataSourceProperty("HikariPool-62826", (java.lang.Object) hikariConfig18);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str8);
    ...
    public void test16099() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-23973");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertNull(str6);
    ...
    public void test16102() throws Throwable {
        ...
        hikariConfig21.setTransactionIsolation("HikariPool-564");
        java.lang.String str32 = hikariConfig21.getConnectionCustomizerClassName();
        java.lang.String str33 = hikariConfig21.getConnectionTestQuery();
        long long34 = hikariConfig21.getMaxLifetime();
        long long35 = hikariConfig21.getConnectionTimeout();
        com.zaxxer.hikari.HikariConfig hikariConfig37 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean38 = hikariConfig37.isInitializationFailFast();
        ...
        hikariConfig37.setReadOnly(false);
        long long45 = hikariConfig37.getMaxLifetime();
        hikariConfig21.addDataSourceProperty("HikariPool-6211", (java.lang.Object) hikariConfig37);
        ...
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 1 + "'", int17 == 1);
        org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-4468" + "'", str20, "HikariPool-4468");
    ...
    public void test16103() throws Throwable {
        ...
        hikariConfig11.setPoolName("HikariPool-37931");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str8);
    ...
    public void test16104() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-15719");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
    ...
    public void test16105() throws Throwable {
        ...
        hikariConfig9.setIdleTimeout((-1L));
        java.lang.String str22 = hikariConfig9.getPoolName();
        ...
        org.junit.Assert.assertNull(str18);
        org.junit.Assert.assertNull(str19);
// flaky:         org.junit.Assert.assertEquals("'" + str22 + "' != '" + "HikariPool-62981" + "'", str22, "HikariPool-62981");
    }
    ...
    public void test16106() throws Throwable {
        ...
        hikariConfig9.setConnectionInitSql("");
        hikariConfig9.setPoolName("HikariPool-3827");
    ...
    public void test16109() throws Throwable {
        ...
        hikariConfig14.setPoolName("HikariPool-61918");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test16114() throws Throwable {
        ...
        org.junit.Assert.assertNull(str20);
        org.junit.Assert.assertNotNull(properties21);
// flaky:         org.junit.Assert.assertEquals("'" + str26 + "' != '" + "HikariPool-62995" + "'", str26, "HikariPool-62995");
...
// flaky:         org.junit.Assert.assertEquals("'" + str5 + "' != '" + "HikariPool-63002" + "'", str5, "HikariPool-63002");
        org.junit.Assert.assertNotNull(properties8);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 5000L + "'", long10 == 5000L);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-63002" + "'", str13, "HikariPool-63002");
    }
    ...
    public void test16118() throws Throwable {
        ...
        hikariConfig0.setUseInstrumentation(true);
        boolean boolean8 = hikariConfig0.isAutoCommit();
        hikariConfig0.setConnectionInitSql("HikariPool-17544");
        hikariConfig0.setMinimumPoolSize((int) (short) 1);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
    ...
    public void test16124() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-63021" + "'", str7, "HikariPool-63021");
        org.junit.Assert.assertNull(str10);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 5000L + "'", long11 == 5000L);
    ...
    public void test16125() throws Throwable {
        ...
        hikariConfig0.setDataSourceClassName("HikariPool-22266");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
    ...
    public void test16126() throws Throwable {
        ...
        java.lang.String str8 = hikariConfig0.getDataSourceClassName();
        java.lang.String str9 = hikariConfig0.getConnectionInitSql();
        hikariConfig0.setConnectionTestQuery("HikariPool-23975");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertNull(str8);
    ...
    public void test16128() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 3 + "'", int8 == 3);
// flaky:         org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-63025" + "'", str9, "HikariPool-63025");
    }
    ...
    public void test16129() throws Throwable {
        ...
        java.lang.String str29 = hikariConfig19.getConnectionInitSql();
        hikariConfig10.addDataSourceProperty("HikariPool-11822", (java.lang.Object) str29);
    ...
    public void test16131() throws Throwable {
        ...
        hikariConfig1.setPoolName("HikariPool-62179");
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNotNull(properties10);
    ...
    public void test16132() throws Throwable {
        ...
        hikariConfig10.setConnectionInitSql("HikariPool-829");
        ...
        boolean boolean25 = hikariConfig22.isIsolateInternalQueries();
        long long26 = hikariConfig22.getMaxLifetime();
        java.util.Properties properties27 = hikariConfig22.getDataSourceProperties();
    ...
    public void test16137() throws Throwable {
        ...
        hikariConfig18.setConnectionInitSql("");
        java.lang.String str29 = hikariConfig18.getConnectionCustomizerClassName();
    ...
    public void test16139() throws Throwable {
        ...
        javax.sql.DataSource dataSource12 = hikariConfig0.getDataSource();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-50210");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 3 + "'", int10 == 3);
    ...
    public void test16140() throws Throwable {
        ...
        int int26 = hikariConfig15.getAcquireRetries();
...
// flaky:         org.junit.Assert.assertEquals("'" + str27 + "' != '" + "HikariPool-63061" + "'", str27, "HikariPool-63061");
    ...
    public void test16141() throws Throwable {
        ...
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + long13 + "' != '" + 750L + "'", long13 == 750L);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-63062" + "'", str14, "HikariPool-63062");
        org.junit.Assert.assertTrue("'" + int15 + "' != '" + 1 + "'", int15 == 1);
        org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-370" + "'", str16, "HikariPool-370");
    }
    ...
    public void test16143() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-12895");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str6);
    ...
    public void test16144() throws Throwable {
        ...
        hikariConfig0.setReadOnly(false);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-63066" + "'", str6, "HikariPool-63066");
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + 1 + "'", int9 == 1);
    }
    ...
    public void test16145() throws Throwable {
        ...
        hikariConfig0.setUseInstrumentation(false);
        hikariConfig0.setInitializationFailFast(true);
        hikariConfig0.setCatalog("HikariPool-12328");
    ...
    public void test16149() throws Throwable {
        ...
        hikariConfig0.setDataSourceClassName("HikariPool-1511");
        hikariConfig0.setMinimumPoolSize((int) 'a');
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-8774");
        javax.sql.DataSource dataSource20 = null;
    ...
    public void test16152() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-52517");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-52517 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test16154() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-31196");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 60 + "'", int4 == 60);
    ...
    public void test16155() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-63083" + "'", str10, "HikariPool-63083");
    }
    ...
    public void test16158() throws Throwable {
        ...
        hikariConfig11.setCatalog("HikariPool-8360");
        java.lang.String str24 = hikariConfig11.getConnectionTestQuery();
        long long25 = hikariConfig11.getLeakDetectionThreshold();
        hikariConfig11.setConnectionCustomizerClassName("HikariPool-26419");
        hikariConfig0.addDataSourceProperty("HikariPool-2037", (java.lang.Object) "HikariPool-26419");
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 10 + "'", int8 == 10);
    ...
    public void test16159() throws Throwable {
        ...
        boolean boolean48 = hikariConfig13.isReadOnly();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str6);
    ...
    public void test16162() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-3885");
        hikariConfig0.setAutoCommit(false);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
    ...
    public void test16163() throws Throwable {
        ...
        int int8 = hikariConfig0.getMinimumPoolSize();
        hikariConfig0.setInitializationFailFast(false);
        hikariConfig0.setPoolName("HikariPool-9057");
        javax.sql.DataSource dataSource13 = null;
        hikariConfig0.setDataSource(dataSource13);
        com.zaxxer.hikari.HikariConfig hikariConfig15 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean16 = hikariConfig15.isInitializationFailFast();
    ...
    public void test16165() throws Throwable {
        ...
        int int13 = hikariConfig0.getAcquireRetries();
        hikariConfig0.setMinimumPoolSize(0);
        hikariConfig0.setConnectionInitSql("HikariPool-5146");
        java.lang.String str18 = hikariConfig0.getConnectionInitSql();
        hikariConfig0.setTransactionIsolation("HikariPool-41692");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
        ...
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 1 + "'", int12 == 1);
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 3 + "'", int13 == 3);
        org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-5146" + "'", str18, "HikariPool-5146");
    }
    ...
    public void test16167() throws Throwable {
        ...
        int int66 = hikariConfig63.getAcquireIncrement();
        javax.sql.DataSource dataSource67 = null;
        hikariConfig63.setDataSource(dataSource67);
        java.lang.String str69 = hikariConfig63.getCatalog();
        long long70 = hikariConfig63.getAcquireRetryDelay();
        int int71 = hikariConfig63.getMinimumPoolSize();
        hikariConfig63.setIsolateInternalQueries(true);
        hikariConfig63.setRegisterMbeans(true);
        int int76 = hikariConfig63.getMinimumPoolSize();
        hikariConfig63.setIdleTimeout((long) (-1));
        boolean boolean79 = hikariConfig63.isAutoCommit();
        hikariConfig63.setMinimumPoolSize((int) (byte) 1);
        hikariConfig0.addDataSourceProperty("HikariPool-18019", (java.lang.Object) (byte) 1);
        hikariConfig0.setJdbc4ConnectionTest(true);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 600000L + "'", long10 == 600000L);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 3 + "'", int11 == 3);
    ...
    public void test16170() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-22994");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-63110" + "'", str10, "HikariPool-63110");
    }
    ...
    public void test16171() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-55696");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-55696' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test16172() throws Throwable {
        ...
        org.junit.Assert.assertNull(str11);
// flaky:         org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-63114" + "'", str16, "HikariPool-63114");
    }
    ...
    public void test16173() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-51911");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
    ...
    public void test16174() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-59407");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 60 + "'", int4 == 60);
    ...
    public void test16175() throws Throwable {
        ...
        hikariConfig41.setLeakDetectionThreshold((long) (byte) 100);
        java.lang.String str47 = hikariConfig41.getDataSourceClassName();
        boolean boolean48 = hikariConfig41.isIsolateInternalQueries();
        boolean boolean49 = hikariConfig41.isReadOnly();
    ...
    public void test16177() throws Throwable {
        ...
        boolean boolean8 = hikariConfig0.isAutoCommit();
        hikariConfig0.setDataSourceClassName("HikariPool-6131");
        com.zaxxer.hikari.HikariConfig hikariConfig11 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean12 = hikariConfig11.isJdbc4ConnectionTest();
        long long13 = hikariConfig11.getConnectionTimeout();
        hikariConfig11.setJdbcUrl("");
        ...
        hikariConfig0.setDataSourceProperties(properties23);
        hikariConfig0.setCatalog("HikariPool-18686");
        hikariConfig0.setInitializationFailFast(false);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + true + "'", boolean8 == true);
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + true + "'", boolean12 == true);
    ...
    public void test16180() throws Throwable {
        ...
        java.lang.String str20 = hikariConfig0.getConnectionCustomizerClassName();
        hikariConfig0.setRegisterMbeans(true);
        hikariConfig0.setCatalog("HikariPool-22667");
    ...
    public void test16181() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-5990");
        hikariConfig0.setAcquireRetryDelay(0L);
        hikariConfig0.setMaxLifetime((long) ' ');
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
    ...
    public void test16183() throws Throwable {
        ...
        javax.sql.DataSource dataSource10 = null;
        hikariConfig0.setDataSource(dataSource10);
        hikariConfig0.setTransactionIsolation("HikariPool-26112");
        long long14 = hikariConfig0.getAcquireRetryDelay();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-29198");
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 0 + "'", int6 == 0);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + false + "'", boolean7 == false);
        org.junit.Assert.assertTrue("'" + long14 + "' != '" + 750L + "'", long14 == 750L);
    ...
    public void test16184() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-15719");
        int int14 = hikariConfig0.getAcquireIncrement();
        hikariConfig0.setAutoCommit(false);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
    ...
    public void test16185() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-14549");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test16188() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-24282");
        hikariConfig0.setDataSourceClassName("HikariPool-35208");
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.validate();
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: Unable to get driver for JDBC URL HikariPool-24282");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
    ...
    public void test16190() throws Throwable {
        ...
        javax.sql.DataSource dataSource12 = hikariConfig0.getDataSource();
        hikariConfig0.setUseInstrumentation(false);
        hikariConfig0.setCatalog("HikariPool-35713");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 0L + "'", long6 == 0L);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 5000L + "'", long11 == 5000L);
        org.junit.Assert.assertNull(dataSource12);
    ...
    public void test16191() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-59375");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertNull(str14);
    ...
    public void test16193() throws Throwable {
        ...
        hikariConfig0.setJdbc4ConnectionTest(false);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-12028");
...
// flaky:         org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-63159" + "'", str16, "HikariPool-63159");
    ...
    public void test16195() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-5130");
        ...
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
        org.junit.Assert.assertNull(str11);
// flaky:         org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-63165" + "'", str18, "HikariPool-63165");
        org.junit.Assert.assertNull(dataSource19);
// flaky:         org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-63165" + "'", str20, "HikariPool-63165");
        org.junit.Assert.assertTrue("'" + int25 + "' != '" + 3 + "'", int25 == 3);
        org.junit.Assert.assertTrue("'" + long26 + "' != '" + 600000L + "'", long26 == 600000L);
    }
    ...
    public void test16197() throws Throwable {
        ...
        long long48 = hikariConfig0.getIdleTimeout();
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 10 + "'", int2 == 10);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-63168" + "'", str6, "HikariPool-63168");
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 5000L + "'", long11 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + false + "'", boolean13 == false);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
    ...
    public void test16200() throws Throwable {
        ...
        hikariConfig9.setConnectionTestQuery("HikariPool-30501");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test16202() throws Throwable {
        ...
        hikariConfig0.setReadOnly(true);
        hikariConfig0.setTransactionIsolation("HikariPool-3500");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + false + "'", boolean12 == false);
    }
    ...
    public void test16203() throws Throwable {
        ...
        java.lang.String str16 = hikariConfig0.getPoolName();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-11093");
        long long19 = hikariConfig0.getAcquireRetryDelay();
        long long20 = hikariConfig0.getConnectionTimeout();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-63182" + "'", str16, "HikariPool-63182");
    ...
    public void test16206() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-18418");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-18418 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test16208() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-33364");
        java.lang.String str11 = hikariConfig0.getConnectionInitSql();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 3 + "'", int4 == 3);
        org.junit.Assert.assertTrue("'" + long5 + "' != '" + 52L + "'", long5 == 52L);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 750L + "'", long6 == 750L);
        org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-3952" + "'", str11, "HikariPool-3952");
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-63195" + "'", str11, "HikariPool-63195");
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + false + "'", boolean12 == false);
    ...
    public void test16210() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("");
        java.lang.String str13 = hikariConfig0.getConnectionCustomizerClassName();
        hikariConfig0.setTransactionIsolation("HikariPool-58398");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str6);
...
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-63218" + "'", str12, "HikariPool-63218");
        org.junit.Assert.assertTrue("'" + int15 + "' != '" + 1 + "'", int15 == 1);
    }
    ...
    public void test16215() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean23 + "' != '" + false + "'", boolean23 == false);
        org.junit.Assert.assertNotNull(properties28);
        org.junit.Assert.assertEquals("'" + str31 + "' != '" + "HikariPool-447" + "'", str31, "HikariPool-447");
    }
    ...
    public void test16219() throws Throwable {
        ...
        hikariConfig17.addDataSourceProperty("HikariPool-250", (java.lang.Object) int30);
        hikariConfig17.setDataSourceClassName("HikariPool-377");
        ...
        hikariConfig37.setMaximumPoolSize((int) (byte) 1);
        hikariConfig37.setJdbcUrl("HikariPool-3101");
    ...
    public void test16220() throws Throwable {
        ...
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(dataSource11);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-63236" + "'", str12, "HikariPool-63236");
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + true + "'", boolean15 == true);
        org.junit.Assert.assertNull(str20);
        org.junit.Assert.assertTrue("'" + int23 + "' != '" + 3 + "'", int23 == 3);
        org.junit.Assert.assertNotNull(properties24);
// flaky:         org.junit.Assert.assertEquals("'" + str28 + "' != '" + "HikariPool-63236" + "'", str28, "HikariPool-63236");
        org.junit.Assert.assertNull(str29);
        org.junit.Assert.assertTrue("'" + long30 + "' != '" + 5000L + "'", long30 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean31 + "' != '" + true + "'", boolean31 == true);
    }
    ...
    public void test16222() throws Throwable {
        ...
        hikariConfig13.addDataSourceProperty("HikariPool-250", (java.lang.Object) int26);
        hikariConfig13.setDataSourceClassName("HikariPool-377");
        ...
        hikariConfig33.setMaximumPoolSize((int) (byte) 1);
        hikariConfig33.setJdbcUrl("HikariPool-3101");
        ...
        javax.sql.DataSource dataSource46 = hikariConfig13.getDataSource();
        ...
        boolean boolean49 = hikariConfig47.isReadOnly();
        int int50 = hikariConfig47.getAcquireIncrement();
        java.lang.String str51 = hikariConfig47.getDataSourceClassName();
        long long52 = hikariConfig47.getConnectionTimeout();
        hikariConfig47.setReadOnly(true);
        long long55 = hikariConfig47.getAcquireRetryDelay();
    ...
    public void test16224() throws Throwable {
        ...
        hikariConfig8.setCatalog("HikariPool-47809");
    ...
    public void test16225() throws Throwable {
        ...
        org.junit.Assert.assertNull(str12);
        org.junit.Assert.assertTrue("'" + int18 + "' != '" + 60 + "'", int18 == 60);
// flaky:         org.junit.Assert.assertEquals("'" + str19 + "' != '" + "HikariPool-63251" + "'", str19, "HikariPool-63251");
    ...
    public void test16226() throws Throwable {
        ...
        java.lang.String str22 = hikariConfig9.getDataSourceClassName();
        com.zaxxer.hikari.HikariConfig hikariConfig23 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean24 = hikariConfig23.isJdbc4ConnectionTest();
        long long25 = hikariConfig23.getConnectionTimeout();
        hikariConfig23.setJdbcUrl("");
        ...
        long long36 = hikariConfig23.getIdleTimeout();
        int int37 = hikariConfig23.getMinimumPoolSize();
        int int38 = hikariConfig23.getAcquireIncrement();
        java.lang.String str39 = hikariConfig23.getDataSourceClassName();
        hikariConfig23.setReadOnly(false);
        java.lang.String str42 = hikariConfig23.getCatalog();
        hikariConfig23.setTransactionIsolation("");
        hikariConfig23.setRegisterMbeans(false);
        long long47 = hikariConfig23.getAcquireRetryDelay();
        ...
        hikariConfig49.addDataSourceProperty("hi!", (java.lang.Object) boolean57);
        hikariConfig49.setTransactionIsolation("HikariPool-447");
        java.lang.String str61 = hikariConfig49.getDataSourceClassName();
        java.lang.String str62 = hikariConfig49.getConnectionCustomizerClassName();
        long long63 = hikariConfig49.getMaxLifetime();
        com.zaxxer.hikari.HikariConfig hikariConfig64 = new com.zaxxer.hikari.HikariConfig();
        hikariConfig64.setConnectionInitSql("");
        hikariConfig64.setConnectionInitSql("hi!");
        java.lang.String str69 = hikariConfig64.getConnectionCustomizerClassName();
        boolean boolean70 = hikariConfig64.isReadOnly();
        hikariConfig64.setTransactionIsolation("HikariPool-211");
        ...
        long long81 = hikariConfig79.getConnectionTimeout();
        hikariConfig79.setJdbcUrl("");
        java.lang.String str84 = hikariConfig79.getConnectionCustomizerClassName();
        java.util.Properties properties85 = hikariConfig79.getDataSourceProperties();
        ...
        hikariConfig73.setDataSourceProperties(properties85);
        hikariConfig64.setDataSourceProperties(properties85);
        com.zaxxer.hikari.HikariConfig hikariConfig90 = new com.zaxxer.hikari.HikariConfig(properties85);
        com.zaxxer.hikari.HikariConfig hikariConfig91 = new com.zaxxer.hikari.HikariConfig(properties85);
        com.zaxxer.hikari.HikariConfig hikariConfig92 = new com.zaxxer.hikari.HikariConfig(properties85);
        hikariConfig49.setDataSourceProperties(properties85);
        hikariConfig23.setDataSourceProperties(properties85);
        hikariConfig9.setDataSourceProperties(properties85);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test16228() throws Throwable {
        ...
        hikariConfig9.setConnectionTestQuery("HikariPool-37835");
        java.lang.String str15 = hikariConfig9.getConnectionCustomizerClassName();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test16230() throws Throwable {
        ...
        hikariConfig0.setRegisterMbeans(true);
        java.lang.String str16 = hikariConfig0.getDataSourceClassName();
        hikariConfig0.setTransactionIsolation("HikariPool-63062");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
    ...
    public void test16232() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-62288");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 10 + "'", int4 == 10);
    ...
    public void test16235() throws Throwable {
        ...
        java.util.Properties properties11 = hikariConfig0.getDataSourceProperties();
        com.zaxxer.hikari.HikariConfig hikariConfig12 = new com.zaxxer.hikari.HikariConfig(properties11);
        hikariConfig12.setTransactionIsolation("HikariPool-39925");
    ...
    public void test16237() throws Throwable {
        ...
        boolean boolean12 = hikariConfig0.isInitializationFailFast();
        hikariConfig0.setIsolateInternalQueries(false);
        hikariConfig0.setTransactionIsolation("HikariPool-61650");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 10 + "'", int2 == 10);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 1 + "'", int6 == 1);
    ...
    public void test16238() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-11159");
        java.lang.String str12 = hikariConfig0.getJdbcUrl();
        hikariConfig0.setLeakDetectionThreshold(3L);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 3 + "'", int4 == 3);
    ...
    public void test16239() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-54250");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-54250' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-63290" + "'", str6, "HikariPool-63290");
    }
    ...
    public void test16240() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-42534");
    ...
    public void test16243() throws Throwable {
        ...
        long long15 = hikariConfig0.getIdleTimeout();
        java.lang.String str16 = hikariConfig0.getJdbcUrl();
        hikariConfig0.setCatalog("HikariPool-58820");
        // The following exception was thrown during execution in test generation
        try {
        ...
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-63297" + "'", str7, "HikariPool-63297");
        org.junit.Assert.assertNotNull(properties14);
        org.junit.Assert.assertTrue("'" + long15 + "' != '" + 600000L + "'", long15 == 600000L);
    ...
    public void test16245() throws Throwable {
        ...
        hikariConfig0.setLeakDetectionThreshold(600000L);
        hikariConfig0.setJdbcUrl("HikariPool-54594");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertNull(str2);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-63299" + "'", str6, "HikariPool-63299");
        org.junit.Assert.assertTrue("'" + long7 + "' != '" + 600000L + "'", long7 == 600000L);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 3 + "'", int8 == 3);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
        org.junit.Assert.assertNull(str16);
    ...
    public void test16246() throws Throwable {
        ...
        int int7 = hikariConfig0.getMinimumPoolSize();
        hikariConfig0.setInitializationFailFast(true);
        hikariConfig0.setCatalog("HikariPool-1805");
        java.lang.String str12 = hikariConfig0.getConnectionCustomizerClassName();
        hikariConfig0.setInitializationFailFast(false);
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 10 + "'", int2 == 10);
    ...
    public void test16250() throws Throwable {
        ...
        boolean boolean9 = hikariConfig0.isJdbc4ConnectionTest();
        java.lang.String str10 = hikariConfig0.getConnectionTestQuery();
        hikariConfig0.setDataSourceClassName("HikariPool-4439");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 60 + "'", int6 == 60);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 60 + "'", int7 == 60);
    ...
    public void test16251() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-26313");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-26313 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test16252() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-63309" + "'", str10, "HikariPool-63309");
        org.junit.Assert.assertNull(str11);
    }
    ...
    public void test16253() throws Throwable {
        ...
        int int44 = hikariConfig42.getMinimumPoolSize();
        int int45 = hikariConfig42.getMinimumPoolSize();
        hikariConfig42.setMaxLifetime((long) 1);
        long long48 = hikariConfig42.getAcquireRetryDelay();
        int int49 = hikariConfig42.getTransactionIsolation();
        java.util.Properties properties50 = hikariConfig42.getDataSourceProperties();
        hikariConfig33.setDataSourceProperties(properties50);
    ...
    public void test16254() throws Throwable {
        ...
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 750L + "'", long4 == 750L);
        org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-829" + "'", str11, "HikariPool-829");
    }
    ...
    public void test16256() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-10848");
        hikariConfig0.setTransactionIsolation("HikariPool-26686");
        java.lang.String str22 = hikariConfig0.getCatalog();
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 10 + "'", int12 == 10);
        org.junit.Assert.assertEquals("'" + str22 + "' != '" + "HikariPool-10848" + "'", str22, "HikariPool-10848");
    }
    ...
    public void test16258() throws Throwable {
        ...
        java.lang.String str14 = hikariConfig0.getConnectionInitSql();
        hikariConfig0.setInitializationFailFast(false);
        hikariConfig0.setConnectionInitSql("HikariPool-9057");
        hikariConfig0.setAutoCommit(false);
    ...
    public void test16259() throws Throwable {
        ...
        hikariConfig0.setIdleTimeout((long) (-1));
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-43133");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 3 + "'", int4 == 3);
    }
    ...
    public void test16260() throws Throwable {
        ...
        int int17 = hikariConfig0.getTransactionIsolation();
        hikariConfig0.setDataSourceClassName("HikariPool-32818");
        // The following exception was thrown during execution in test generation
        try {
    ...
    public void test16261() throws Throwable {
        ...
        hikariConfig24.setConnectionTestQuery("HikariPool-137");
        ...
        hikariConfig36.setLeakDetectionThreshold((long) (byte) 1);
        ...
        java.lang.String str48 = hikariConfig24.getConnectionCustomizerClassName();
        hikariConfig16.addDataSourceProperty("HikariPool-370", (java.lang.Object) hikariConfig24);
        hikariConfig24.setAcquireRetries((int) (short) 10);
        hikariConfig24.setIsolateInternalQueries(true);
        int int54 = hikariConfig24.getAcquireRetries();
        hikariConfig24.setConnectionTestQuery("HikariPool-4969");
        int int57 = hikariConfig24.getAcquireRetries();
        hikariConfig0.addDataSourceProperty("HikariPool-46435", (java.lang.Object) int57);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertNull(str21);
        org.junit.Assert.assertTrue("'" + boolean22 + "' != '" + false + "'", boolean22 == false);
    ...
    public void test16266() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-48381");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-48381 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test16267() throws Throwable {
        ...
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + long13 + "' != '" + 750L + "'", long13 == 750L);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-63338" + "'", str14, "HikariPool-63338");
    }
    ...
    public void test16268() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long8 + "' != '" + 750L + "'", long8 == 750L);
        org.junit.Assert.assertTrue("'" + boolean19 + "' != '" + true + "'", boolean19 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-63339" + "'", str20, "HikariPool-63339");
    }
    ...
    public void test16269() throws Throwable {
        ...
        hikariConfig0.setMaxLifetime((-1L));
        hikariConfig0.setMaxLifetime((long) (byte) 0);
        hikariConfig0.setDataSourceClassName("HikariPool-33818");
        // The following exception was thrown during execution in test generation
        try {
    ...
    public void test16272() throws Throwable {
        ...
        hikariConfig8.setConnectionTestQuery("HikariPool-49142");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertNotNull(properties7);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + false + "'", boolean11 == false);
    ...
    public void test16275() throws Throwable {
        ...
        hikariConfig0.setUseInstrumentation(false);
        java.util.Properties properties41 = hikariConfig0.getDataSourceProperties();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test16280() throws Throwable {
        ...
        long long11 = hikariConfig0.getMaxLifetime();
        hikariConfig0.setDataSourceClassName("HikariPool-30345");
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-18926");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-18926' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
    ...
    public void test16281() throws Throwable {
        ...
        org.junit.Assert.assertNull(str16);
        org.junit.Assert.assertNull(str20);
// flaky:         org.junit.Assert.assertEquals("'" + str21 + "' != '" + "HikariPool-63366" + "'", str21, "HikariPool-63366");
    ...
    public void test16282() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + false + "'", boolean7 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-63368" + "'", str12, "HikariPool-63368");
    ...
    public void test16283() throws Throwable {
        ...
        hikariConfig15.setJdbcUrl("HikariPool-137");
        ...
        hikariConfig38.setIdleTimeout(2147483647L);
    ...
    public void test16284() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-63375" + "'", str6, "HikariPool-63375");
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 60 + "'", int7 == 60);
        org.junit.Assert.assertEquals("'" + str12 + "' != '" + "" + "'", str12, "");
        org.junit.Assert.assertTrue("'" + long13 + "' != '" + 600000L + "'", long13 == 600000L);
        org.junit.Assert.assertNull(str16);
    ...
    public void test16290() throws Throwable {
        ...
        hikariConfig0.setInitializationFailFast(true);
        long long9 = hikariConfig0.getLeakDetectionThreshold();
        hikariConfig0.setJdbcUrl("HikariPool-16009");
        hikariConfig0.setMaxLifetime((long) ' ');
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-19429");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-19429' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test16297() throws Throwable {
        ...
        int int19 = hikariConfig1.getAcquireRetries();
        hikariConfig1.setDataSourceClassName("HikariPool-47152");
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNotNull(properties10);
    ...
    public void test16300() throws Throwable {
        ...
        hikariConfig7.setDataSourceClassName("HikariPool-2646");
        hikariConfig7.setReadOnly(false);
        hikariConfig7.setMaximumPoolSize((int) (short) 0);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test16302() throws Throwable {
        ...
        javax.sql.DataSource dataSource8 = null;
        hikariConfig0.setDataSource(dataSource8);
        hikariConfig0.setCatalog("HikariPool-45651");
        hikariConfig0.setJdbcUrl("HikariPool-53550");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
    }
    ...
    public void test16304() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 1800000L + "'", long10 == 1800000L);
        org.junit.Assert.assertNull(str11);
// flaky:         org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-63422" + "'", str16, "HikariPool-63422");
        org.junit.Assert.assertTrue("'" + long22 + "' != '" + 0L + "'", long22 == 0L);
    }
    ...
    public void test16305() throws Throwable {
        ...
        java.lang.String str10 = hikariConfig0.getPoolName();
        java.lang.String str11 = hikariConfig0.getPoolName();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-30716");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
        ...
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + long9 + "' != '" + 600000L + "'", long9 == 600000L);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-63423" + "'", str10, "HikariPool-63423");
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-63423" + "'", str11, "HikariPool-63423");
    }
    ...
    public void test16307() throws Throwable {
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-21595", (java.lang.Object) hikariConfig16);
    ...
    public void test16309() throws Throwable {
        ...
        java.lang.Class<?> wildcardClass19 = hikariConfig9.getClass();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test16311() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + false + "'", boolean17 == false);
        org.junit.Assert.assertTrue("'" + long18 + "' != '" + 1800000L + "'", long18 == 1800000L);
// flaky:         org.junit.Assert.assertEquals("'" + str19 + "' != '" + "HikariPool-63448" + "'", str19, "HikariPool-63448");
    }
    ...
    public void test16312() throws Throwable {
        ...
        hikariConfig10.setConnectionCustomizerClassName("HikariPool-1104");
        hikariConfig10.setUseInstrumentation(true);
        hikariConfig10.setTransactionIsolation("HikariPool-1949");
        ...
        hikariConfig25.setJdbcUrl("HikariPool-801");
        hikariConfig10.addDataSourceProperty("HikariPool-8274", (java.lang.Object) hikariConfig25);
        ...
        hikariConfig35.setConnectionTestQuery("HikariPool-137");
        ...
        java.lang.String str56 = hikariConfig51.getConnectionCustomizerClassName();
        java.util.Properties properties57 = hikariConfig51.getDataSourceProperties();
        hikariConfig48.setDataSourceProperties(properties57);
        hikariConfig48.setRegisterMbeans(true);
        java.lang.String str61 = hikariConfig48.getConnectionInitSql();
        java.lang.String str62 = hikariConfig48.getJdbcUrl();
        long long63 = hikariConfig48.getAcquireRetryDelay();
        hikariConfig48.setPoolName("HikariPool-514");
        hikariConfig48.setMinimumPoolSize((int) (byte) 100);
        com.zaxxer.hikari.HikariConfig hikariConfig68 = new com.zaxxer.hikari.HikariConfig();
        hikariConfig68.setConnectionInitSql("");
        hikariConfig68.setConnectionInitSql("hi!");
        java.lang.String str73 = hikariConfig68.getConnectionCustomizerClassName();
        hikariConfig68.setReadOnly(false);
        com.zaxxer.hikari.HikariConfig hikariConfig76 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean77 = hikariConfig76.isJdbc4ConnectionTest();
        long long78 = hikariConfig76.getConnectionTimeout();
        hikariConfig76.setJdbcUrl("");
        java.lang.String str81 = hikariConfig76.getConnectionCustomizerClassName();
        java.util.Properties properties82 = hikariConfig76.getDataSourceProperties();
        ...
        hikariConfig68.setDataSourceProperties(properties82);
        hikariConfig48.setDataSourceProperties(properties82);
        ...
        hikariConfig10.setDataSourceProperties(properties82);
...
// flaky:         org.junit.Assert.assertEquals("'" + str46 + "' != '" + "HikariPool-63452" + "'", str46, "HikariPool-63452");
        org.junit.Assert.assertTrue("'" + boolean52 + "' != '" + true + "'", boolean52 == true);
        org.junit.Assert.assertTrue("'" + long53 + "' != '" + 5000L + "'", long53 == 5000L);
        org.junit.Assert.assertNull(str56);
        org.junit.Assert.assertNotNull(properties57);
    ...
    public void test16313() throws Throwable {
        ...
        hikariConfig18.setTransactionIsolation("HikariPool-11288");
    ...
    public void test16314() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-14669");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-14669' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertNull(str1);
    ...
    public void test16319() throws Throwable {
        ...
        hikariConfig0.setIdleTimeout(0L);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-63482" + "'", str6, "HikariPool-63482");
        org.junit.Assert.assertTrue("'" + long7 + "' != '" + 600000L + "'", long7 == 600000L);
    }
    ...
    public void test16321() throws Throwable {
        ...
        hikariConfig26.setPoolName("HikariPool-62939");
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 5000L + "'", long11 == 5000L);
    ...
    public void test16323() throws Throwable {
        ...
        int int14 = hikariConfig0.getAcquireIncrement();
        hikariConfig0.setUseInstrumentation(false);
        hikariConfig0.setCatalog("HikariPool-55020");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str6);
    ...
    public void test16326() throws Throwable {
        ...
        hikariConfig0.setIsolateInternalQueries(false);
        hikariConfig0.setMaximumPoolSize(0);
        hikariConfig0.setConnectionTestQuery("HikariPool-49711");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 750L + "'", long4 == 750L);
    }
    ...
    public void test16329() throws Throwable {
        ...
        org.junit.Assert.assertNotNull(properties27);
        org.junit.Assert.assertNull(str33);
        org.junit.Assert.assertEquals("'" + str36 + "' != '" + "HikariPool-3911" + "'", str36, "HikariPool-3911");
    }
    ...
    public void test16330() throws Throwable {
        ...
        java.lang.String str7 = hikariConfig0.getConnectionCustomizerClassName();
        int int8 = hikariConfig0.getTransactionIsolation();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-27404");
    ...
    public void test16331() throws Throwable {
        ...
        hikariConfig8.setMaximumPoolSize((int) 'a');
        hikariConfig0.addDataSourceProperty("HikariPool-2708", (java.lang.Object) hikariConfig8);
        hikariConfig8.setConnectionTestQuery("HikariPool-573");
        com.zaxxer.hikari.HikariConfig hikariConfig22 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean23 = hikariConfig22.isInitializationFailFast();
        ...
        hikariConfig29.setAcquireIncrement((int) (byte) 1);
        java.lang.String str38 = hikariConfig29.getConnectionInitSql();
        hikariConfig22.addDataSourceProperty("HikariPool-575", (java.lang.Object) hikariConfig29);
        long long40 = hikariConfig29.getConnectionTimeout();
        java.util.Properties properties41 = hikariConfig29.getDataSourceProperties();
        hikariConfig8.setDataSourceProperties(properties41);
        java.lang.String str43 = hikariConfig8.getCatalog();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 1800000L + "'", long10 == 1800000L);
        org.junit.Assert.assertNull(str11);
// flaky:         org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-63509" + "'", str16, "HikariPool-63509");
        org.junit.Assert.assertTrue("'" + boolean23 + "' != '" + false + "'", boolean23 == false);
        org.junit.Assert.assertTrue("'" + long26 + "' != '" + 5000L + "'", long26 == 5000L);
        org.junit.Assert.assertNull(str27);
        org.junit.Assert.assertTrue("'" + boolean30 + "' != '" + false + "'", boolean30 == false);
    ...
    public void test16334() throws Throwable {
        ...
        long long5 = hikariConfig0.getIdleTimeout();
        long long6 = hikariConfig0.getIdleTimeout();
        hikariConfig0.setConnectionTestQuery("HikariPool-6970");
        hikariConfig0.setLeakDetectionThreshold((long) 35);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test16335() throws Throwable {
        ...
        boolean boolean54 = hikariConfig23.isInitializationFailFast();
        hikariConfig23.setAcquireRetryDelay((long) 52);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
    ...
    public void test16338() throws Throwable {
        ...
        java.util.Properties properties15 = hikariConfig0.getDataSourceProperties();
        hikariConfig0.setCatalog("HikariPool-6665");
    ...
    public void test16340() throws Throwable {
        ...
        int int46 = hikariConfig37.getMinimumPoolSize();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test16341() throws Throwable {
        ...
        boolean boolean10 = hikariConfig9.isJdbc4ConnectionTest();
        long long11 = hikariConfig9.getConnectionTimeout();
        java.lang.String str12 = hikariConfig9.getJdbcUrl();
        long long13 = hikariConfig9.getAcquireRetryDelay();
        hikariConfig9.setConnectionCustomizerClassName("HikariPool-377");
        int int16 = hikariConfig9.getAcquireIncrement();
        hikariConfig9.setMinimumPoolSize(0);
        hikariConfig0.addDataSourceProperty("HikariPool-3572", (java.lang.Object) 0);
        hikariConfig0.setRegisterMbeans(false);
    ...
    public void test16345() throws Throwable {
        ...
        hikariConfig10.setDataSourceClassName("HikariPool-211");
    ...
    public void test16353() throws Throwable {
        ...
        hikariConfig7.setAcquireRetryDelay(100L);
        com.zaxxer.hikari.HikariConfig hikariConfig14 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean15 = hikariConfig14.isInitializationFailFast();
        javax.sql.DataSource dataSource16 = null;
        hikariConfig14.setDataSource(dataSource16);
    ...
    public void test16359() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig12.setConnectionTimeout((long) 52);
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: connectionTimeout cannot be less than 100ms");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    ...
    public void test16360() throws Throwable {
        ...
        hikariConfig0.setMinimumPoolSize(32);
        java.lang.String str15 = hikariConfig0.getJdbcUrl();
        hikariConfig0.setPoolName("HikariPool-31168");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 60 + "'", int4 == 60);
    ...
    public void test16362() throws Throwable {
        ...
        hikariConfig0.setReadOnly(true);
        hikariConfig0.setDataSourceClassName("HikariPool-49780");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 600000L + "'", long10 == 600000L);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 3 + "'", int11 == 3);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + true + "'", boolean13 == true);
...
// flaky:         org.junit.Assert.assertEquals("'" + str29 + "' != '" + "HikariPool-63609" + "'", str29, "HikariPool-63609");
    }
    ...
    public void test16372() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 0L + "'", long10 == 0L);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-63614" + "'", str11, "HikariPool-63614");
    ...
    public void test16373() throws Throwable {
        ...
        hikariConfig36.setAcquireRetryDelay((long) 3);
        com.zaxxer.hikari.HikariConfig hikariConfig41 = new com.zaxxer.hikari.HikariConfig();
        ...
        hikariConfig41.setConnectionTimeout(0L);
        hikariConfig36.addDataSourceProperty("HikariPool-903", (java.lang.Object) hikariConfig41);
        long long52 = hikariConfig36.getMaxLifetime();
        ...
        java.util.Properties properties59 = hikariConfig56.getDataSourceProperties();
    ...
    public void test16375() throws Throwable {
        ...
        hikariConfig0.setInitializationFailFast(true);
        hikariConfig0.setCatalog("HikariPool-697");
        hikariConfig0.setConnectionTestQuery("HikariPool-32512");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 1 + "'", int6 == 1);
    ...
    public void test16376() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-60250");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-60250 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test16377() throws Throwable {
        ...
        long long77 = hikariConfig0.getAcquireRetryDelay();
        long long78 = hikariConfig0.getMaxLifetime();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
...
// flaky:         org.junit.Assert.assertEquals("'" + str76 + "' != '" + "HikariPool-63628" + "'", str76, "HikariPool-63628");
    ...
    public void test16378() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-23413");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 0L + "'", long6 == 0L);
    }
    ...
    public void test16380() throws Throwable {
        ...
        hikariConfig0.setInitializationFailFast(false);
        java.lang.String str10 = hikariConfig0.getPoolName();
        hikariConfig0.setConnectionTestQuery("HikariPool-23305");
        long long13 = hikariConfig0.getConnectionTimeout();
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-63645" + "'", str10, "HikariPool-63645");
        org.junit.Assert.assertTrue("'" + long13 + "' != '" + 5000L + "'", long13 == 5000L);
    }
    ...
    public void test16381() throws Throwable {
        ...
        org.junit.Assert.assertNull(str4);
        org.junit.Assert.assertNotNull(properties11);
        org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-960" + "'", str16, "HikariPool-960");
    }
    ...
    public void test16384() throws Throwable {
        ...
        hikariConfig0.setMaxLifetime(100L);
        int int8 = hikariConfig0.getAcquireRetries();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-38482");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 10 + "'", int4 == 10);
    ...
    public void test16390() throws Throwable {
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-4493", (java.lang.Object) hikariConfig16);
    ...
    public void test16392() throws Throwable {
        ...
        java.lang.String str14 = hikariConfig0.getPoolName();
        java.lang.String str15 = hikariConfig0.getConnectionCustomizerClassName();
        hikariConfig0.setDataSourceClassName("HikariPool-13322");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-63681" + "'", str14, "HikariPool-63681");
        org.junit.Assert.assertNull(str15);
    }
    ...
    public void test16393() throws Throwable {
        ...
        hikariConfig7.setAcquireRetries((int) 'a');
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test16395() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int26 + "' != '" + 60 + "'", int26 == 60);
        org.junit.Assert.assertTrue("'" + int27 + "' != '" + 60 + "'", int27 == 60);
        org.junit.Assert.assertEquals("'" + str31 + "' != '" + "HikariPool-211" + "'", str31, "HikariPool-211");
    }
    ...
    public void test16396() throws Throwable {
        ...
        hikariConfig32.setAcquireIncrement((int) (byte) 10);
        hikariConfig32.setDataSourceClassName("HikariPool-6068");
        hikariConfig18.addDataSourceProperty("HikariPool-10161", (java.lang.Object) "HikariPool-6068");
        hikariConfig0.addDataSourceProperty("HikariPool-43466", (java.lang.Object) "HikariPool-10161");
        hikariConfig0.setJdbc4ConnectionTest(false);
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
    ...
    public void test16402() throws Throwable {
        ...
        hikariConfig8.setDataSourceClassName("HikariPool-25680");
    ...
    public void test16403() throws Throwable {
        ...
        boolean boolean9 = hikariConfig0.isInitializationFailFast();
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-63706" + "'", str6, "HikariPool-63706");
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
    }
    ...
    public void test16404() throws Throwable {
        ...
        hikariConfig0.setJdbc4ConnectionTest(false);
        hikariConfig0.setReadOnly(false);
        hikariConfig0.setTransactionIsolation("HikariPool-16578");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    }
    ...
    public void test16405() throws Throwable {
        ...
        int int5 = hikariConfig0.getAcquireRetries();
        java.util.Properties properties6 = hikariConfig0.getDataSourceProperties();
        hikariConfig0.setDataSourceClassName("HikariPool-50534");
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-49761");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-49761' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test16407() throws Throwable {
        ...
        javax.sql.DataSource dataSource13 = null;
        hikariConfig0.setDataSource(dataSource13);
        hikariConfig0.setJdbcUrl("HikariPool-4066");
    ...
    public void test16408() throws Throwable {
        ...
        boolean boolean10 = hikariConfig0.isJdbc4ConnectionTest();
        long long11 = hikariConfig0.getMaxLifetime();
        hikariConfig0.setDataSourceClassName("HikariPool-17962");
        hikariConfig0.setInitializationFailFast(false);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
    ...
    public void test16409() throws Throwable {
        ...
        hikariConfig0.setJdbc4ConnectionTest(false);
        hikariConfig0.setDataSourceClassName("HikariPool-57048");
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + true + "'", boolean8 == true);
        org.junit.Assert.assertNull(str15);
    ...
    public void test16411() throws Throwable {
        ...
        hikariConfig23.setMinimumPoolSize((int) (short) 100);
        hikariConfig0.addDataSourceProperty("HikariPool-2463", (java.lang.Object) hikariConfig23);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-53456");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
    ...
    public void test16414() throws Throwable {
        ...
        hikariConfig0.setReadOnly(false);
        int int14 = hikariConfig0.getAcquireRetries();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-50439");
        hikariConfig0.setUseInstrumentation(true);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertNotNull(properties6);
        org.junit.Assert.assertTrue("'" + long7 + "' != '" + 0L + "'", long7 == 0L);
    ...
    public void test16416() throws Throwable {
        ...
        hikariConfig1.setConnectionInitSql("HikariPool-13624");
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
    }
    ...
    public void test16419() throws Throwable {
        ...
        boolean boolean34 = hikariConfig28.isReadOnly();
        ...
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(dataSource11);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-63737" + "'", str12, "HikariPool-63737");
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + true + "'", boolean14 == true);
        org.junit.Assert.assertTrue("'" + long15 + "' != '" + 5000L + "'", long15 == 5000L);
        org.junit.Assert.assertNull(str18);
        org.junit.Assert.assertNotNull(properties19);
    ...
    public void test16421() throws Throwable {
        ...
        hikariConfig8.setMaxLifetime((long) 60);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertNotNull(properties6);
        org.junit.Assert.assertTrue("'" + long9 + "' != '" + 750L + "'", long9 == 750L);
        org.junit.Assert.assertNull(str10);
    ...
    public void test16423() throws Throwable {
        ...
        hikariConfig0.setAutoCommit(true);
        hikariConfig0.setUseInstrumentation(false);
        hikariConfig0.setJdbcUrl("HikariPool-21373");
        hikariConfig0.setConnectionTestQuery("");
        long long16 = hikariConfig0.getMaxLifetime();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
    ...
    public void test16424() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-49102");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-49102 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test16427() throws Throwable {
        ...
        org.junit.Assert.assertNotNull(properties6);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 1 + "'", int11 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-63762" + "'", str12, "HikariPool-63762");
    }
    ...
    public void test16429() throws Throwable {
        ...
        int int14 = hikariConfig0.getMinimumPoolSize();
        int int15 = hikariConfig0.getMaximumPoolSize();
        hikariConfig0.setJdbcUrl("HikariPool-38172");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 10 + "'", int4 == 10);
    ...
    public void test16431() throws Throwable {
        ...
        hikariConfig18.setMaximumPoolSize(60);
    ...
    public void test16432() throws Throwable {
        ...
        javax.sql.DataSource dataSource18 = hikariConfig0.getDataSource();
        hikariConfig0.setReadOnly(false);
        hikariConfig0.setPoolName("HikariPool-25474");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 600000L + "'", long10 == 600000L);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 3 + "'", int11 == 3);
        org.junit.Assert.assertNull(dataSource12);
    ...
    public void test16433() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 1800000L + "'", long6 == 1800000L);
// flaky:         org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-63773" + "'", str9, "HikariPool-63773");
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
        org.junit.Assert.assertNull(str17);
        org.junit.Assert.assertNull(str18);
    }
    ...
    public void test16434() throws Throwable {
        ...
        hikariConfig13.setJdbcUrl("HikariPool-18381");
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig13.setDriverClassName("HikariPool-45876");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-45876' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test16437() throws Throwable {
        ...
        hikariConfig0.setAcquireIncrement(1);
        hikariConfig0.setConnectionTestQuery("HikariPool-6245");
        hikariConfig0.setCatalog("HikariPool-31387");
        int int15 = hikariConfig0.getMaximumPoolSize();
        com.zaxxer.hikari.HikariConfig hikariConfig16 = new com.zaxxer.hikari.HikariConfig();
        java.lang.String str17 = hikariConfig16.getConnectionInitSql();
        long long18 = hikariConfig16.getMaxLifetime();
        ...
        org.junit.Assert.assertTrue("'" + long20 + "' != '" + 750L + "'", long20 == 750L);
        org.junit.Assert.assertNotNull(properties21);
// flaky:         org.junit.Assert.assertEquals("'" + str22 + "' != '" + "HikariPool-63780" + "'", str22, "HikariPool-63780");
        org.junit.Assert.assertNotNull(properties23);
    }
    ...
    public void test16438() throws Throwable {
        ...
        hikariConfig0.setCatalog("");
        javax.sql.DataSource dataSource11 = hikariConfig0.getDataSource();
        hikariConfig0.setDataSourceClassName("HikariPool-12745");
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 0L + "'", long6 == 0L);
        org.junit.Assert.assertNull(dataSource11);
    }
    ...
    public void test16441() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertNull(dataSource10);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-63785" + "'", str13, "HikariPool-63785");
        org.junit.Assert.assertNull(str14);
    }
    ...
    public void test16442() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-8335");
        java.util.Properties properties9 = hikariConfig0.getDataSourceProperties();
        int int10 = hikariConfig0.getMinimumPoolSize();
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
    ...
    public void test16443() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-56349");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
    }
    ...
    public void test16446() throws Throwable {
        ...
        long long10 = hikariConfig0.getIdleTimeout();
        hikariConfig0.setReadOnly(true);
        hikariConfig0.setConnectionInitSql("HikariPool-11782");
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-10078");
        com.zaxxer.hikari.HikariConfig hikariConfig17 = new com.zaxxer.hikari.HikariConfig();
        ...
        long long34 = hikariConfig27.getConnectionTimeout();
        boolean boolean35 = hikariConfig27.isReadOnly();
        hikariConfig27.setConnectionInitSql("HikariPool-829");
        ...
        long long43 = hikariConfig39.getMaxLifetime();
        java.util.Properties properties44 = hikariConfig39.getDataSourceProperties();
        hikariConfig27.setDataSourceProperties(properties44);
    ...
    public void test16447() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 60 + "'", int7 == 60);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-63795" + "'", str11, "HikariPool-63795");
        org.junit.Assert.assertNotNull(properties14);
        org.junit.Assert.assertTrue("'" + int15 + "' != '" + 1 + "'", int15 == 1);
    }
    ...
    public void test16448() throws Throwable {
        ...
        hikariConfig0.setMinimumPoolSize(1);
        boolean boolean16 = hikariConfig0.isRegisterMbeans();
        hikariConfig0.setConnectionInitSql("HikariPool-31102");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 60 + "'", int8 == 60);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
    ...
    public void test16450() throws Throwable {
        ...
        com.zaxxer.hikari.HikariConfig hikariConfig19 = new com.zaxxer.hikari.HikariConfig(properties17);
        hikariConfig19.setConnectionTestQuery("HikariPool-12070");
        hikariConfig19.setConnectionInitSql("HikariPool-57472");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 1800000L + "'", long4 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
    ...
    public void test16453() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-58090");
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 10 + "'", int10 == 10);
    ...
    public void test16455() throws Throwable {
        ...
        java.util.Properties properties8 = hikariConfig0.getDataSourceProperties();
        com.zaxxer.hikari.HikariConfig hikariConfig9 = new com.zaxxer.hikari.HikariConfig(properties8);
        hikariConfig9.setCatalog("HikariPool-47402");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNotNull(properties8);
    ...
    public void test16456() throws Throwable {
        ...
        hikariConfig0.setAcquireIncrement((int) (byte) 10);
        java.util.Properties properties7 = hikariConfig0.getDataSourceProperties();
        hikariConfig0.setJdbcUrl("HikariPool-19153");
        boolean boolean10 = hikariConfig0.isJdbc4ConnectionTest();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNotNull(properties7);
    ...
    public void test16457() throws Throwable {
        ...
        hikariConfig0.setIdleTimeout((long) (short) 0);
        hikariConfig0.setConnectionInitSql("HikariPool-4457");
        java.lang.String str21 = hikariConfig0.getPoolName();
        java.lang.String str22 = hikariConfig0.getConnectionTestQuery();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 5000L + "'", long4 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + long8 + "' != '" + 600000L + "'", long8 == 600000L);
// flaky:         org.junit.Assert.assertEquals("'" + str21 + "' != '" + "HikariPool-63812" + "'", str21, "HikariPool-63812");
    ...
    public void test16459() throws Throwable {
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-49210", (java.lang.Object) long26);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
    ...
    public void test16464() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-47402");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
    ...
    public void test16471() throws Throwable {
        ...
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-63843" + "'", str10, "HikariPool-63843");
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + true + "'", boolean13 == true);
    }
    ...
    public void test16474() throws Throwable {
        ...
        java.lang.String str8 = hikariConfig0.getPoolName();
        long long9 = hikariConfig0.getIdleTimeout();
        hikariConfig0.setTransactionIsolation("HikariPool-11248");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(str5);
// flaky:         org.junit.Assert.assertEquals("'" + str8 + "' != '" + "HikariPool-63849" + "'", str8, "HikariPool-63849");
        org.junit.Assert.assertTrue("'" + long9 + "' != '" + 600000L + "'", long9 == 600000L);
    }
    ...
    public void test16476() throws Throwable {
        ...
        long long27 = hikariConfig16.getIdleTimeout();
        java.lang.String str28 = hikariConfig16.getConnectionCustomizerClassName();
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-36269", (java.lang.Object) boolean34);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertTrue("'" + long8 + "' != '" + 5000L + "'", long8 == 5000L);
    ...
    public void test16477() throws Throwable {
        ...
        java.lang.String str59 = hikariConfig58.getConnectionCustomizerClassName();
        hikariConfig58.setJdbcUrl("HikariPool-510");
        hikariConfig58.setAcquireRetries((int) (byte) 1);
        hikariConfig58.setAutoCommit(false);
        hikariConfig58.setJdbc4ConnectionTest(true);
    ...
    public void test16478() throws Throwable {
        ...
        hikariConfig1.setPoolName("HikariPool-15159");
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNotNull(properties10);
    ...
    public void test16482() throws Throwable {
        ...
        boolean boolean10 = hikariConfig0.isRegisterMbeans();
        java.lang.String str11 = hikariConfig0.getConnectionTestQuery();
        hikariConfig0.setConnectionInitSql("HikariPool-16322");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 3 + "'", int4 == 3);
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + 60 + "'", int9 == 60);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
    ...
    public void test16483() throws Throwable {
        ...
        boolean boolean23 = hikariConfig17.isAutoCommit();
        java.lang.String str24 = hikariConfig17.getPoolName();
        hikariConfig17.setJdbcUrl("HikariPool-1229");
        int int27 = hikariConfig17.getAcquireIncrement();
        long long28 = hikariConfig17.getConnectionTimeout();
        hikariConfig0.addDataSourceProperty("HikariPool-32871", (java.lang.Object) long28);
        hikariConfig0.setMinimumPoolSize((int) (short) 0);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        ...
        org.junit.Assert.assertTrue("'" + boolean20 + "' != '" + false + "'", boolean20 == false);
        org.junit.Assert.assertTrue("'" + boolean23 + "' != '" + true + "'", boolean23 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str24 + "' != '" + "HikariPool-63877" + "'", str24, "HikariPool-63877");
        org.junit.Assert.assertTrue("'" + int27 + "' != '" + 1 + "'", int27 == 1);
        org.junit.Assert.assertTrue("'" + long28 + "' != '" + 5000L + "'", long28 == 5000L);
    }
    ...
    public void test16484() throws Throwable {
        ...
        long long6 = hikariConfig0.getAcquireRetryDelay();
        hikariConfig0.setUseInstrumentation(false);
        hikariConfig0.setTransactionIsolation("HikariPool-39386");
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 750L + "'", long6 == 750L);
    }
    ...
    public void test16485() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 1 + "'", int12 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-63879" + "'", str13, "HikariPool-63879");
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + (-1) + "'", int14 == (-1));
    }
    ...
    public void test16486() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-8363");
        java.lang.String str12 = hikariConfig0.getCatalog();
        java.lang.String str13 = hikariConfig0.getConnectionCustomizerClassName();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
    ...
    public void test16489() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-63884" + "'", str13, "HikariPool-63884");
        org.junit.Assert.assertNull(str14);
    }
    ...
    public void test16491() throws Throwable {
        ...
        org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-137" + "'", str6, "HikariPool-137");
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
// flaky:         org.junit.Assert.assertEquals("'" + str8 + "' != '" + "HikariPool-63886" + "'", str8, "HikariPool-63886");
    }
    ...
    public void test16492() throws Throwable {
        ...
        hikariConfig0.setMinimumPoolSize((int) (byte) 10);
        hikariConfig0.setInitializationFailFast(false);
        hikariConfig0.setCatalog("HikariPool-46112");
        hikariConfig0.setIdleTimeout(60L);
        hikariConfig0.setDataSourceClassName("HikariPool-49907");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
    }
    ...
    public void test16493() throws Throwable {
        ...
        hikariConfig0.setAcquireRetries((int) ' ');
        hikariConfig0.setMaximumPoolSize((int) '4');
        hikariConfig0.setDataSourceClassName("HikariPool-53314");
        org.junit.Assert.assertNull(str5);
    }
    ...
    public void test16497() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-27913");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 60 + "'", int8 == 60);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 750L + "'", long11 == 750L);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-63894" + "'", str12, "HikariPool-63894");
        org.junit.Assert.assertEquals("'" + str15 + "' != '" + "" + "'", str15, "");
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + true + "'", boolean17 == true);
        org.junit.Assert.assertTrue("'" + long18 + "' != '" + 5000L + "'", long18 == 5000L);
        org.junit.Assert.assertNull(str21);
    ...
    public void test16498() throws Throwable {
        ...
        javax.sql.DataSource dataSource3 = hikariConfig0.getDataSource();
        long long4 = hikariConfig0.getAcquireRetryDelay();
        hikariConfig0.setDataSourceClassName("HikariPool-26840");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 750L + "'", long4 == 750L);
    ...
    public void test16499() throws Throwable {
        ...
        hikariConfig0.setMinimumPoolSize(0);
        java.lang.String str15 = hikariConfig0.getConnectionInitSql();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-37814");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str6);
