...
// flaky:         org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-66150" + "'", str16, "HikariPool-66150");
...
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-66151" + "'", str14, "HikariPool-66151");
    }
    ...
    public void test17504() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-12452");
        ...
        org.junit.Assert.assertEquals("'" + str30 + "' != '" + "HikariPool-960" + "'", str30, "HikariPool-960");
    }
    ...
    public void test17505() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-53673");
    ...
    public void test17509() throws Throwable {
        ...
        org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-17958" + "'", str18, "HikariPool-17958");
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str49 + "' != '" + "HikariPool-66168" + "'", str49, "HikariPool-66168");
    }
    ...
    public void test17513() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-43973");
...
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-66173" + "'", str14, "HikariPool-66173");
    ...
    public void test17515() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-41818");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-41818' could not be loaded");
    ...
    public void test17516() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-16453");
        hikariConfig0.setIsolateInternalQueries(false);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
    ...
    public void test17517() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("");
        hikariConfig0.setConnectionInitSql("HikariPool-32689");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 600000L + "'", long2 == 600000L);
        org.junit.Assert.assertTrue("'" + long3 + "' != '" + 750L + "'", long3 == 750L);
    ...
    public void test17518() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-66181" + "'", str14, "HikariPool-66181");
    ...
    public void test17519() throws Throwable {
        ...
        org.junit.Assert.assertNull(str5);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-66182" + "'", str6, "HikariPool-66182");
    }
    ...
    public void test17522() throws Throwable {
        ...
        hikariConfig11.addDataSourceProperty("", (java.lang.Object) hikariConfig22);
    ...
    public void test17527() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-24316");
        hikariConfig0.setAcquireRetries(0);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str5 + "' != '" + "HikariPool-66195" + "'", str5, "HikariPool-66195");
    ...
    public void test17529() throws Throwable {
        ...
        hikariConfig0.setDataSourceClassName("HikariPool-31083");
    ...
    public void test17532() throws Throwable {
        ...
        hikariConfig0.setReadOnly(false);
        hikariConfig0.setDataSourceClassName("");
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-5848");
    ...
    public void test17536() throws Throwable {
        ...
        hikariConfig16.setIdleTimeout(2147483647L);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
    ...
    public void test17537() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-13339");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-13339 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17540() throws Throwable {
        ...
        hikariConfig6.setJdbcUrl("");
        long long11 = hikariConfig6.getAcquireRetryDelay();
        hikariConfig6.setLeakDetectionThreshold((long) (byte) 0);
    ...
    public void test17547() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-5980");
    ...
    public void test17548() throws Throwable {
        ...
        boolean boolean49 = hikariConfig0.isJdbc4ConnectionTest();
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str13);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
...
// flaky:         org.junit.Assert.assertEquals("'" + str34 + "' != '" + "HikariPool-66235" + "'", str34, "HikariPool-66235");
    ...
    public void test17551() throws Throwable {
        ...
        org.junit.Assert.assertNull(dataSource5);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-66236" + "'", str11, "HikariPool-66236");
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + true + "'", boolean16 == true);
    }
    ...
    public void test17555() throws Throwable {
        ...
        java.lang.String str7 = hikariConfig0.getDataSourceClassName();
        hikariConfig0.setDataSourceClassName("HikariPool-63663");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 750L + "'", long4 == 750L);
        org.junit.Assert.assertNull(str7);
    }
    ...
    public void test17557() throws Throwable {
        ...
        hikariConfig0.setInitializationFailFast(false);
        java.util.Properties properties11 = hikariConfig0.getDataSourceProperties();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-27683");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
    ...
    public void test17564() throws Throwable {
        ...
        java.lang.String str11 = hikariConfig0.getPoolName();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-14001");
        java.lang.String str14 = hikariConfig0.getPoolName();
        ...
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-66258" + "'", str11, "HikariPool-66258");
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-66258" + "'", str14, "HikariPool-66258");
    }
    ...
    public void test17565() throws Throwable {
        ...
        hikariConfig11.setConnectionTestQuery("HikariPool-21047");
    ...
    public void test17566() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-50977");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-50977 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17567() throws Throwable {
        ...
        hikariConfig19.setDataSource(dataSource32);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test17569() throws Throwable {
        ...
        org.junit.Assert.assertNotNull(properties6);
        org.junit.Assert.assertNull(str10);
// flaky:         org.junit.Assert.assertEquals("'" + str19 + "' != '" + "HikariPool-66270" + "'", str19, "HikariPool-66270");
    ...
    public void test17571() throws Throwable {
        ...
        java.lang.String str18 = hikariConfig0.getConnectionInitSql();
        hikariConfig0.setConnectionTestQuery("HikariPool-18735");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 600000L + "'", long10 == 600000L);
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + false + "'", boolean17 == false);
        org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-11782" + "'", str18, "HikariPool-11782");
    }
    ...
    public void test17575() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-13813");
    ...
    public void test17578() throws Throwable {
        ...
        boolean boolean33 = hikariConfig29.isRegisterMbeans();
        boolean boolean34 = hikariConfig29.isIsolateInternalQueries();
        ...
        hikariConfig38.setDataSource(dataSource40);
        boolean boolean42 = hikariConfig38.isJdbc4ConnectionTest();
        hikariConfig38.setAcquireRetryDelay(0L);
        java.util.Properties properties45 = hikariConfig38.getDataSourceProperties();
        hikariConfig35.setDataSourceProperties(properties45);
        ...
        hikariConfig29.setDataSourceProperties(properties57);
        ...
        org.junit.Assert.assertNull(str20);
        org.junit.Assert.assertNotNull(properties21);
// flaky:         org.junit.Assert.assertEquals("'" + str26 + "' != '" + "HikariPool-66286" + "'", str26, "HikariPool-66286");
    ...
    public void test17581() throws Throwable {
        ...
        hikariConfig21.setAcquireRetryDelay(600000L);
        java.lang.String str32 = hikariConfig21.getJdbcUrl();
        long long33 = hikariConfig21.getIdleTimeout();
        ...
        hikariConfig34.setIdleTimeout((long) 60);
        hikariConfig34.setReadOnly(false);
        hikariConfig34.setConnectionTestQuery("HikariPool-6653");
        ...
        hikariConfig21.setDataSourceProperties(properties50);
    ...
    public void test17582() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-55421");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-55421 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17583() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-63338");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-63338 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17586() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-10161");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertNull(str6);
    ...
    public void test17590() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-31168");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-31168 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17598() throws Throwable {
        ...
        hikariConfig0.setMaxLifetime(0L);
        hikariConfig0.setJdbc4ConnectionTest(true);
        hikariConfig0.setTransactionIsolation("HikariPool-3448");
    ...
    public void test17604() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-36084");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str10);
    ...
    public void test17607() throws Throwable {
        ...
        hikariConfig7.setConnectionTestQuery("HikariPool-51362");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test17611() throws Throwable {
        ...
        int int6 = hikariConfig0.getAcquireIncrement();
        long long7 = hikariConfig0.getConnectionTimeout();
        hikariConfig0.setPoolName("HikariPool-25962");
    ...
    public void test17612() throws Throwable {
        ...
        hikariConfig19.setJdbcUrl("HikariPool-7638");
    ...
    public void test17614() throws Throwable {
        ...
        hikariConfig0.setAutoCommit(false);
        hikariConfig0.setPoolName("HikariPool-27539");
        int int14 = hikariConfig0.getTransactionIsolation();
    ...
    public void test17616() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 10 + "'", int12 == 10);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + false + "'", boolean13 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-66364" + "'", str16, "HikariPool-66364");
        org.junit.Assert.assertNotNull(properties17);
        org.junit.Assert.assertTrue("'" + int21 + "' != '" + 1 + "'", int21 == 1);
        org.junit.Assert.assertTrue("'" + boolean22 + "' != '" + false + "'", boolean22 == false);
        org.junit.Assert.assertTrue("'" + boolean23 + "' != '" + true + "'", boolean23 == true);
    ...
    public void test17617() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-32022");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(str17);
    }
    ...
    public void test17618() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-32177");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 10 + "'", int2 == 10);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 1 + "'", int6 == 1);
    ...
    public void test17619() throws Throwable {
        ...
        java.lang.String str11 = hikariConfig0.getCatalog();
        hikariConfig0.setLeakDetectionThreshold((long) (short) 100);
        hikariConfig0.setPoolName("HikariPool-15280");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test17621() throws Throwable {
        ...
        hikariConfig0.setMaxLifetime((long) 10);
        hikariConfig0.setJdbcUrl("HikariPool-17196");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test17625() throws Throwable {
        ...
        hikariConfig14.setCatalog("HikariPool-573");
        hikariConfig14.setAcquireIncrement((int) (byte) 10);
        hikariConfig14.setDataSourceClassName("HikariPool-6068");
        hikariConfig0.addDataSourceProperty("HikariPool-10161", (java.lang.Object) "HikariPool-6068");
        hikariConfig0.setPoolName("HikariPool-5275");
        ...
        int int30 = hikariConfig26.getMaximumPoolSize();
        ...
        hikariConfig26.setMaximumPoolSize((int) (short) 100);
        ...
        long long53 = hikariConfig39.getMaxLifetime();
    ...
    public void test17626() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-37208");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-37208' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
    ...
    public void test17629() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-32936");
    ...
    public void test17631() throws Throwable {
        ...
        hikariConfig61.setTransactionIsolation("HikariPool-50790");
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNotNull(properties10);
    ...
    public void test17632() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-3979");
        int int4 = hikariConfig0.getMaximumPoolSize();
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 60 + "'", int4 == 60);
    }
    ...
    public void test17638() throws Throwable {
        ...
        java.lang.String str23 = hikariConfig9.getPoolName();
        hikariConfig9.addDataSourceProperty("HikariPool-57086", (java.lang.Object) "HikariPool-42077");
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig9.setDriverClassName("HikariPool-31955");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-31955' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        ...
        org.junit.Assert.assertNull(str19);
        org.junit.Assert.assertNull(str22);
// flaky:         org.junit.Assert.assertEquals("'" + str23 + "' != '" + "HikariPool-66425" + "'", str23, "HikariPool-66425");
    }
    ...
    public void test17644() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-34193");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
    ...
    public void test17645() throws Throwable {
        ...
        org.junit.Assert.assertNull(dataSource5);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-66433" + "'", str11, "HikariPool-66433");
        org.junit.Assert.assertTrue("'" + long14 + "' != '" + 5000L + "'", long14 == 5000L);
    }
    ...
    public void test17657() throws Throwable {
        ...
        hikariConfig0.setMaximumPoolSize(35);
        hikariConfig0.setCatalog("HikariPool-10616");
    ...
    public void test17658() throws Throwable {
        ...
        java.lang.String str44 = hikariConfig35.getConnectionCustomizerClassName();
        hikariConfig35.setAcquireRetryDelay((long) (byte) 0);
        hikariConfig35.setMinimumPoolSize(0);
        hikariConfig35.setAcquireRetryDelay(10L);
        long long51 = hikariConfig35.getIdleTimeout();
        hikariConfig35.setLeakDetectionThreshold((long) (byte) 10);
        hikariConfig35.setJdbc4ConnectionTest(true);
        long long56 = hikariConfig35.getIdleTimeout();
        hikariConfig16.addDataSourceProperty("HikariPool-11215", (java.lang.Object) long56);
        boolean boolean58 = hikariConfig16.isInitializationFailFast();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
    ...
    public void test17666() throws Throwable {
        ...
        hikariConfig20.setConnectionInitSql("HikariPool-137");
        int int25 = hikariConfig20.getTransactionIsolation();
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-26600", (java.lang.Object) int29);
    ...
    public void test17667() throws Throwable {
        ...
        hikariConfig12.setConnectionInitSql("HikariPool-2708");
        ...
        java.lang.String str57 = hikariConfig44.getConnectionInitSql();
        java.lang.String str58 = hikariConfig44.getJdbcUrl();
        long long59 = hikariConfig44.getAcquireRetryDelay();
        hikariConfig44.setPoolName("HikariPool-514");
        ...
        boolean boolean73 = hikariConfig72.isJdbc4ConnectionTest();
        long long74 = hikariConfig72.getConnectionTimeout();
        hikariConfig72.setJdbcUrl("");
        java.lang.String str77 = hikariConfig72.getConnectionCustomizerClassName();
        java.util.Properties properties78 = hikariConfig72.getDataSourceProperties();
        ...
        hikariConfig64.setDataSourceProperties(properties78);
        hikariConfig44.setDataSourceProperties(properties78);
        ...
        long long88 = hikariConfig0.getConnectionTimeout();
        java.lang.String str89 = hikariConfig0.getConnectionTestQuery();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(dataSource5);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-66471" + "'", str11, "HikariPool-66471");
        org.junit.Assert.assertNull(str13);
...
// flaky:         org.junit.Assert.assertEquals("'" + str42 + "' != '" + "HikariPool-66473" + "'", str42, "HikariPool-66473");
    ...
    public void test17668() throws Throwable {
        ...
        boolean boolean20 = hikariConfig0.isJdbc4ConnectionTest();
        hikariConfig0.setDataSourceClassName("HikariPool-36269");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
    ...
    public void test17671() throws Throwable {
        ...
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 10 + "'", int8 == 10);
// flaky:         org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-66488" + "'", str9, "HikariPool-66488");
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 3 + "'", int10 == 3);
    }
    ...
    public void test17674() throws Throwable {
        ...
        int int10 = hikariConfig0.getMaximumPoolSize();
        hikariConfig0.setAcquireRetries(0);
        hikariConfig0.setTransactionIsolation("HikariPool-47798");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test17680() throws Throwable {
        ...
        org.junit.Assert.assertNotNull(properties23);
        org.junit.Assert.assertTrue("'" + int28 + "' != '" + 1 + "'", int28 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str29 + "' != '" + "HikariPool-66501" + "'", str29, "HikariPool-66501");
    }
    ...
    public void test17682() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-18526");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-18526 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17685() throws Throwable {
        ...
        hikariConfig0.setDataSourceProperties(properties16);
        hikariConfig0.setConnectionInitSql("HikariPool-25145");
    ...
    public void test17687() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-903" + "'", str20, "HikariPool-903");
    }
    ...
    public void test17688() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-47077");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-47077 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17694() throws Throwable {
        ...
        int int17 = hikariConfig9.getTransactionIsolation();
        int int18 = hikariConfig9.getAcquireRetries();
        boolean boolean19 = hikariConfig9.isReadOnly();
        int int20 = hikariConfig9.getTransactionIsolation();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test17695() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("");
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-13483");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 600000L + "'", long10 == 600000L);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 3 + "'", int11 == 3);
        org.junit.Assert.assertNull(dataSource12);
    ...
    public void test17697() throws Throwable {
        ...
        org.junit.Assert.assertNull(str12);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + false + "'", boolean13 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-66536" + "'", str14, "HikariPool-66536");
    }
    ...
    public void test17702() throws Throwable {
        ...
        hikariConfig0.setDataSourceClassName("HikariPool-41982");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNotNull(properties14);
    ...
    public void test17710() throws Throwable {
        ...
        hikariConfig0.setIsolateInternalQueries(false);
        hikariConfig0.setConnectionTestQuery("HikariPool-28042");
    ...
    public void test17711() throws Throwable {
        ...
        org.junit.Assert.assertNull(str21);
        org.junit.Assert.assertNotNull(properties22);
// flaky:         org.junit.Assert.assertEquals("'" + str30 + "' != '" + "HikariPool-66560" + "'", str30, "HikariPool-66560");
        org.junit.Assert.assertTrue("'" + boolean35 + "' != '" + false + "'", boolean35 == false);
    }
    ...
    public void test17712() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-10084");
    ...
    public void test17715() throws Throwable {
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-23324", (java.lang.Object) "HikariPool-27347");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
    ...
    public void test17718() throws Throwable {
        ...
        java.lang.Class<?> wildcardClass22 = hikariConfig10.getClass();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str8);
    ...
    public void test17726() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-45150");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertNull(dataSource10);
    ...
    public void test17727() throws Throwable {
        ...
        hikariConfig0.setDataSourceProperties(properties22);
        com.zaxxer.hikari.HikariConfig hikariConfig24 = new com.zaxxer.hikari.HikariConfig(properties22);
        boolean boolean25 = hikariConfig24.isIsolateInternalQueries();
        ...
        org.junit.Assert.assertTrue("'" + int16 + "' != '" + 1 + "'", int16 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str21 + "' != '" + "HikariPool-66590" + "'", str21, "HikariPool-66590");
        org.junit.Assert.assertNotNull(properties22);
        org.junit.Assert.assertTrue("'" + boolean25 + "' != '" + false + "'", boolean25 == false);
    }
    ...
    public void test17729() throws Throwable {
        ...
        hikariConfig0.setMinimumPoolSize((int) '4');
        hikariConfig0.setPoolName("HikariPool-9559");
        hikariConfig0.setConnectionTestQuery("HikariPool-47057");
    ...
    public void test17730() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-6519");
    ...
    public void test17732() throws Throwable {
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-17314", (java.lang.Object) false);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
    ...
    public void test17734() throws Throwable {
        ...
        long long32 = hikariConfig23.getMaxLifetime();
    ...
    public void test17737() throws Throwable {
        ...
        hikariConfig0.setIdleTimeout((long) (-1));
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-15191");
        hikariConfig0.setMaxLifetime((long) (-1));
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
    ...
    public void test17738() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-4289");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test17740() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig24.setDriverClassName("HikariPool-24445");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-24445' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test17742() throws Throwable {
        ...
        hikariConfig5.setMinimumPoolSize((int) (byte) 0);
    ...
    public void test17745() throws Throwable {
        ...
        java.lang.String str15 = hikariConfig0.getConnectionTestQuery();
        long long16 = hikariConfig0.getConnectionTimeout();
        hikariConfig0.setConnectionInitSql("HikariPool-56862");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 5000L + "'", long4 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 10 + "'", int12 == 10);
    ...
    public void test17749() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-33942");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertTrue("'" + long12 + "' != '" + 1800000L + "'", long12 == 1800000L);
    ...
    public void test17750() throws Throwable {
        ...
        hikariConfig0.setAutoCommit(false);
        hikariConfig0.setCatalog("HikariPool-31792");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test17753() throws Throwable {
        ...
        hikariConfig25.setTransactionIsolation("HikariPool-8012");
        hikariConfig25.setMaximumPoolSize((int) (short) 1);
    ...
    public void test17758() throws Throwable {
        ...
        hikariConfig0.setAcquireRetries(10);
        hikariConfig0.setUseInstrumentation(false);
        hikariConfig0.setJdbcUrl("HikariPool-60153");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test17761() throws Throwable {
        ...
        javax.sql.DataSource dataSource28 = hikariConfig21.getDataSource();
        java.util.Properties properties29 = hikariConfig21.getDataSourceProperties();
        hikariConfig11.setDataSourceProperties(properties29);
        com.zaxxer.hikari.HikariConfig hikariConfig31 = new com.zaxxer.hikari.HikariConfig(properties29);
    ...
    public void test17762() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-45608");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-45608 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17765() throws Throwable {
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-250", (java.lang.Object) str25);
        ...
        org.junit.Assert.assertEquals("'" + str25 + "' != '" + "HikariPool-377" + "'", str25, "HikariPool-377");
        org.junit.Assert.assertTrue("'" + boolean27 + "' != '" + false + "'", boolean27 == false);
    }
    ...
    public void test17767() throws Throwable {
        ...
        org.junit.Assert.assertNull(str18);
        org.junit.Assert.assertTrue("'" + long21 + "' != '" + 1800000L + "'", long21 == 1800000L);
// flaky:         org.junit.Assert.assertEquals("'" + str22 + "' != '" + "HikariPool-66694" + "'", str22, "HikariPool-66694");
    }
    ...
    public void test17768() throws Throwable {
        ...
        java.util.Properties properties37 = hikariConfig34.getDataSourceProperties();
        com.zaxxer.hikari.HikariConfig hikariConfig38 = new com.zaxxer.hikari.HikariConfig(properties37);
    ...
    public void test17771() throws Throwable {
        ...
        hikariConfig19.setPoolName("HikariPool-14265");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertTrue("'" + boolean20 + "' != '" + false + "'", boolean20 == false);
    ...
    public void test17772() throws Throwable {
        ...
        long long10 = hikariConfig0.getAcquireRetryDelay();
        hikariConfig0.setTransactionIsolation("HikariPool-37313");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + false + "'", boolean7 == false);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 750L + "'", long10 == 750L);
    ...
    public void test17773() throws Throwable {
        ...
        hikariConfig1.setConnectionCustomizerClassName("HikariPool-62382");
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNotNull(properties10);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 3 + "'", int12 == 3);
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + false + "'", boolean15 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-66709" + "'", str16, "HikariPool-66709");
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + false + "'", boolean17 == false);
        org.junit.Assert.assertTrue("'" + int18 + "' != '" + 60 + "'", int18 == 60);
    ...
    public void test17776() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 600000L + "'", long10 == 600000L);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-66713" + "'", str11, "HikariPool-66713");
        org.junit.Assert.assertTrue("'" + long12 + "' != '" + 5000L + "'", long12 == 5000L);
    ...
    public void test17780() throws Throwable {
        ...
        long long23 = hikariConfig21.getMaxLifetime();
        java.lang.String str24 = hikariConfig21.getConnectionCustomizerClassName();
        int int25 = hikariConfig21.getMinimumPoolSize();
        hikariConfig21.setCatalog("HikariPool-250");
        hikariConfig21.setAcquireIncrement((int) (short) 10);
        hikariConfig21.setPoolName("HikariPool-960");
        hikariConfig14.addDataSourceProperty("HikariPool-8895", (java.lang.Object) "HikariPool-960");
        hikariConfig0.addDataSourceProperty("HikariPool-5027", (java.lang.Object) hikariConfig14);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
    ...
    public void test17782() throws Throwable {
        ...
        hikariConfig10.setConnectionCustomizerClassName("HikariPool-11180");
        hikariConfig0.addDataSourceProperty("HikariPool-20012", (java.lang.Object) hikariConfig10);
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 3 + "'", int6 == 3);
...
// flaky:         org.junit.Assert.assertEquals("'" + str5 + "' != '" + "HikariPool-66737" + "'", str5, "HikariPool-66737");
        org.junit.Assert.assertNull(str8);
    }
    ...
    public void test17786() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-66738" + "'", str11, "HikariPool-66738");
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 60 + "'", int14 == 60);
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + true + "'", boolean15 == true);
    }
    ...
    public void test17788() throws Throwable {
        ...
        hikariConfig0.setAcquireRetries(60);
        hikariConfig0.setRegisterMbeans(true);
        hikariConfig0.setCatalog("HikariPool-18984");
        boolean boolean14 = hikariConfig0.isRegisterMbeans();
        hikariConfig0.setCatalog("HikariPool-37778");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 10 + "'", int2 == 10);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + true + "'", boolean14 == true);
    ...
    public void test17789() throws Throwable {
        ...
        hikariConfig1.setDataSourceClassName("HikariPool-61738");
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNotNull(properties10);
    ...
    public void test17790() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-25895");
        hikariConfig0.setAutoCommit(true);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 600000L + "'", long10 == 600000L);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
    ...
    public void test17793() throws Throwable {
        ...
        hikariConfig14.setReadOnly(false);
        hikariConfig14.setPoolName("HikariPool-7401");
        hikariConfig0.addDataSourceProperty("HikariPool-46368", (java.lang.Object) "HikariPool-7401");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 60 + "'", int4 == 60);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 3 + "'", int5 == 3);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-66750" + "'", str6, "HikariPool-66750");
        org.junit.Assert.assertNull(str11);
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + false + "'", boolean12 == false);
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + true + "'", boolean15 == true);
        org.junit.Assert.assertTrue("'" + long20 + "' != '" + 0L + "'", long20 == 0L);
    ...
    public void test17794() throws Throwable {
        ...
        hikariConfig0.setMaximumPoolSize(60);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-37143");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNotNull(properties14);
    ...
    public void test17795() throws Throwable {
        ...
        hikariConfig0.setJdbc4ConnectionTest(false);
        long long12 = hikariConfig0.getAcquireRetryDelay();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-51044");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 600000L + "'", long2 == 600000L);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
    ...
    public void test17800() throws Throwable {
        ...
        hikariConfig14.setTransactionIsolation("HikariPool-137");
        hikariConfig14.setInitializationFailFast(false);
        java.lang.String str30 = hikariConfig14.getConnectionCustomizerClassName();
        hikariConfig14.setUseInstrumentation(true);
        hikariConfig14.setPoolName("HikariPool-1707");
        int int35 = hikariConfig14.getMaximumPoolSize();
        boolean boolean36 = hikariConfig14.isAutoCommit();
        ...
        boolean boolean46 = hikariConfig37.isReadOnly();
        hikariConfig37.setIdleTimeout((long) 0);
        boolean boolean49 = hikariConfig37.isRegisterMbeans();
    ...
    public void test17801() throws Throwable {
        ...
        hikariConfig0.setMinimumPoolSize(10);
        java.lang.String str16 = hikariConfig0.getDataSourceClassName();
        hikariConfig0.setConnectionInitSql("HikariPool-21943");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str6);
    ...
    public void test17802() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-30498");
        hikariConfig0.setInitializationFailFast(false);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
    ...
    public void test17803() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-30501");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-30501 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17804() throws Throwable {
        ...
        hikariConfig0.setConnectionTestQuery("HikariPool-22912");
        hikariConfig0.setMaxLifetime(1L);
        com.zaxxer.hikari.HikariConfig hikariConfig18 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean19 = hikariConfig18.isInitializationFailFast();
        boolean boolean20 = hikariConfig18.isReadOnly();
        ...
        hikariConfig0.addDataSourceProperty("HikariPool-24861", (java.lang.Object) hikariConfig18);
        com.zaxxer.hikari.HikariConfig hikariConfig31 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean32 = hikariConfig31.isJdbc4ConnectionTest();
        hikariConfig31.setMaxLifetime((long) '4');
        ...
        hikariConfig31.addDataSourceProperty("HikariPool-564", (java.lang.Object) hikariConfig50);
        hikariConfig50.setMaximumPoolSize(10);
        hikariConfig50.setIsolateInternalQueries(false);
        boolean boolean56 = hikariConfig50.isAutoCommit();
        hikariConfig50.setConnectionCustomizerClassName("HikariPool-18686");
        hikariConfig50.setRegisterMbeans(false);
        hikariConfig18.addDataSourceProperty("HikariPool-16639", (java.lang.Object) hikariConfig50);
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test17811() throws Throwable {
        ...
        hikariConfig0.setMinimumPoolSize(32);
        hikariConfig0.setLeakDetectionThreshold(97L);
        hikariConfig0.setPoolName("HikariPool-59131");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + long8 + "' != '" + 750L + "'", long8 == 750L);
        org.junit.Assert.assertTrue("'" + long9 + "' != '" + 0L + "'", long9 == 0L);
    }
    ...
    public void test17814() throws Throwable {
        ...
        hikariConfig9.setInitializationFailFast(true);
        hikariConfig9.setIdleTimeout((long) (short) 0);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test17815() throws Throwable {
        ...
        int int8 = hikariConfig7.getAcquireRetries();
        java.lang.String str9 = hikariConfig7.getCatalog();
        hikariConfig7.setPoolName("HikariPool-1230");
    ...
    public void test17816() throws Throwable {
        ...
        hikariConfig23.setAutoCommit(true);
        java.lang.Class<?> wildcardClass57 = hikariConfig23.getClass();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
    ...
    public void test17823() throws Throwable {
        ...
        hikariConfig17.setJdbcUrl("HikariPool-28063");
        javax.sql.DataSource dataSource20 = null;
    ...
    public void test17826() throws Throwable {
        ...
        hikariConfig9.setInitializationFailFast(true);
        hikariConfig9.setTransactionIsolation("HikariPool-37584");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test17827() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 1 + "'", int7 == 1);
        org.junit.Assert.assertNotNull(properties8);
// flaky:         org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-66841" + "'", str9, "HikariPool-66841");
    }
    ...
    public void test17834() throws Throwable {
        ...
        boolean boolean15 = hikariConfig0.isReadOnly();
        hikariConfig0.setJdbc4ConnectionTest(false);
        hikariConfig0.setJdbcUrl("HikariPool-6245");
    ...
    public void test17838() throws Throwable {
        ...
        hikariConfig0.setLeakDetectionThreshold(0L);
        hikariConfig0.setJdbc4ConnectionTest(true);
        hikariConfig0.setConnectionTestQuery("HikariPool-19329");
    ...
    public void test17841() throws Throwable {
        ...
        hikariConfig0.setCatalog("HikariPool-40371");
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
    }
    ...
    public void test17843() throws Throwable {
        ...
        hikariConfig0.setDataSource(dataSource8);
        java.lang.String str10 = hikariConfig0.getConnectionInitSql();
        hikariConfig0.setCatalog("HikariPool-16124");
        com.zaxxer.hikari.HikariConfig hikariConfig13 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean14 = hikariConfig13.isInitializationFailFast();
        ...
        hikariConfig13.setConnectionInitSql("HikariPool-8148");
    ...
    public void test17845() throws Throwable {
        ...
        org.junit.Assert.assertNull(str13);
        org.junit.Assert.assertNull(str16);
// flaky:         org.junit.Assert.assertEquals("'" + str17 + "' != '" + "HikariPool-66868" + "'", str17, "HikariPool-66868");
        org.junit.Assert.assertTrue("'" + int18 + "' != '" + 1 + "'", int18 == 1);
        org.junit.Assert.assertNull(str19);
    }
    ...
    public void test17848() throws Throwable {
        ...
        org.junit.Assert.assertNull(str18);
        org.junit.Assert.assertTrue("'" + long19 + "' != '" + 0L + "'", long19 == 0L);
// flaky:         org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-66872" + "'", str20, "HikariPool-66872");
// flaky:         org.junit.Assert.assertEquals("'" + str25 + "' != '" + "HikariPool-66872" + "'", str25, "HikariPool-66872");
    }
    ...
    public void test17849() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-801");
        java.util.Properties properties12 = hikariConfig0.getDataSourceProperties();
        hikariConfig0.setCatalog("HikariPool-29075");
        hikariConfig0.setJdbc4ConnectionTest(true);
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
    ...
    public void test17852() throws Throwable {
        ...
        hikariConfig0.setTransactionIsolation("HikariPool-27332");
        javax.sql.DataSource dataSource13 = hikariConfig0.getDataSource();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
    ...
    public void test17853() throws Throwable {
        ...
        hikariConfig0.setConnectionInitSql("HikariPool-62526");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
    ...
    public void test17855() throws Throwable {
        ...
        long long10 = hikariConfig0.getIdleTimeout();
        hikariConfig0.setLeakDetectionThreshold((long) (byte) -1);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-2438");
        hikariConfig0.setAcquireRetryDelay(10L);
        int int17 = hikariConfig0.getAcquireRetries();
        hikariConfig0.setReadOnly(false);
        org.junit.Assert.assertNull(str5);
    ...
    public void test17859() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 10 + "'", int2 == 10);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-66887" + "'", str6, "HikariPool-66887");
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 5000L + "'", long11 == 5000L);
// flaky:         org.junit.Assert.assertEquals("'" + str16 + "' != '" + "HikariPool-66887" + "'", str16, "HikariPool-66887");
    }
    ...
    public void test17860() throws Throwable {
        ...
        boolean boolean60 = hikariConfig56.isInitializationFailFast();
        hikariConfig56.setMinimumPoolSize(0);
        hikariConfig56.setJdbc4ConnectionTest(false);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 600000L + "'", long10 == 600000L);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-66888" + "'", str11, "HikariPool-66888");
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + true + "'", boolean17 == true);
        org.junit.Assert.assertTrue("'" + long18 + "' != '" + 5000L + "'", long18 == 5000L);
        org.junit.Assert.assertNull(str21);
        org.junit.Assert.assertNotNull(properties22);
    ...
    public void test17861() throws Throwable {
        ...
        hikariConfig20.setAutoCommit(true);
        java.lang.String str40 = hikariConfig20.getPoolName();
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
...
// flaky:         org.junit.Assert.assertEquals("'" + str40 + "' != '" + "HikariPool-66902" + "'", str40, "HikariPool-66902");
    }
    ...
    public void test17862() throws Throwable {
        ...
        javax.sql.DataSource dataSource9 = hikariConfig0.getDataSource();
        boolean boolean10 = hikariConfig0.isIsolateInternalQueries();
        hikariConfig0.setConnectionInitSql("HikariPool-52739");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str6);
    ...
    public void test17864() throws Throwable {
        ...
        int int18 = hikariConfig0.getAcquireRetries();
        boolean boolean19 = hikariConfig0.isAutoCommit();
        hikariConfig0.setTransactionIsolation("HikariPool-44626");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + false + "'", boolean12 == false);
    ...
    public void test17866() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-66912" + "'", str9, "HikariPool-66912");
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
    }
    ...
    public void test17867() throws Throwable {
        ...
        hikariConfig7.setJdbc4ConnectionTest(false);
        long long16 = hikariConfig7.getMaxLifetime();
        java.lang.Class<?> wildcardClass17 = hikariConfig7.getClass();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNotNull(properties6);
    ...
    public void test17868() throws Throwable {
        ...
        int int22 = hikariConfig1.getAcquireIncrement();
        hikariConfig1.setConnectionInitSql("HikariPool-30318");
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNotNull(properties10);
    ...
    public void test17869() throws Throwable {
        ...
        hikariConfig0.setMinimumPoolSize(3);
        hikariConfig0.setJdbcUrl("HikariPool-57303");
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 5000L + "'", long10 == 5000L);
        org.junit.Assert.assertNull(str13);
    ...
    public void test17870() throws Throwable {
        ...
        hikariConfig0.setPoolName("HikariPool-34466");
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 10 + "'", int12 == 10);
    ...
    public void test17872() throws Throwable {
        ...
        hikariConfig0.setDataSourceProperties(properties39);
        hikariConfig0.setUseInstrumentation(false);
        hikariConfig0.setJdbcUrl("HikariPool-52998");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
    ...
    public void test17873() throws Throwable {
        ...
        boolean boolean11 = hikariConfig0.isRegisterMbeans();
        boolean boolean12 = hikariConfig0.isRegisterMbeans();
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-29610");
        ...
        hikariConfig17.setDataSourceClassName("HikariPool-211");
        hikariConfig17.setCatalog("hi!");
        hikariConfig17.setDataSourceClassName("HikariPool-6000");
        java.util.Properties properties27 = hikariConfig17.getDataSourceProperties();
        hikariConfig0.addDataSourceProperty("HikariPool-1324", (java.lang.Object) hikariConfig17);
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
        org.junit.Assert.assertNull(str6);
        ...
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + false + "'", boolean11 == false);
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + false + "'", boolean12 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-66935" + "'", str15, "HikariPool-66935");
        org.junit.Assert.assertNull(str18);
    ...
    public void test17875() throws Throwable {
        ...
        hikariConfig16.setDataSourceClassName("HikariPool-211");
        hikariConfig16.setConnectionInitSql("HikariPool-9754");
    ...
    public void test17877() throws Throwable {
        ...
        java.lang.String str44 = hikariConfig41.getDataSourceClassName();
    ...
    public void test17880() throws Throwable {
        ...
        long long13 = hikariConfig0.getIdleTimeout();
        hikariConfig0.setMaxLifetime(0L);
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-51380");
        hikariConfig0.setAcquireRetries(1);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
    ...
    public void test17882() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str5 + "' != '" + "HikariPool-66964" + "'", str5, "HikariPool-66964");
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 3 + "'", int8 == 3);
    }
    ...
    public void test17883() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-26420");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-26420 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17885() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-15484");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-15484 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17886() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-3587");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-3587' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test17887() throws Throwable {
        ...
        hikariConfig38.setAutoCommit(true);
        hikariConfig38.setConnectionCustomizerClassName("HikariPool-1104");
        int int50 = hikariConfig38.getAcquireRetries();
        hikariConfig38.setUseInstrumentation(false);
        boolean boolean53 = hikariConfig38.isInitializationFailFast();
        hikariConfig38.setJdbcUrl("HikariPool-5130");
        java.util.Properties properties56 = hikariConfig38.getDataSourceProperties();
        hikariConfig7.setDataSourceProperties(properties56);
        com.zaxxer.hikari.HikariConfig hikariConfig58 = new com.zaxxer.hikari.HikariConfig(properties56);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        ...
        org.junit.Assert.assertNull(str11);
        org.junit.Assert.assertNull(str12);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-66975" + "'", str15, "HikariPool-66975");
        org.junit.Assert.assertTrue("'" + boolean21 + "' != '" + false + "'", boolean21 == false);
        org.junit.Assert.assertTrue("'" + boolean24 + "' != '" + true + "'", boolean24 == true);
        org.junit.Assert.assertNotNull(properties27);
        org.junit.Assert.assertNull(str32);
    ...
    public void test17889() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + true + "'", boolean18 == true);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + (-1) + "'", int19 == (-1));
        org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-250" + "'", str20, "HikariPool-250");
    }
    ...
    public void test17891() throws Throwable {
        ...
        hikariConfig54.setDataSource(dataSource55);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 3 + "'", int1 == 3);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 600000L + "'", long10 == 600000L);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-66986" + "'", str11, "HikariPool-66986");
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + true + "'", boolean17 == true);
        org.junit.Assert.assertTrue("'" + long18 + "' != '" + 5000L + "'", long18 == 5000L);
        org.junit.Assert.assertNull(str21);
        org.junit.Assert.assertNotNull(properties22);
    ...
    public void test17895() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-51788");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    }
    ...
    public void test17896() throws Throwable {
        ...
        hikariConfig8.setConnectionInitSql("HikariPool-22776");
        com.zaxxer.hikari.HikariConfig hikariConfig22 = new com.zaxxer.hikari.HikariConfig();
        ...
        hikariConfig22.setIdleTimeout(10L);
        com.zaxxer.hikari.HikariConfig hikariConfig34 = new com.zaxxer.hikari.HikariConfig();
        boolean boolean35 = hikariConfig34.isInitializationFailFast();
        boolean boolean36 = hikariConfig34.isReadOnly();
        javax.sql.DataSource dataSource37 = hikariConfig34.getDataSource();
        int int38 = hikariConfig34.getAcquireIncrement();
        hikariConfig34.setRegisterMbeans(true);
        hikariConfig34.setMaximumPoolSize((int) '#');
        java.lang.String str43 = hikariConfig34.getPoolName();
        ...
        hikariConfig8.setDataSourceProperties(properties44);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertNotNull(properties7);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + false + "'", boolean11 == false);
        ...
        org.junit.Assert.assertTrue("'" + int38 + "' != '" + 1 + "'", int38 == 1);
// flaky:         org.junit.Assert.assertEquals("'" + str43 + "' != '" + "HikariPool-67015" + "'", str43, "HikariPool-67015");
    ...
    public void test17897() throws Throwable {
        ...
        hikariConfig0.setDataSourceClassName("HikariPool-6918");
        hikariConfig0.setDataSourceClassName("HikariPool-16250");
        hikariConfig0.setTransactionIsolation("HikariPool-8688");
        hikariConfig0.setPoolName("HikariPool-31387");
        org.junit.Assert.assertNull(str1);
    }
    ...
    public void test17898() throws Throwable {
        ...
        java.lang.String str14 = hikariConfig0.getPoolName();
        hikariConfig0.setCatalog("HikariPool-4364");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 1 + "'", int4 == 1);
        ...
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 750L + "'", long6 == 750L);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + true + "'", boolean13 == true);
        org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-1969" + "'", str14, "HikariPool-1969");
    }
    ...
    public void test17899() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertNull(str3);
// flaky:         org.junit.Assert.assertEquals("'" + str8 + "' != '" + "HikariPool-67018" + "'", str8, "HikariPool-67018");
        org.junit.Assert.assertTrue("'" + long13 + "' != '" + 0L + "'", long13 == 0L);
        org.junit.Assert.assertNull(str20);
    ...
    public void test17903() throws Throwable {
        ...
        hikariConfig0.setAcquireIncrement((int) 'a');
        hikariConfig0.setIdleTimeout(5000L);
        hikariConfig0.setPoolName("HikariPool-22392");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
    }
    ...
    public void test17904() throws Throwable {
        ...
        boolean boolean9 = hikariConfig0.isReadOnly();
        int int10 = hikariConfig0.getAcquireRetries();
        hikariConfig0.setConnectionInitSql("HikariPool-15455");
        long long13 = hikariConfig0.getLeakDetectionThreshold();
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.validate();
    ...
    public void test17907() throws Throwable {
        ...
        boolean boolean17 = hikariConfig0.isAutoCommit();
        boolean boolean18 = hikariConfig0.isJdbc4ConnectionTest();
        hikariConfig0.setCatalog("HikariPool-56924");
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 10 + "'", int10 == 10);
    ...
    public void test17915() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-65100");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-65100' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        ...
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
        org.junit.Assert.assertNull(dataSource11);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-67052" + "'", str12, "HikariPool-67052");
    }
    ...
    public void test17918() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-67056" + "'", str7, "HikariPool-67056");
        org.junit.Assert.assertTrue("'" + long14 + "' != '" + 1800000L + "'", long14 == 1800000L);
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 60 + "'", int17 == 60);
    }
    ...
    public void test17919() throws Throwable {
        ...
        java.lang.String str27 = hikariConfig11.getConnectionCustomizerClassName();
        long long28 = hikariConfig11.getAcquireRetryDelay();
        hikariConfig11.setConnectionInitSql("HikariPool-60180");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(str17);
        org.junit.Assert.assertNull(str24);
    ...
    public void test17922() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + (-1) + "'", int8 == (-1));
        org.junit.Assert.assertNull(str9);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-67066" + "'", str14, "HikariPool-67066");
        org.junit.Assert.assertTrue("'" + int15 + "' != '" + (-1) + "'", int15 == (-1));
    }
    ...
    public void test17924() throws Throwable {
        ...
        java.util.Properties properties15 = hikariConfig0.getDataSourceProperties();
        boolean boolean16 = hikariConfig0.isInitializationFailFast();
        hikariConfig0.setTransactionIsolation("HikariPool-60655");
    ...
    public void test17925() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setDriverClassName("HikariPool-36339");
            org.junit.Assert.fail("Expected exception of type java.lang.RuntimeException; message: driverClassName specified class 'HikariPool-36339' could not be loaded");
        } catch (java.lang.RuntimeException e) {
        // Expected exception.
        }
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
    ...
    public void test17926() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-48212");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-48212 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17930() throws Throwable {
        ...
        long long10 = hikariConfig0.getMaxLifetime();
        java.lang.String str11 = hikariConfig0.getConnectionCustomizerClassName();
        hikariConfig0.setCatalog("HikariPool-8688");
        int int14 = hikariConfig0.getAcquireRetries();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
    ...
    public void test17933() throws Throwable {
        ...
        hikariConfig0.setJdbcUrl("HikariPool-30934");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 1 + "'", int3 == 1);
        org.junit.Assert.assertNull(str4);
        ...
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 0L + "'", long11 == 0L);
        org.junit.Assert.assertTrue("'" + long12 + "' != '" + 5000L + "'", long12 == 5000L);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-67087" + "'", str13, "HikariPool-67087");
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + true + "'", boolean14 == true);
    }
    ...
    public void test17938() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int15 + "' != '" + 10 + "'", int15 == 10);
        org.junit.Assert.assertNull(dataSource16);
// flaky:         org.junit.Assert.assertEquals("'" + str17 + "' != '" + "HikariPool-67093" + "'", str17, "HikariPool-67093");
    }
    ...
    public void test17939() throws Throwable {
        ...
        hikariConfig17.setAcquireRetryDelay(1800000L);
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 1800000L + "'", long2 == 1800000L);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test17941() throws Throwable {
        ...
        boolean boolean49 = hikariConfig18.isAutoCommit();
        com.zaxxer.hikari.HikariConfig hikariConfig50 = new com.zaxxer.hikari.HikariConfig();
        ...
        boolean boolean58 = hikariConfig50.isReadOnly();
        ...
        java.lang.String str65 = hikariConfig60.getConnectionCustomizerClassName();
        java.util.Properties properties66 = hikariConfig60.getDataSourceProperties();
        ...
        hikariConfig18.setDataSourceProperties(properties66);
    ...
    public void test17945() throws Throwable {
        ...
        hikariConfig0.setAcquireRetryDelay((long) (byte) 0);
        hikariConfig0.setConnectionInitSql("HikariPool-48839");
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig0.setMinimumPoolSize((int) (short) -1);
    ...
    public void test17948() throws Throwable {
        ...
        hikariConfig30.addDataSourceProperty("HikariPool-11326", (java.lang.Object) hikariConfig50);
        hikariConfig16.addDataSourceProperty("HikariPool-564", (java.lang.Object) hikariConfig50);
        hikariConfig16.setAcquireRetries(1);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
    ...
    public void test17951() throws Throwable {
        ...
        hikariConfig28.setDataSource(dataSource39);
        java.lang.String str41 = hikariConfig28.getCatalog();
        com.zaxxer.hikari.HikariConfig hikariConfig43 = new com.zaxxer.hikari.HikariConfig();
        ...
        hikariConfig28.addDataSourceProperty("HikariPool-250", (java.lang.Object) boolean49);
        long long51 = hikariConfig28.getIdleTimeout();
        hikariConfig28.setAutoCommit(true);
        ...
        hikariConfig28.setDataSourceProperties(properties59);
    ...
    public void test17955() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-5275" + "'", str14, "HikariPool-5275");
        org.junit.Assert.assertTrue("'" + long17 + "' != '" + 0L + "'", long17 == 0L);
    }
    ...
    public void test17960() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-27310");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-27310 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17964() throws Throwable {
        ...
        boolean boolean19 = hikariConfig0.isInitializationFailFast();
        hikariConfig0.setConnectionTestQuery("HikariPool-19443");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test17966() throws Throwable {
        ...
        boolean boolean6 = hikariConfig0.isReadOnly();
        int int7 = hikariConfig0.getMaximumPoolSize();
        hikariConfig0.setDataSourceClassName("HikariPool-6133");
    ...
    public void test17967() throws Throwable {
        ...
        hikariConfig0.setIsolateInternalQueries(true);
        hikariConfig0.setAutoCommit(false);
        hikariConfig0.setConnectionTestQuery("HikariPool-15853");
        hikariConfig0.setAcquireRetryDelay((long) ' ');
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(str5);
    ...
    public void test17971() throws Throwable {
        ...
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str5 + "' != '" + "HikariPool-67173" + "'", str5, "HikariPool-67173");
        org.junit.Assert.assertNotNull(properties8);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 5000L + "'", long10 == 5000L);
    }
    ...
    public void test17974() throws Throwable {
        ...
        hikariConfig15.addDataSourceProperty("HikariPool-11822", (java.lang.Object) str34);
        boolean boolean36 = hikariConfig15.isRegisterMbeans();
        long long37 = hikariConfig15.getAcquireRetryDelay();
        hikariConfig0.addDataSourceProperty("HikariPool-2322", (java.lang.Object) long37);
        hikariConfig0.setInitializationFailFast(false);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertTrue("'" + long2 + "' != '" + 5000L + "'", long2 == 5000L);
        org.junit.Assert.assertNull(dataSource5);
    ...
    public void test17976() throws Throwable {
        ...
        int int32 = hikariConfig18.getMinimumPoolSize();
    ...
    public void test17983() throws Throwable {
        ...
        boolean boolean58 = hikariConfig47.isAutoCommit();
        hikariConfig0.addDataSourceProperty("HikariPool-15940", (java.lang.Object) boolean58);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + true + "'", boolean1 == true);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + long7 + "' != '" + 750L + "'", long7 == 750L);
        org.junit.Assert.assertNull(str10);
    ...
    public void test17985() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-65156");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-65156 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17986() throws Throwable {
        ...
        hikariConfig0.setAutoCommit(false);
        java.lang.String str10 = hikariConfig0.getCatalog();
        hikariConfig0.setDataSourceClassName("HikariPool-30483");
        javax.sql.DataSource dataSource13 = hikariConfig0.getDataSource();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 5000L + "'", long4 == 5000L);
        org.junit.Assert.assertNull(str5);
    ...
    public void test17994() throws Throwable {
        ...
        hikariConfig7.setCatalog("HikariPool-65042");
    ...
    public void test17995() throws Throwable {
        ...
        long long14 = hikariConfig0.getAcquireRetryDelay();
        hikariConfig0.setJdbcUrl("HikariPool-50548");
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertNull(dataSource3);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
    ...
    public void test18000() throws Throwable {
        ...
        hikariConfig1.setJdbcUrl("HikariPool-48272");
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + long6 + "' != '" + 5000L + "'", long6 == 5000L);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNotNull(properties10);
