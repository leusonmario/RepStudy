...
public class RegressionTest34 {
    ...
    public void test17001() throws Throwable {
        ...
        long long54 = hikariConfig1.getMaxLifetime();
...
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 60L + "'", long5 == 60L);
    ...
    public void test17003() throws Throwable {
        ...
        hikariConfig1.connectionTestQuery = "HikariPool-12120";
    ...
    public void test17008() throws Throwable {
        ...
        hikariConfig1.setConnectionCustomizerClassName("HikariPool-29823");
...
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-46530" + "'", str11, "HikariPool-46530");
    ...
    public void test17011() throws Throwable {
        ...
        hikariConfig1.connectionInitSql = "HikariPool-13747";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long8 + "' != '" + 60L + "'", long8 == 60L);
    ...
    public void test17016() throws Throwable {
        ...
        hikariConfig1.connectionInitSql = "HikariPool-431";
        hikariConfig1.setRegisterMbeans(false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long3 + "' != '" + 60L + "'", long3 == 60L);
    ...
    public void test17017() throws Throwable {
        ...
        long long14 = hikariConfig1.getIdleTimeout();
        hikariConfig1.dataSourceClassName = "HikariPool-37454";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str7);
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 60L + "'", long14 == 60L);
    ...
    public void test17018() throws Throwable {
        ...
        hikariConfig31.setConnectionCustomizerClassName("HikariPool-25240");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
...
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-46564" + "'", str10, "HikariPool-46564");
        org.junit.Assert.assertNull(str11);
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-46565" + "'", str7, "HikariPool-46565");
    }
    ...
    public void test17026() throws Throwable {
        ...
        hikariConfig26.dataSourceClassName = "HikariPool-19912";
        org.junit.Assert.assertNull(str4);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertTrue("'" + long12 + "' != '" + 0L + "'", long12 == 0L);
...
// flaky:         org.junit.Assert.assertEquals("'" + str17 + "' != '" + "HikariPool-46574" + "'", str17, "HikariPool-46574");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 35L + "'", long12 == 35L);
    ...
    public void test17033() throws Throwable {
        ...
        hikariConfig1.setConnectionCustomizerClassName("HikariPool-39692");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 60L + "'", long5 == 60L);
    ...
    public void test17038() throws Throwable {
        ...
        long long97 = hikariConfig1.idleTimeout;
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(iConnectionCustomizer9);
...
// flaky:         org.junit.Assert.assertTrue("'" + long69 + "' != '" + 60L + "'", long69 == 60L);
        ...
        org.junit.Assert.assertEquals("'" + str96 + "' != '" + "HikariPool-222" + "'", str96, "HikariPool-222");
// flaky:         org.junit.Assert.assertTrue("'" + long97 + "' != '" + 60L + "'", long97 == 60L);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long18 + "' != '" + 60L + "'", long18 == 60L);
    ...
    public void test17040() throws Throwable {
        ...
        hikariConfig15.idleTimeout = (short) 0;
        hikariConfig1.addDataSourceProperty("HikariPool-11422", (java.lang.Object) hikariConfig15);
    ...
    public void test17041() throws Throwable {
        ...
        boolean boolean13 = hikariConfig1.isRegisterMbeans();
        hikariConfig1.connectionTestQuery = "HikariPool-3343";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 60 + "'", int6 == 60);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
// flaky:         org.junit.Assert.assertEquals("'" + str8 + "' != '" + "HikariPool-46597" + "'", str8, "HikariPool-46597");
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + false + "'", boolean13 == false);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 35L + "'", long7 == 35L);
    ...
    public void test17045() throws Throwable {
        ...
        hikariConfig1.dataSourceClassName = "HikariPool-975";
        hikariConfig1.setCatalog("HikariPool-35705");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 35L + "'", long9 == 35L);
    ...
    public void test17046() throws Throwable {
        ...
        hikariConfig1.setConnectionInitSql("HikariPool-33818");
        hikariConfig1.connectionInitSql = "HikariPool-39864";
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
    ...
    public void test17050() throws Throwable {
        ...
        hikariConfig1.setCatalog("HikariPool-1921");
        hikariConfig1.setRegisterMbeans(true);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
...
// flaky:         org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-46615" + "'", str9, "HikariPool-46615");
    }
    ...
    public void test17055() throws Throwable {
        ...
        hikariConfig11.connectionTimeout = 97;
        boolean boolean35 = hikariConfig11.isInitializationFailFast;
        hikariConfig11.setMinimumPoolSize((int) (short) 100);
        hikariConfig11.setLeakDetectionThreshold((long) 'a');
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer40 = hikariConfig11.connectionCustomizer;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str7);
...
// flaky:         org.junit.Assert.assertEquals("'" + str32 + "' != '" + "HikariPool-46619" + "'", str32, "HikariPool-46619");
    ...
    public void test17057() throws Throwable {
        ...
        hikariConfig1.connectionCustomizerClassName = "HikariPool-407";
    ...
    public void test17058() throws Throwable {
        ...
        hikariConfig1.connectionTestQuery = "HikariPool-35094";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 60 + "'", int6 == 60);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 60L + "'", long11 == 60L);
    ...
    public void test17059() throws Throwable {
        ...
        hikariConfig1.setConnectionTestQuery("HikariPool-552");
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer25 = hikariConfig1.connectionCustomizer;
        hikariConfig1.connectionTestQuery = "HikariPool-23116";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str7);
...
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + 35L + "'", long21 == 35L);
    ...
    public void test17060() throws Throwable {
        ...
        hikariConfig16.setMaximumPoolSize((int) (byte) 10);
        hikariConfig16.setConnectionInitSql("HikariPool-1485");
...
// flaky:         org.junit.Assert.assertEquals("'" + str21 + "' != '" + "HikariPool-46627" + "'", str21, "HikariPool-46627");
        org.junit.Assert.assertNotNull(properties28);
    }
...
// flaky:             org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
    ...
    public void test17065() throws Throwable {
        ...
        java.lang.String str35 = hikariConfig32.catalog;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str7);
    ...
    public void test17066() throws Throwable {
        ...
        hikariConfig1.setCatalog("HikariPool-1591");
        hikariConfig1.poolName = "HikariPool-6022";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str7);
...
// flaky:         org.junit.Assert.assertTrue("'" + long18 + "' != '" + 60L + "'", long18 == 60L);
    ...
    public void test17067() throws Throwable {
        ...
        hikariConfig13.idleTimeout = (short) 0;
        hikariConfig1.addDataSourceProperty("HikariPool-222", (java.lang.Object) (short) 0);
        hikariConfig1.connectionCustomizerClassName = "HikariPool-596";
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 10L + "'", long11 == 10L);
    ...
    public void test17070() throws Throwable {
        ...
        hikariConfig1.setConnectionInitSql("HikariPool-10516");
        java.util.Properties properties14 = hikariConfig1.getDataSourceProperties();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + (-1) + "'", int11 == (-1));
        org.junit.Assert.assertNotNull(properties14);
    ...
    public void test17071() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-36371");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-36371 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17072() throws Throwable {
        ...
        hikariConfig21.maxPoolSize = (short) 100;
        javax.sql.DataSource dataSource31 = null;
        hikariConfig21.setDataSource(dataSource31);
        java.lang.String str33 = hikariConfig21.connectionTestQuery;
        java.lang.String str34 = hikariConfig21.connectionInitSql;
        hikariConfig21.transactionIsolationName = "HikariPool-2269";
        int int37 = hikariConfig21.acquireRetries;
        java.lang.String str38 = hikariConfig21.getConnectionInitSql();
        ...
        hikariConfig40.maxLifetime = 32L;
        java.util.Properties properties52 = hikariConfig40.dataSourceProperties;
        hikariConfig21.dataSourceProperties = properties52;
        ...
        org.junit.Assert.assertNull(str17);
        org.junit.Assert.assertTrue("'" + int22 + "' != '" + (-1) + "'", int22 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "HikariPool-104" + "'", str33, "HikariPool-104");
    ...
    public void test17073() throws Throwable {
        ...
        hikariConfig1.setConnectionInitSql("HikariPool-25008");
    ...
    public void test17074() throws Throwable {
        ...
        hikariConfig1.poolName = "HikariPool-35148";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 60 + "'", int6 == 60);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
    ...
    public void test17077() throws Throwable {
        ...
        java.lang.String str63 = hikariConfig15.getConnectionCustomizerClassName();
        boolean boolean64 = hikariConfig15.isInitializationFailFast();
        hikariConfig15.setCatalog("HikariPool-756");
        java.util.Properties properties67 = hikariConfig15.getDataSourceProperties();
        ...
        hikariConfig70.transactionIsolation = (byte) 100;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
        org.junit.Assert.assertNull(str7);
...
// flaky:         org.junit.Assert.assertEquals("'" + str30 + "' != '" + "HikariPool-46668" + "'", str30, "HikariPool-46668");
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
    ...
    public void test17080() throws Throwable {
        ...
        hikariConfig0.catalog = "HikariPool-449";
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 10L + "'", long7 == 10L);
    ...
    public void test17081() throws Throwable {
        ...
        java.lang.String str24 = hikariConfig11.connectionCustomizerClassName;
        hikariConfig11.poolName = "HikariPool-5752";
        hikariConfig11.transactionIsolation = (short) 10;
    ...
    public void test17083() throws Throwable {
        ...
        org.junit.Assert.assertNull(str11);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + true + "'", boolean14 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-46675" + "'", str15, "HikariPool-46675");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 60L + "'", long17 == 60L);
    ...
    public void test17085() throws Throwable {
        ...
        hikariConfig1.connectionCustomizerClassName = "HikariPool-13356";
    ...
    public void test17086() throws Throwable {
        ...
        java.lang.String str87 = hikariConfig1.getPoolName();
        hikariConfig1.addDataSourceProperty("HikariPool-5274", (java.lang.Object) "HikariPool-10137");
        long long91 = hikariConfig1.connectionTimeout;
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(iConnectionCustomizer9);
...
// flaky:         org.junit.Assert.assertTrue("'" + long69 + "' != '" + 60L + "'", long69 == 60L);
        ...
        org.junit.Assert.assertEquals("'" + str87 + "' != '" + "HikariPool-222" + "'", str87, "HikariPool-222");
// flaky:         org.junit.Assert.assertTrue("'" + long91 + "' != '" + 10L + "'", long91 == 10L);
    ...
    public void test17087() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-33042");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-33042 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17089() throws Throwable {
        ...
        hikariConfig1.connectionCustomizerClassName = "HikariPool-24547";
        hikariConfig1.setDataSourceClassName("HikariPool-1458");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 0 + "'", int10 == 0);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-46698" + "'", str13, "HikariPool-46698");
    ...
    public void test17092() throws Throwable {
        ...
        int int29 = hikariConfig19.transactionIsolation;
...
// flaky:         org.junit.Assert.assertTrue("'" + long25 + "' != '" + 35L + "'", long25 == 35L);
    ...
    public void test17095() throws Throwable {
        ...
        hikariConfig1.setMinimumPoolSize((int) (byte) 100);
        hikariConfig1.setAutoCommit(false);
        hikariConfig1.setConnectionCustomizerClassName("HikariPool-44484");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(dataSource7);
    }
    ...
    public void test17096() throws Throwable {
        ...
        hikariConfig1.connectionCustomizerClassName = "HikariPool-468";
...
// flaky:         org.junit.Assert.assertTrue("'" + long24 + "' != '" + 35L + "'", long24 == 35L);
    ...
    public void test17098() throws Throwable {
        ...
        hikariConfig31.connectionTestQuery = "HikariPool-1544";
    ...
    public void test17100() throws Throwable {
        ...
        hikariConfig85.isRegisterMbeans = false;
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(iConnectionCustomizer9);
...
// flaky:         org.junit.Assert.assertTrue("'" + long69 + "' != '" + 60L + "'", long69 == 60L);
    ...
    public void test17101() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertNull(str10);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-46737" + "'", str15, "HikariPool-46737");
        org.junit.Assert.assertNull(str18);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
    ...
    public void test17103() throws Throwable {
        ...
        java.lang.String str16 = hikariConfig1.catalog;
        hikariConfig1.connectionCustomizerClassName = "HikariPool-41313";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
...
// flaky:         org.junit.Assert.assertTrue("'" + long8 + "' != '" + 10L + "'", long8 == 10L);
    ...
    public void test17109() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 60L + "'", long5 == 60L);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-46748" + "'", str6, "HikariPool-46748");
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-46748" + "'", str7, "HikariPool-46748");
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + (-1) + "'", int8 == (-1));
...
// flaky:         org.junit.Assert.assertEquals("'" + str1 + "' != '" + "HikariPool-46750" + "'", str1, "HikariPool-46750");
        org.junit.Assert.assertNull(dataSource4);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 0 + "'", int7 == 0);
        org.junit.Assert.assertNull(iConnectionCustomizer10);
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 60L + "'", long13 == 60L);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-46750" + "'", str14, "HikariPool-46750");
    }
...
// flaky:         org.junit.Assert.assertEquals("'" + str1 + "' != '" + "HikariPool-46751" + "'", str1, "HikariPool-46751");
        org.junit.Assert.assertNull(str6);
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 60L + "'", long7 == 60L);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 0L + "'", long10 == 0L);
    }
    ...
    public void test17112() throws Throwable {
        ...
        hikariConfig11.setConnectionTestQuery("HikariPool-1242");
...
// flaky:         org.junit.Assert.assertEquals("'" + str29 + "' != '" + "HikariPool-46753" + "'", str29, "HikariPool-46753");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long20 + "' != '" + 60L + "'", long20 == 60L);
    ...
    public void test17116() throws Throwable {
        ...
        hikariConfig1.setDataSourceProperties(properties22);
        hikariConfig1.setDataSourceClassName("HikariPool-10805");
        long long26 = hikariConfig1.idleTimeout;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 10L + "'", long6 == 10L);
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-46757" + "'", str7, "HikariPool-46757");
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + (-1) + "'", int10 == (-1));
        org.junit.Assert.assertNull(str13);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + (-1) + "'", int14 == (-1));
        org.junit.Assert.assertNull(str15);
...
// flaky:         org.junit.Assert.assertTrue("'" + long26 + "' != '" + 60L + "'", long26 == 60L);
    ...
    public void test17117() throws Throwable {
        ...
        hikariConfig1.setPoolName("HikariPool-1611");
        hikariConfig1.connectionInitSql = "HikariPool-957";
        java.util.Properties properties24 = null;
        com.zaxxer.hikari.HikariConfig hikariConfig25 = new com.zaxxer.hikari.HikariConfig(properties24);
        int int26 = hikariConfig25.getTransactionIsolation();
        hikariConfig25.setRegisterMbeans(false);
        ...
        boolean boolean35 = hikariConfig25.isInitializationFailFast;
        int int36 = hikariConfig25.getTransactionIsolation();
        hikariConfig25.minPoolSize = '4';
        java.util.Properties properties39 = null;
        com.zaxxer.hikari.HikariConfig hikariConfig40 = new com.zaxxer.hikari.HikariConfig(properties39);
        hikariConfig40.leakDetectionThreshold = 100;
        boolean boolean43 = hikariConfig40.isJdbc4connectionTest;
        long long44 = hikariConfig40.getIdleTimeout();
        java.lang.String str45 = hikariConfig40.getPoolName();
        hikariConfig40.setMaximumPoolSize((int) (byte) 10);
        hikariConfig40.setConnectionInitSql("HikariPool-1485");
        hikariConfig40.isJdbc4connectionTest = false;
...
// flaky:         org.junit.Assert.assertEquals("'" + str45 + "' != '" + "HikariPool-46761" + "'", str45, "HikariPool-46761");
        org.junit.Assert.assertNotNull(properties52);
    }
    ...
    public void test17118() throws Throwable {
        ...
        java.lang.String str24 = hikariConfig17.poolName;
        int int25 = hikariConfig17.getTransactionIsolation();
        hikariConfig17.setIdleTimeout(35L);
        hikariConfig17.isJdbc4connectionTest = true;
        hikariConfig1.addDataSourceProperty("HikariPool-18969", (java.lang.Object) true);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str7);
...
// flaky:         org.junit.Assert.assertTrue("'" + long20 + "' != '" + 60L + "'", long20 == 60L);
    ...
    public void test17125() throws Throwable {
        ...
        int int43 = hikariConfig10.minPoolSize;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str8);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-46780" + "'", str11, "HikariPool-46780");
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 35L + "'", long15 == 35L);
    ...
    public void test17126() throws Throwable {
        ...
        java.lang.String str15 = hikariConfig1.getDataSourceClassName();
        hikariConfig1.setConnectionCustomizerClassName("HikariPool-18158");
...
// flaky:         org.junit.Assert.assertEquals("'" + str25 + "' != '" + "HikariPool-46795" + "'", str25, "HikariPool-46795");
        org.junit.Assert.assertNotNull(properties26);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 10L + "'", long11 == 10L);
        org.junit.Assert.assertNull(str12);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-46797" + "'", str13, "HikariPool-46797");
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
    }
    ...
    public void test17134() throws Throwable {
        ...
        hikariConfig1.catalog = "HikariPool-311";
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 60L + "'", long14 == 60L);
    ...
    public void test17136() throws Throwable {
        ...
        hikariConfig1.connectionTestQuery = "HikariPool-277";
    ...
    public void test17137() throws Throwable {
        ...
        hikariConfig1.connectionInitSql = "HikariPool-65";
        hikariConfig1.connectionTestQuery = "HikariPool-19064";
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + 60 + "'", int9 == 60);
...
// flaky:         org.junit.Assert.assertTrue("'" + long25 + "' != '" + 60L + "'", long25 == 60L);
    ...
    public void test17141() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-39005");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-39005 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertNotNull(properties8);
// flaky:         org.junit.Assert.assertEquals("'" + str9 + "' != '" + "HikariPool-46812" + "'", str9, "HikariPool-46812");
        org.junit.Assert.assertNull(str10);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 10L + "'", long11 == 10L);
    ...
    public void test17145() throws Throwable {
        ...
        hikariConfig1.setTransactionIsolation("HikariPool-42966");
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(iConnectionCustomizer9);
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 60L + "'", long14 == 60L);
    ...
    public void test17147() throws Throwable {
        ...
        java.lang.String str32 = hikariConfig31.connectionInitSql;
        hikariConfig31.setIdleTimeout((long) (byte) -1);
        long long35 = hikariConfig31.idleTimeout;
        hikariConfig31.setDataSourceClassName("HikariPool-18899");
        java.util.Properties properties38 = null;
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig31.setDataSourceProperties(properties38);
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 10L + "'", long10 == 10L);
    ...
    public void test17151() throws Throwable {
        ...
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 0 + "'", int6 == 0);
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-46828" + "'", str7, "HikariPool-46828");
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 10 + "'", int10 == 10);
...
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + 10L + "'", long22 == 10L);
    ...
    public void test17155() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long15 + "' != '" + 0L + "'", long15 == 0L);
        org.junit.Assert.assertNull(str20);
        org.junit.Assert.assertEquals("'" + str21 + "' != '" + "HikariPool-1517" + "'", str21, "HikariPool-1517");
    }
    ...
    public void test17156() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig29.setAcquireRetryDelay(3L);
// flaky:             org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        // Expected exception.
        }
    ...
    public void test17157() throws Throwable {
        ...
        java.lang.String str13 = hikariConfig1.connectionTestQuery;
        java.lang.String str14 = hikariConfig1.connectionInitSql;
        hikariConfig1.transactionIsolationName = "HikariPool-2269";
        int int17 = hikariConfig1.acquireRetries;
    ...
    public void test17158() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-14853");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-14853 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 60L + "'", long11 == 60L);
        ...
        org.junit.Assert.assertNull(str13);
        org.junit.Assert.assertNotNull(properties18);
// flaky:         org.junit.Assert.assertEquals("'" + str21 + "' != '" + "HikariPool-46843" + "'", str21, "HikariPool-46843");
// flaky:         org.junit.Assert.assertEquals("'" + str26 + "' != '" + "HikariPool-46843" + "'", str26, "HikariPool-46843");
    }
    ...
    public void test17162() throws Throwable {
        ...
        hikariConfig1.setAutoCommit(false);
        hikariConfig1.setPoolName("HikariPool-2567");
        hikariConfig1.catalog = "HikariPool-18614";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
        org.junit.Assert.assertNull(str7);
    ...
    public void test17163() throws Throwable {
        ...
        hikariConfig1.setConnectionCustomizerClassName("HikariPool-34406");
    ...
    public void test17164() throws Throwable {
        ...
        java.lang.String str13 = hikariConfig1.catalog;
        hikariConfig1.setPoolName("HikariPool-38559");
        java.lang.String str16 = hikariConfig1.catalog;
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long18 + "' != '" + 60L + "'", long18 == 60L);
    ...
    public void test17166() throws Throwable {
        ...
        hikariConfig1.setTransactionIsolation("HikariPool-26622");
...
// flaky:         org.junit.Assert.assertEquals("'" + str45 + "' != '" + "HikariPool-46853" + "'", str45, "HikariPool-46853");
...
// flaky:         org.junit.Assert.assertTrue("'" + long47 + "' != '" + 60L + "'", long47 == 60L);
    ...
    public void test17167() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
        org.junit.Assert.assertTrue("'" + long7 + "' != '" + 0L + "'", long7 == 0L);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-46857" + "'", str10, "HikariPool-46857");
        org.junit.Assert.assertNull(str11);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-46857" + "'", str12, "HikariPool-46857");
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 60 + "'", int13 == 60);
    }
...
// flaky:             org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
    ...
    public void test17170() throws Throwable {
        ...
        javax.sql.DataSource dataSource48 = hikariConfig1.getDataSource();
        hikariConfig1.transactionIsolation = (short) -1;
        hikariConfig1.transactionIsolationName = "HikariPool-5802";
    ...
    public void test17171() throws Throwable {
        ...
        boolean boolean14 = hikariConfig1.isAutoCommit;
        hikariConfig1.setDataSourceClassName("HikariPool-43962");
        org.junit.Assert.assertNull(dataSource6);
    ...
    public void test17172() throws Throwable {
        ...
        hikariConfig1.connectionInitSql = "HikariPool-357";
        hikariConfig1.setTransactionIsolation("HikariPool-30304");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 35L + "'", long7 == 35L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 35L + "'", long10 == 35L);
    ...
    public void test17177() throws Throwable {
        ...
        hikariConfig1.catalog = "HikariPool-27100";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
        org.junit.Assert.assertNull(str7);
    ...
    public void test17180() throws Throwable {
        ...
        hikariConfig1.poolName = "HikariPool-9572";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str11);
...
// flaky:         org.junit.Assert.assertEquals("'" + str1 + "' != '" + "HikariPool-46894" + "'", str1, "HikariPool-46894");
        org.junit.Assert.assertNull(dataSource4);
        org.junit.Assert.assertNull(str5);
    }
    ...
    public void test17182() throws Throwable {
        ...
        hikariConfig1.catalog = "HikariPool-33170";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
    ...
    public void test17183() throws Throwable {
        ...
        int int89 = hikariConfig1.minPoolSize;
        java.lang.Class<?> wildcardClass90 = hikariConfig1.getClass();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 60 + "'", int6 == 60);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long32 + "' != '" + 60L + "'", long32 == 60L);
    ...
    public void test17184() throws Throwable {
        ...
        long long9 = hikariConfig1.maxLifetime;
        long long10 = hikariConfig1.getMaxLifetime();
        hikariConfig1.connectionTestQuery = "HikariPool-1220";
        hikariConfig1.setInitializationFailFast(false);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 10L + "'", long11 == 10L);
    ...
    public void test17186() throws Throwable {
        ...
        boolean boolean9 = hikariConfig1.isRegisterMbeans;
        hikariConfig1.setConnectionTimeout(0L);
        hikariConfig1.setConnectionTestQuery("HikariPool-483");
        hikariConfig1.setInitializationFailFast(true);
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 10L + "'", long7 == 10L);
    ...
    public void test17192() throws Throwable {
        ...
        hikariConfig25.minPoolSize = (short) 1;
        boolean boolean35 = hikariConfig25.isAutoCommit;
        hikariConfig25.setJdbc4ConnectionTest(false);
        java.util.Properties properties38 = null;
        ...
        int int44 = hikariConfig39.transactionIsolation;
        java.lang.String str45 = hikariConfig39.getConnectionInitSql();
        hikariConfig39.setMaxLifetime((long) (short) 1);
        java.lang.String str48 = hikariConfig39.getConnectionCustomizerClassName();
        hikariConfig39.setAcquireRetries(1);
        java.lang.String str51 = hikariConfig39.catalog;
        javax.sql.DataSource dataSource52 = hikariConfig39.getDataSource();
        java.lang.String str53 = hikariConfig39.connectionInitSql;
        hikariConfig39.catalog = "HikariPool-1372";
        hikariConfig39.setCatalog("HikariPool-249");
        java.util.Properties properties58 = hikariConfig39.dataSourceProperties;
        hikariConfig25.setDataSourceProperties(properties58);
        hikariConfig11.setDataSourceProperties(properties58);
        long long61 = hikariConfig11.getConnectionTimeout();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int16 + "' != '" + 60 + "'", int16 == 60);
        org.junit.Assert.assertTrue("'" + int26 + "' != '" + (-1) + "'", int26 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long61 + "' != '" + 10L + "'", long61 == 10L);
    ...
    public void test17194() throws Throwable {
        ...
        hikariConfig1.setConnectionCustomizerClassName("HikariPool-44666");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str7);
    ...
    public void test17195() throws Throwable {
        ...
        java.lang.String str11 = hikariConfig1.connectionInitSql;
        hikariConfig1.idleTimeout = 10;
        hikariConfig1.connectionInitSql = "HikariPool-493";
        ...
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str11);
// flaky:         org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-46928" + "'", str18, "HikariPool-46928");
    }
    ...
    public void test17196() throws Throwable {
        ...
        hikariConfig1.dataSourceClassName = "";
        hikariConfig1.setTransactionIsolation("");
        hikariConfig1.setTransactionIsolation("HikariPool-119");
        boolean boolean11 = hikariConfig1.isAutoCommit;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 35L + "'", long13 == 35L);
    ...
    public void test17198() throws Throwable {
        ...
        hikariConfig1.setDataSourceClassName("HikariPool-3508");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 60 + "'", int6 == 60);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long88 + "' != '" + 60L + "'", long88 == 60L);
    ...
    public void test17204() throws Throwable {
        ...
        java.lang.String str56 = hikariConfig51.dataSourceClassName;
        hikariConfig51.setJdbc4ConnectionTest(false);
        java.lang.String str59 = hikariConfig51.transactionIsolationName;
        hikariConfig51.setMaximumPoolSize((int) (short) 0);
        java.lang.String str62 = hikariConfig51.getCatalog();
        long long63 = hikariConfig51.leakDetectionThreshold;
        hikariConfig51.setJdbc4ConnectionTest(true);
        java.util.Properties properties66 = hikariConfig51.dataSourceProperties;
...
// flaky:         org.junit.Assert.assertTrue("'" + long47 + "' != '" + 60L + "'", long47 == 60L);
    ...
    public void test17206() throws Throwable {
        ...
        hikariConfig31.idleTimeout = 10;
        hikariConfig31.idleTimeout = ' ';
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + (-1L) + "'", long11 == (-1L));
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 10L + "'", long17 == 10L);
    ...
    public void test17208() throws Throwable {
        ...
        hikariConfig1.dataSourceClassName = "HikariPool-1102";
        ...
        java.lang.String str48 = hikariConfig47.connectionInitSql;
        java.lang.String str49 = hikariConfig47.getCatalog();
        boolean boolean50 = hikariConfig47.isJdbc4connectionTest;
        long long51 = hikariConfig47.connectionTimeout;
...
// flaky:         org.junit.Assert.assertEquals("'" + str1 + "' != '" + "HikariPool-46972" + "'", str1, "HikariPool-46972");
        org.junit.Assert.assertNull(str6);
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 60L + "'", long7 == 60L);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 60L + "'", long9 == 60L);
    ...
    public void test17213() throws Throwable {
        ...
        hikariConfig25.connectionCustomizerClassName = "HikariPool-107";
        java.lang.String str46 = hikariConfig25.connectionCustomizerClassName;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 35L + "'", long13 == 35L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 35L + "'", long17 == 35L);
        ...
        org.junit.Assert.assertNull(str40);
        org.junit.Assert.assertEquals("'" + str46 + "' != '" + "HikariPool-107" + "'", str46, "HikariPool-107");
    }
    ...
    public void test17214() throws Throwable {
        ...
        hikariConfig1.connectionInitSql = "HikariPool-3343";
        hikariConfig1.setAutoCommit(false);
        int int58 = hikariConfig1.getAcquireIncrement();
        hikariConfig1.setAutoCommit(false);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + true + "'", boolean3 == true);
        org.junit.Assert.assertNull(str10);
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 60L + "'", long7 == 60L);
    ...
    public void test17218() throws Throwable {
        ...
        hikariConfig1.setDataSourceClassName("HikariPool-28109");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
...
// flaky:         org.junit.Assert.assertTrue("'" + long50 + "' != '" + 60L + "'", long50 == 60L);
    ...
    public void test17222() throws Throwable {
        ...
        hikariConfig1.dataSourceClassName = "HikariPool-21028";
        hikariConfig1.setCatalog("HikariPool-34920");
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 10L + "'", long9 == 10L);
    }
    ...
    public void test17224() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-30815");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-30815 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17225() throws Throwable {
        ...
        hikariConfig1.setConnectionTestQuery("HikariPool-37051");
        long long21 = hikariConfig1.getAcquireRetryDelay();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 60 + "'", int6 == 60);
...
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 10L + "'", long15 == 10L);
    ...
    public void test17230() throws Throwable {
        ...
        hikariConfig1.poolName = "HikariPool-12065";
        boolean boolean18 = hikariConfig1.isJdbc4ConnectionTest();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + 60 + "'", int9 == 60);
        org.junit.Assert.assertTrue("'" + long10 + "' != '" + 0L + "'", long10 == 0L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 35L + "'", long11 == 35L);
    ...
    public void test17233() throws Throwable {
        ...
        java.lang.String str31 = hikariConfig20.connectionInitSql;
        ...
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + false + "'", boolean7 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-47008" + "'", str14, "HikariPool-47008");
        org.junit.Assert.assertTrue("'" + boolean21 + "' != '" + true + "'", boolean21 == true);
        org.junit.Assert.assertNull(str24);
        org.junit.Assert.assertNull(str25);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 10L + "'", long6 == 10L);
    ...
    public void test17235() throws Throwable {
        ...
        hikariConfig15.dataSourceProperties = properties27;
        java.util.Properties properties29 = hikariConfig15.getDataSourceProperties();
        java.util.Properties properties30 = hikariConfig15.dataSourceProperties;
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 60L + "'", long17 == 60L);
    ...
    public void test17237() throws Throwable {
        ...
        hikariConfig1.connectionCustomizerClassName = "HikariPool-10201";
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + 60 + "'", int19 == 60);
        org.junit.Assert.assertTrue("'" + boolean23 + "' != '" + false + "'", boolean23 == false);
    ...
    public void test17238() throws Throwable {
        ...
        long long98 = hikariConfig1.getAcquireRetryDelay();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(iConnectionCustomizer9);
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 60L + "'", long10 == 60L);
    ...
    public void test17243() throws Throwable {
        ...
        com.zaxxer.hikari.HikariConfig hikariConfig12 = new com.zaxxer.hikari.HikariConfig(properties11);
        int int13 = hikariConfig12.getTransactionIsolation();
        hikariConfig12.maxLifetime = 32L;
        hikariConfig12.connectionCustomizerClassName = "HikariPool-104";
        ...
        long long29 = hikariConfig24.connectionTimeout;
        ...
        hikariConfig1.dataSourceProperties = properties32;
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-47035" + "'", str10, "HikariPool-47035");
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + (-1) + "'", int13 == (-1));
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + true + "'", boolean18 == true);
        org.junit.Assert.assertTrue("'" + long21 + "' != '" + 0L + "'", long21 == 0L);
// flaky:         org.junit.Assert.assertEquals("'" + str22 + "' != '" + "HikariPool-47036" + "'", str22, "HikariPool-47036");
        org.junit.Assert.assertTrue("'" + int25 + "' != '" + (-1) + "'", int25 == (-1));
        org.junit.Assert.assertNull(str28);
// flaky:         org.junit.Assert.assertTrue("'" + long29 + "' != '" + 10L + "'", long29 == 10L);
    ...
    public void test17244() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-36778");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-36778 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long23 + "' != '" + 35L + "'", long23 == 35L);
    ...
    public void test17247() throws Throwable {
        ...
        java.lang.String str14 = hikariConfig1.dataSourceClassName;
        javax.sql.DataSource dataSource15 = hikariConfig1.getDataSource();
        hikariConfig1.setConnectionInitSql("HikariPool-1265");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str9);
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 60L + "'", long13 == 60L);
    ...
    public void test17249() throws Throwable {
        ...
        java.lang.String str14 = hikariConfig1.getDataSourceClassName();
        hikariConfig1.catalog = "HikariPool-5464";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + false + "'", boolean7 == false);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 60 + "'", int10 == 60);
        org.junit.Assert.assertNull(str11);
...
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 35L + "'", long19 == 35L);
    ...
    public void test17252() throws Throwable {
        ...
        long long22 = hikariConfig17.connectionTimeout;
...
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + 10L + "'", long22 == 10L);
    ...
    public void test17254() throws Throwable {
        ...
        int int40 = hikariConfig31.getAcquireIncrement();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + (-1L) + "'", long11 == (-1L));
...
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + 60L + "'", long21 == 60L);
    ...
    public void test17255() throws Throwable {
        ...
        hikariConfig1.catalog = "HikariPool-2644";
        javax.sql.DataSource dataSource19 = null;
        hikariConfig1.setDataSource(dataSource19);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 35L + "'", long12 == 35L);
    ...
    public void test17259() throws Throwable {
        ...
        boolean boolean42 = hikariConfig29.isAutoCommit();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + false + "'", boolean11 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 60L + "'", long10 == 60L);
    ...
    public void test17265() throws Throwable {
        ...
        boolean boolean25 = hikariConfig10.isInitializationFailFast();
// flaky:         org.junit.Assert.assertEquals("'" + str1 + "' != '" + "HikariPool-47081" + "'", str1, "HikariPool-47081");
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + (-1) + "'", int17 == (-1));
// flaky:         org.junit.Assert.assertEquals("'" + str20 + "' != '" + "HikariPool-47082" + "'", str20, "HikariPool-47082");
        org.junit.Assert.assertTrue("'" + boolean24 + "' != '" + true + "'", boolean24 == true);
        org.junit.Assert.assertTrue("'" + boolean25 + "' != '" + false + "'", boolean25 == false);
    }
    ...
    public void test17266() throws Throwable {
        ...
        hikariConfig1.setPoolName("HikariPool-413");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 60 + "'", int6 == 60);
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 60L + "'", long7 == 60L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long26 + "' != '" + 60L + "'", long26 == 60L);
    ...
    public void test17267() throws Throwable {
        ...
        hikariConfig1.setCatalog("HikariPool-37644");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertNull(str15);
    ...
    public void test17269() throws Throwable {
        ...
        hikariConfig1.setConnectionInitSql("HikariPool-3849");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str7);
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 10L + "'", long12 == 10L);
    ...
    public void test17271() throws Throwable {
        ...
        boolean boolean11 = hikariConfig1.isRegisterMbeans;
        hikariConfig1.setPoolName("HikariPool-19879");
    ...
    public void test17273() throws Throwable {
        ...
        long long14 = hikariConfig10.getAcquireRetryDelay();
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 60L + "'", long7 == 60L);
    ...
    public void test17278() throws Throwable {
        ...
        int int77 = hikariConfig74.getMinimumPoolSize();
        hikariConfig74.setConnectionInitSql("HikariPool-44290");
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(iConnectionCustomizer9);
...
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + 10L + "'", long21 == 10L);
    ...
    public void test17284() throws Throwable {
        ...
        hikariConfig31.setCatalog("HikariPool-40889");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + (-1) + "'", int11 == (-1));
        org.junit.Assert.assertTrue("'" + int16 + "' != '" + 3 + "'", int16 == 3);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + (-1) + "'", int19 == (-1));
    ...
    public void test17286() throws Throwable {
        ...
        hikariConfig1.poolName = "HikariPool-9669";
        org.junit.Assert.assertNull(iConnectionCustomizer8);
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + (-1) + "'", int12 == (-1));
        org.junit.Assert.assertNull(str15);
        org.junit.Assert.assertTrue("'" + int16 + "' != '" + 60 + "'", int16 == 60);
    ...
    public void test17287() throws Throwable {
        ...
        java.util.Properties properties16 = hikariConfig1.dataSourceProperties;
        hikariConfig1.setTransactionIsolation("HikariPool-4817");
        hikariConfig1.setConnectionInitSql("");
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + (-1) + "'", int8 == (-1));
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 60 + "'", int11 == 60);
        org.junit.Assert.assertNotNull(properties16);
    ...
    public void test17289() throws Throwable {
        ...
        hikariConfig15.idleTimeout = '4';
        int int25 = hikariConfig15.getAcquireIncrement();
        hikariConfig15.setTransactionIsolation("HikariPool-173");
        long long28 = hikariConfig15.getAcquireRetryDelay();
        boolean boolean29 = hikariConfig15.isInitializationFailFast();
        hikariConfig1.addDataSourceProperty("HikariPool-22336", (java.lang.Object) hikariConfig15);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 0 + "'", int8 == 0);
        org.junit.Assert.assertEquals("'" + str9 + "' != '" + "hi!" + "'", str9, "hi!");
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 60L + "'", long16 == 60L);
    ...
    public void test17294() throws Throwable {
        ...
        boolean boolean32 = hikariConfig18.isJdbc4connectionTest;
        hikariConfig18.setPoolName("HikariPool-222");
        int int35 = hikariConfig18.getTransactionIsolation();
        boolean boolean36 = hikariConfig18.isRegisterMbeans();
        long long37 = hikariConfig18.connectionTimeout;
        boolean boolean38 = hikariConfig18.isRegisterMbeans();
        hikariConfig18.setMinimumPoolSize(100);
        hikariConfig18.transactionIsolationName = "HikariPool-13466";
        hikariConfig1.addDataSourceProperty("HikariPool-16921", (java.lang.Object) hikariConfig18);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(dataSource11);
...
// flaky:         org.junit.Assert.assertTrue("'" + long37 + "' != '" + 10L + "'", long37 == 10L);
    ...
    public void test17295() throws Throwable {
        ...
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer48 = hikariConfig1.connectionCustomizer;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + (-1) + "'", int10 == (-1));
        org.junit.Assert.assertNull(str13);
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 10L + "'", long17 == 10L);
    ...
    public void test17301() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + false + "'", boolean7 == false);
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-47158" + "'", str14, "HikariPool-47158");
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 60 + "'", int17 == 60);
        org.junit.Assert.assertNull(str18);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 60L + "'", long13 == 60L);
    ...
    public void test17303() throws Throwable {
        ...
        hikariConfig1.connectionInitSql = "HikariPool-2937";
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
        org.junit.Assert.assertNull(str10);
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 60L + "'", long11 == 60L);
    ...
    public void test17304() throws Throwable {
        ...
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 0 + "'", int6 == 0);
// flaky:         org.junit.Assert.assertEquals("'" + str7 + "' != '" + "HikariPool-47165" + "'", str7, "HikariPool-47165");
    }
    ...
    public void test17305() throws Throwable {
        ...
        hikariConfig1.setAutoCommit(false);
        hikariConfig1.maxLifetime = 35;
        hikariConfig1.setConnectionTestQuery("HikariPool-10588");
        hikariConfig1.setPoolName("HikariPool-1674");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str11);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long29 + "' != '" + 35L + "'", long29 == 35L);
    ...
    public void test17311() throws Throwable {
        ...
        hikariConfig1.setDataSourceClassName("HikariPool-8742");
        hikariConfig1.dataSourceClassName = "HikariPool-21301";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 60 + "'", int6 == 60);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 60L + "'", long10 == 60L);
    ...
    public void test17315() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 60L + "'", long5 == 60L);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-47187" + "'", str6, "HikariPool-47187");
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertNull(str11);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 35L + "'", long10 == 35L);
    ...
    public void test17319() throws Throwable {
        ...
        long long10 = hikariConfig1.idleTimeout;
        hikariConfig1.setRegisterMbeans(false);
        hikariConfig1.setDataSourceClassName("HikariPool-6903");
        javax.sql.DataSource dataSource15 = null;
        hikariConfig1.setDataSource(dataSource15);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 60L + "'", long10 == 60L);
    ...
    public void test17320() throws Throwable {
        ...
        java.lang.String str49 = hikariConfig1.getConnectionInitSql();
        org.junit.Assert.assertNull(iConnectionCustomizer8);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + (-1) + "'", int11 == (-1));
        org.junit.Assert.assertTrue("'" + int20 + "' != '" + (-1) + "'", int20 == (-1));
        org.junit.Assert.assertTrue("'" + int25 + "' != '" + 3 + "'", int25 == 3);
...
// flaky:         org.junit.Assert.assertTrue("'" + long45 + "' != '" + 60L + "'", long45 == 60L);
        ...
        org.junit.Assert.assertEquals("'" + str49 + "' != '" + "HikariPool-726" + "'", str49, "HikariPool-726");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 35L + "'", long15 == 35L);
    ...
    public void test17323() throws Throwable {
        ...
        java.lang.String str15 = hikariConfig14.poolName;
        hikariConfig14.setMinimumPoolSize((int) '4');
        hikariConfig14.minPoolSize = (byte) 0;
        long long20 = hikariConfig14.maxLifetime;
        ...
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + (-1) + "'", int11 == (-1));
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 10L + "'", long12 == 10L);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-47200" + "'", str15, "HikariPool-47200");
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 60L + "'", long11 == 60L);
    ...
    public void test17326() throws Throwable {
        ...
        long long13 = hikariConfig1.connectionTimeout;
        int int14 = hikariConfig1.getAcquireRetries();
        hikariConfig1.catalog = "HikariPool-817";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 35L + "'", long9 == 35L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 10L + "'", long13 == 10L);
    ...
    public void test17327() throws Throwable {
        ...
        int int34 = hikariConfig1.minPoolSize;
...
// flaky:         org.junit.Assert.assertTrue("'" + long32 + "' != '" + 60L + "'", long32 == 60L);
    ...
    public void test17328() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-36445");
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 0L + "'", long4 == 0L);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 3 + "'", int8 == 3);
        org.junit.Assert.assertNull(str9);
    ...
    public void test17329() throws Throwable {
        ...
        int int82 = hikariConfig81.getTransactionIsolation();
        hikariConfig81.setRegisterMbeans(false);
        java.lang.String str85 = hikariConfig81.transactionIsolationName;
        long long86 = hikariConfig81.getIdleTimeout();
        java.lang.String str87 = hikariConfig81.getCatalog();
        java.util.Properties properties88 = hikariConfig81.getDataSourceProperties();
        hikariConfig81.setRegisterMbeans(true);
        hikariConfig81.setMaxLifetime((long) (byte) 1);
        hikariConfig81.setInitializationFailFast(false);
        javax.sql.DataSource dataSource95 = null;
        hikariConfig81.dataSource = dataSource95;
        hikariConfig74.addDataSourceProperty("HikariPool-536", (java.lang.Object) hikariConfig81);
        java.lang.String str98 = hikariConfig81.connectionCustomizerClassName;
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(iConnectionCustomizer9);
...
// flaky:         org.junit.Assert.assertTrue("'" + long86 + "' != '" + 60L + "'", long86 == 60L);
    ...
    public void test17332() throws Throwable {
        ...
        hikariConfig1.dataSourceClassName = "HikariPool-15409";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + true + "'", boolean13 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 60L + "'", long14 == 60L);
    ...
    public void test17333() throws Throwable {
        ...
        java.util.Properties properties12 = hikariConfig1.dataSourceProperties;
        int int13 = hikariConfig1.getMaximumPoolSize();
        hikariConfig1.connectionInitSql = "HikariPool-6538";
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 10L + "'", long7 == 10L);
// flaky:         org.junit.Assert.assertTrue("'" + long8 + "' != '" + 60L + "'", long8 == 60L);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 3 + "'", int11 == 3);
...
// flaky:             org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
    ...
    public void test17337() throws Throwable {
        ...
        int int37 = hikariConfig31.getAcquireIncrement();
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer38 = null;
        hikariConfig31.connectionCustomizer = iConnectionCustomizer38;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + (-1L) + "'", long11 == (-1L));
...
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + 60L + "'", long21 == 60L);
    ...
    public void test17338() throws Throwable {
        ...
        hikariConfig13.dataSourceProperties = properties40;
        com.zaxxer.hikari.HikariConfig hikariConfig43 = new com.zaxxer.hikari.HikariConfig(properties40);
        java.lang.String str44 = hikariConfig43.connectionInitSql;
        hikariConfig43.setIdleTimeout((long) (byte) -1);
        hikariConfig43.setRegisterMbeans(true);
        hikariConfig43.connectionInitSql = "HikariPool-696";
        hikariConfig43.idleTimeout = 32;
        java.lang.String str53 = hikariConfig43.poolName;
        int int54 = hikariConfig43.getTransactionIsolation();
        hikariConfig43.transactionIsolationName = "HikariPool-1362";
        hikariConfig1.addDataSourceProperty("HikariPool-2847", (java.lang.Object) hikariConfig43);
        hikariConfig43.setJdbc4ConnectionTest(false);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNotNull(properties9);
...
// flaky:         org.junit.Assert.assertEquals("'" + str53 + "' != '" + "HikariPool-47236" + "'", str53, "HikariPool-47236");
        org.junit.Assert.assertTrue("'" + int54 + "' != '" + (-1) + "'", int54 == (-1));
    }
    ...
    public void test17339() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + 60 + "'", int9 == 60);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-47237" + "'", str11, "HikariPool-47237");
    }
    ...
    public void test17341() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig1.addDataSourceProperty("HikariPool-23841", obj10);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        // Expected exception.
        }
    ...
    public void test17342() throws Throwable {
        ...
        java.lang.String str27 = hikariConfig22.connectionInitSql;
        hikariConfig22.catalog = "HikariPool-1547";
        java.util.Properties properties31 = null;
        com.zaxxer.hikari.HikariConfig hikariConfig32 = new com.zaxxer.hikari.HikariConfig(properties31);
        int int33 = hikariConfig32.getTransactionIsolation();
        hikariConfig32.setRegisterMbeans(false);
        ...
        java.lang.String str42 = hikariConfig32.transactionIsolationName;
        hikariConfig32.setUseInstrumentation(false);
        hikariConfig22.addDataSourceProperty("HikariPool-2359", (java.lang.Object) hikariConfig32);
        long long46 = hikariConfig22.getLeakDetectionThreshold();
        java.util.Properties properties47 = hikariConfig22.getDataSourceProperties();
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 60L + "'", long13 == 60L);
    ...
    public void test17344() throws Throwable {
        ...
        hikariConfig20.addDataSourceProperty("HikariPool-2991", (java.lang.Object) "HikariPool-756");
    ...
    public void test17345() throws Throwable {
        ...
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNotNull(properties9);
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-47251" + "'", str10, "HikariPool-47251");
...
// flaky:         org.junit.Assert.assertTrue("'" + long19 + "' != '" + 60L + "'", long19 == 60L);
    ...
    public void test17347() throws Throwable {
        ...
        hikariConfig0.poolName = "HikariPool-41906";
// flaky:         org.junit.Assert.assertTrue("'" + long1 + "' != '" + 10L + "'", long1 == 10L);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 35L + "'", long14 == 35L);
    ...
    public void test17350() throws Throwable {
        ...
        hikariConfig8.transactionIsolationName = "HikariPool-756";
        hikariConfig8.connectionTimeout = (short) 10;
        java.lang.String str29 = hikariConfig8.getCatalog();
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + (-1) + "'", int9 == (-1));
        org.junit.Assert.assertNull(str12);
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + (-1) + "'", int13 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long27 + "' != '" + 60L + "'", long27 == 60L);
    ...
    public void test17356() throws Throwable {
        ...
        org.junit.Assert.assertNull(dataSource10);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 0L + "'", long11 == 0L);
// flaky:         org.junit.Assert.assertEquals("'" + str12 + "' != '" + "HikariPool-47278" + "'", str12, "HikariPool-47278");
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 60L + "'", long16 == 60L);
    ...
    public void test17359() throws Throwable {
        ...
        hikariConfig1.setDataSourceProperties(properties18);
        hikariConfig1.setRegisterMbeans(false);
        hikariConfig1.connectionCustomizerClassName = "HikariPool-1512";
...
// flaky:         org.junit.Assert.assertTrue("'" + long24 + "' != '" + 10L + "'", long24 == 10L);
    ...
    public void test17361() throws Throwable {
        ...
        boolean boolean8 = hikariConfig1.isAutoCommit;
        hikariConfig1.setConnectionInitSql("HikariPool-1253");
        hikariConfig1.poolName = "HikariPool-10044";
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
    ...
    public void test17362() throws Throwable {
        ...
        int int5 = hikariConfig1.getMinimumPoolSize();
        boolean boolean6 = hikariConfig1.isAutoCommit();
        hikariConfig1.connectionInitSql = "HikariPool-29281";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 10 + "'", int5 == 10);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 10L + "'", long11 == 10L);
    ...
    public void test17365() throws Throwable {
        ...
        hikariConfig1.leakDetectionThreshold = 100;
        boolean boolean4 = hikariConfig1.isJdbc4connectionTest;
        hikariConfig1.catalog = "HikariPool-1367";
...
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 10L + "'", long15 == 10L);
    ...
    public void test17368() throws Throwable {
        ...
        java.lang.String str25 = hikariConfig19.dataSourceClassName;
        boolean boolean26 = hikariConfig19.isInitializationFailFast();
        hikariConfig19.setConnectionTestQuery("HikariPool-68");
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 60L + "'", long16 == 60L);
    ...
    public void test17370() throws Throwable {
        ...
        hikariConfig1.setMaxLifetime(60L);
        hikariConfig1.setPoolName("HikariPool-3155");
        hikariConfig1.setRegisterMbeans(false);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 10L + "'", long10 == 10L);
    ...
    public void test17371() throws Throwable {
        ...
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer17 = null;
        hikariConfig8.connectionCustomizer = iConnectionCustomizer17;
        long long19 = hikariConfig8.connectionTimeout;
        hikariConfig8.setLeakDetectionThreshold(52L);
        java.util.Properties properties22 = hikariConfig8.dataSourceProperties;
        hikariConfig1.setDataSourceProperties(properties22);
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 35L + "'", long12 == 35L);
    ...
    public void test17374() throws Throwable {
        ...
        hikariConfig16.dataSourceClassName = "HikariPool-18784";
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 0L + "'", long4 == 0L);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
        org.junit.Assert.assertNull(str10);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 60 + "'", int11 == 60);
...
// flaky:         org.junit.Assert.assertTrue("'" + long23 + "' != '" + 60L + "'", long23 == 60L);
    ...
    public void test17375() throws Throwable {
        ...
        java.lang.String str55 = hikariConfig1.dataSourceClassName;
        hikariConfig1.setAcquireRetries(0);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + (-1) + "'", int13 == (-1));
        org.junit.Assert.assertNull(str18);
    ...
    public void test17376() throws Throwable {
        ...
        boolean boolean35 = hikariConfig33.isAutoCommit();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + (-1L) + "'", long11 == (-1L));
...
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + 60L + "'", long21 == 60L);
    ...
    public void test17377() throws Throwable {
        ...
        hikariConfig1.isJdbc4connectionTest = true;
        hikariConfig1.setCatalog("HikariPool-19608");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long12 + "' != '" + 35L + "'", long12 == 35L);
    ...
    public void test17380() throws Throwable {
        ...
        javax.sql.DataSource dataSource75 = hikariConfig1.dataSource;
        long long76 = hikariConfig1.getMaxLifetime();
        hikariConfig1.minPoolSize = 0;
        javax.sql.DataSource dataSource79 = null;
        hikariConfig1.dataSource = dataSource79;
        // The following exception was thrown during execution in test generation
        try {
...
// flaky:         org.junit.Assert.assertTrue("'" + long76 + "' != '" + 35L + "'", long76 == 35L);
    ...
    public void test17381() throws Throwable {
        ...
        hikariConfig1.isJdbc4connectionTest = true;
        java.util.Properties properties11 = hikariConfig1.dataSourceProperties;
        hikariConfig1.transactionIsolationName = "HikariPool-9038";
        boolean boolean14 = hikariConfig1.isAutoCommit;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(dataSource5);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test17383() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int21 + "' != '" + (-1) + "'", int21 == (-1));
        org.junit.Assert.assertNull(str26);
// flaky:         org.junit.Assert.assertEquals("'" + str35 + "' != '" + "HikariPool-47341" + "'", str35, "HikariPool-47341");
    ...
    public void test17385() throws Throwable {
        ...
        hikariConfig1.poolName = "HikariPool-412";
        ...
        org.junit.Assert.assertTrue("'" + boolean23 + "' != '" + false + "'", boolean23 == false);
        org.junit.Assert.assertEquals("'" + str26 + "' != '" + "HikariPool-204" + "'", str26, "HikariPool-204");
        org.junit.Assert.assertNull(str27);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 10L + "'", long17 == 10L);
    ...
    public void test17387() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-33853");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-33853 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17389() throws Throwable {
        ...
        int int9 = hikariConfig1.getTransactionIsolation();
        hikariConfig1.connectionCustomizerClassName = "HikariPool-4111";
// flaky:         org.junit.Assert.assertTrue("'" + long2 + "' != '" + 60L + "'", long2 == 60L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 3 + "'", int3 == 3);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + (-1) + "'", int9 == (-1));
    ...
    public void test17390() throws Throwable {
        ...
        hikariConfig1.setDataSourceClassName("HikariPool-279");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
        org.junit.Assert.assertNull(str7);
...
// flaky:         org.junit.Assert.assertTrue("'" + long18 + "' != '" + 60L + "'", long18 == 60L);
    ...
    public void test17392() throws Throwable {
        ...
        hikariConfig0.setConnectionCustomizerClassName("HikariPool-44025");
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 10 + "'", int5 == 10);
        org.junit.Assert.assertNull(str6);
...
// flaky:         org.junit.Assert.assertEquals("'" + str10 + "' != '" + "HikariPool-47360" + "'", str10, "HikariPool-47360");
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + true + "'", boolean15 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 60L + "'", long16 == 60L);
        org.junit.Assert.assertNotNull(properties21);
// flaky:         org.junit.Assert.assertTrue("'" + long24 + "' != '" + 60L + "'", long24 == 60L);
...
// flaky:         org.junit.Assert.assertEquals("'" + str1 + "' != '" + "HikariPool-47366" + "'", str1, "HikariPool-47366");
        org.junit.Assert.assertNull(dataSource4);
        org.junit.Assert.assertNull(str5);
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 10L + "'", long16 == 10L);
    ...
    public void test17399() throws Throwable {
        ...
        hikariConfig1.setTransactionIsolation("HikariPool-36011");
...
// flaky:         org.junit.Assert.assertTrue("'" + long24 + "' != '" + 10L + "'", long24 == 10L);
    ...
    public void test17402() throws Throwable {
        ...
        hikariConfig1.setInitializationFailFast(true);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-47372" + "'", str11, "HikariPool-47372");
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 10 + "'", int14 == 10);
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 10L + "'", long15 == 10L);
        org.junit.Assert.assertNotNull(properties16);
    }
    ...
    public void test17404() throws Throwable {
        ...
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer10 = hikariConfig8.connectionCustomizer;
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNotNull(properties7);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
        org.junit.Assert.assertNull(iConnectionCustomizer10);
    ...
    public void test17406() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
        org.junit.Assert.assertNotNull(properties8);
// flaky:         org.junit.Assert.assertEquals("'" + str11 + "' != '" + "HikariPool-47382" + "'", str11, "HikariPool-47382");
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + false + "'", boolean12 == false);
        org.junit.Assert.assertTrue("'" + int21 + "' != '" + (-1) + "'", int21 == (-1));
        org.junit.Assert.assertNotNull(properties28);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 60L + "'", long11 == 60L);
        ...
        org.junit.Assert.assertNull(str13);
        org.junit.Assert.assertNotNull(properties18);
// flaky:         org.junit.Assert.assertEquals("'" + str21 + "' != '" + "HikariPool-47392" + "'", str21, "HikariPool-47392");
// flaky:         org.junit.Assert.assertTrue("'" + long26 + "' != '" + 35L + "'", long26 == 35L);
    ...
    public void test17410() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + (-1) + "'", int10 == (-1));
        org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-128" + "'", str15, "HikariPool-128");
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + true + "'", boolean18 == true);
        org.junit.Assert.assertNull(str21);
        org.junit.Assert.assertTrue("'" + int22 + "' != '" + 0 + "'", int22 == 0);
// flaky:         org.junit.Assert.assertEquals("'" + str23 + "' != '" + "HikariPool-47397" + "'", str23, "HikariPool-47397");
        org.junit.Assert.assertNotNull(properties26);
    }
    ...
    public void test17411() throws Throwable {
        ...
        java.lang.String str13 = hikariConfig1.getConnectionInitSql();
        hikariConfig1.catalog = "HikariPool-21851";
...
// flaky:         org.junit.Assert.assertTrue("'" + long9 + "' != '" + 35L + "'", long9 == 35L);
    ...
    public void test17413() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            hikariConfig76.setAcquireIncrement((-1));
// flaky:             org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        // Expected exception.
        }
    ...
    public void test17414() throws Throwable {
        ...
        java.lang.String str10 = hikariConfig1.catalog;
        hikariConfig1.connectionCustomizerClassName = "HikariPool-29";
        hikariConfig1.transactionIsolationName = "HikariPool-20708";
        java.util.Properties properties15 = null;
        com.zaxxer.hikari.HikariConfig hikariConfig16 = new com.zaxxer.hikari.HikariConfig(properties15);
        int int17 = hikariConfig16.getTransactionIsolation();
        hikariConfig16.setRegisterMbeans(false);
        ...
        hikariConfig44.dataSource = dataSource50;
        java.lang.String str52 = hikariConfig44.transactionIsolationName;
        com.zaxxer.hikari.IConnectionCustomizer iConnectionCustomizer53 = hikariConfig44.connectionCustomizer;
        java.lang.String str54 = hikariConfig44.connectionCustomizerClassName;
        hikariConfig33.addDataSourceProperty("HikariPool-1802", (java.lang.Object) hikariConfig44);
        hikariConfig44.maxPoolSize = (byte) 1;
...
// flaky:         org.junit.Assert.assertTrue("'" + long8 + "' != '" + 60L + "'", long8 == 60L);
    ...
    public void test17417() throws Throwable {
        ...
        hikariConfig28.poolName = "hi!";
        java.lang.String str32 = hikariConfig28.dataSourceClassName;
        hikariConfig28.acquireRetries = (short) 10;
        ...
        hikariConfig12.dataSourceProperties = properties35;
        java.util.Properties properties39 = hikariConfig12.dataSourceProperties;
        hikariConfig1.setDataSourceProperties(properties39);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + true + "'", boolean13 == true);
        org.junit.Assert.assertNull(str16);
...
// flaky:         org.junit.Assert.assertTrue("'" + long16 + "' != '" + 60L + "'", long16 == 60L);
    ...
    public void test17419() throws Throwable {
        ...
        hikariConfig9.acquireRetries = 0;
        long long13 = hikariConfig9.getLeakDetectionThreshold();
        hikariConfig9.poolName = "HikariPool-39229";
        org.junit.Assert.assertTrue("'" + long4 + "' != '" + 0L + "'", long4 == 0L);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertNotNull(properties8);
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 10L + "'", long10 == 10L);
    ...
    public void test17420() throws Throwable {
        ...
        hikariConfig1.catalog = "HikariPool-35407";
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + (-1) + "'", int7 == (-1));
        org.junit.Assert.assertNull(str10);
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 60L + "'", long11 == 60L);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertNotNull(properties8);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-47432" + "'", str15, "HikariPool-47432");
...
// flaky:         org.junit.Assert.assertTrue("'" + long18 + "' != '" + 35L + "'", long18 == 35L);
    ...
    public void test17422() throws Throwable {
        ...
        hikariConfig1.setTransactionIsolation("HikariPool-36132");
// flaky:         org.junit.Assert.assertTrue("'" + long2 + "' != '" + 60L + "'", long2 == 60L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 3 + "'", int3 == 3);
// flaky:         org.junit.Assert.assertTrue("'" + long4 + "' != '" + 10L + "'", long4 == 10L);
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + (-1) + "'", int5 == (-1));
...
// flaky:         org.junit.Assert.assertTrue("'" + long25 + "' != '" + 60L + "'", long25 == 60L);
    ...
    public void test17424() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-33665");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-33665 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17425() throws Throwable {
        ...
        hikariConfig1.connectionCustomizerClassName = "HikariPool-23421";
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(iConnectionCustomizer9);
...
// flaky:         org.junit.Assert.assertTrue("'" + long6 + "' != '" + 60L + "'", long6 == 60L);
        org.junit.Assert.assertNull(str7);
        org.junit.Assert.assertNotNull(properties8);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-47445" + "'", str13, "HikariPool-47445");
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + true + "'", boolean14 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str15 + "' != '" + "HikariPool-47445" + "'", str15, "HikariPool-47445");
        org.junit.Assert.assertNull(str16);
    }
    ...
    public void test17427() throws Throwable {
        ...
        boolean boolean8 = hikariConfig1.isJdbc4connectionTest;
        hikariConfig1.setUseInstrumentation(false);
        hikariConfig1.setPoolName("HikariPool-36877");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + true + "'", boolean8 == true);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 60L + "'", long14 == 60L);
    ...
    public void test17430() throws Throwable {
        ...
        javax.sql.DataSource dataSource75 = hikariConfig1.dataSource;
        hikariConfig1.isJdbc4connectionTest = false;
        hikariConfig1.setPoolName("HikariPool-15825");
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(iConnectionCustomizer9);
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 60L + "'", long14 == 60L);
    ...
    public void test17432() throws Throwable {
        ...
        int int17 = hikariConfig1.maxPoolSize;
        hikariConfig1.setConnectionInitSql("HikariPool-5693");
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 60 + "'", int17 == 60);
    ...
    public void test17433() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 0 + "'", int10 == 0);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-47463" + "'", str13, "HikariPool-47463");
        org.junit.Assert.assertNull(dataSource19);
        org.junit.Assert.assertNull(iConnectionCustomizer20);
...
// flaky:         org.junit.Assert.assertEquals("'" + str1 + "' != '" + "HikariPool-47464" + "'", str1, "HikariPool-47464");
        org.junit.Assert.assertNull(dataSource4);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 3 + "'", int6 == 3);
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + false + "'", boolean9 == false);
...
// flaky:         org.junit.Assert.assertTrue("'" + long17 + "' != '" + 35L + "'", long17 == 35L);
    ...
    public void test17441() throws Throwable {
        ...
        java.lang.String str9 = hikariConfig1.transactionIsolationName;
        int int10 = hikariConfig1.getTransactionIsolation();
        hikariConfig1.setConnectionTestQuery("HikariPool-46812");
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertNull(str9);
    ...
    public void test17442() throws Throwable {
        ...
        java.lang.String str35 = hikariConfig11.connectionInitSql;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str7);
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 10L + "'", long7 == 10L);
    ...
    public void test17444() throws Throwable {
        ...
        long long5 = hikariConfig1.getIdleTimeout();
        hikariConfig1.setCatalog("HikariPool-104");
        hikariConfig1.setConnectionCustomizerClassName("HikariPool-1362");
        hikariConfig1.isRegisterMbeans = true;
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 60L + "'", long5 == 60L);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long15 + "' != '" + 10L + "'", long15 == 10L);
    ...
    public void test17447() throws Throwable {
        ...
        hikariConfig1.setIdleTimeout((long) 60);
        hikariConfig1.setPoolName("HikariPool-18784");
        hikariConfig1.catalog = "HikariPool-39607";
// flaky:         org.junit.Assert.assertTrue("'" + long2 + "' != '" + 60L + "'", long2 == 60L);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 3 + "'", int3 == 3);
...
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 60L + "'", long7 == 60L);
    ...
    public void test17449() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-36918");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-36918 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long21 + "' != '" + 60L + "'", long21 == 60L);
    ...
    public void test17452() throws Throwable {
        ...
        java.util.Properties properties25 = hikariConfig11.getDataSourceProperties();
        hikariConfig1.addDataSourceProperty("HikariPool-489", (java.lang.Object) hikariConfig11);
        int int27 = hikariConfig11.getTransactionIsolation();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + (-1) + "'", int6 == (-1));
        org.junit.Assert.assertNull(str7);
    ...
    public void test17454() throws Throwable {
        ...
        hikariConfig31.setMaximumPoolSize((int) (byte) 1);
        hikariConfig31.setCatalog("HikariPool-32708");
        javax.sql.DataSource dataSource39 = hikariConfig31.dataSource;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + (-1) + "'", int11 == (-1));
        org.junit.Assert.assertTrue("'" + int16 + "' != '" + 3 + "'", int16 == 3);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + (-1) + "'", int19 == (-1));
    ...
    public void test17455() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 1L + "'", long11 == 1L);
        org.junit.Assert.assertNull(str12);
// flaky:         org.junit.Assert.assertEquals("'" + str13 + "' != '" + "HikariPool-47512" + "'", str13, "HikariPool-47512");
// flaky:         org.junit.Assert.assertEquals("'" + str14 + "' != '" + "HikariPool-47512" + "'", str14, "HikariPool-47512");
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + true + "'", boolean15 == true);
    }
...
// flaky:         org.junit.Assert.assertTrue("'" + long13 + "' != '" + 35L + "'", long13 == 35L);
    ...
    public void test17457() throws Throwable {
        ...
        boolean boolean12 = hikariConfig1.isInitializationFailFast();
        boolean boolean13 = hikariConfig1.isJdbc4ConnectionTest();
        hikariConfig1.connectionInitSql = "HikariPool-494";
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertNull(str5);
        org.junit.Assert.assertNull(str6);
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + 60 + "'", int9 == 60);
...
// flaky:         org.junit.Assert.assertTrue("'" + long14 + "' != '" + 10L + "'", long14 == 10L);
    ...
    public void test17459() throws Throwable {
        ...
        java.lang.String str29 = hikariConfig16.connectionTestQuery;
        hikariConfig16.isRegisterMbeans = false;
        int int32 = hikariConfig16.acquireRetries;
        java.lang.String str33 = hikariConfig16.transactionIsolationName;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str13);
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + true + "'", boolean17 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + 10L + "'", long22 == 10L);
    ...
    public void test17460() throws Throwable {
        ...
        hikariConfig17.addDataSourceProperty("HikariPool-222", (java.lang.Object) hikariConfig29);
        hikariConfig17.poolName = "HikariPool-104";
        java.util.Properties properties42 = null;
        com.zaxxer.hikari.HikariConfig hikariConfig43 = new com.zaxxer.hikari.HikariConfig(properties42);
        hikariConfig43.leakDetectionThreshold = 100;
        boolean boolean46 = hikariConfig43.isJdbc4ConnectionTest();
        ...
        hikariConfig48.setRegisterMbeans(false);
        java.lang.String str52 = hikariConfig48.transactionIsolationName;
        long long53 = hikariConfig48.getIdleTimeout();
        ...
        hikariConfig57.dataSourceClassName = "";
        java.util.Properties properties60 = hikariConfig57.dataSourceProperties;
        hikariConfig48.setDataSourceProperties(properties60);
        hikariConfig43.dataSourceProperties = properties60;
        java.util.Properties properties63 = hikariConfig43.dataSourceProperties;
        hikariConfig17.dataSourceProperties = properties63;
        java.lang.String str65 = hikariConfig17.connectionCustomizerClassName;
        hikariConfig17.setRegisterMbeans(false);
        hikariConfig1.addDataSourceProperty("HikariPool-1658", (java.lang.Object) hikariConfig17);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 3 + "'", int7 == 3);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + true + "'", boolean13 == true);
...
// flaky:         org.junit.Assert.assertTrue("'" + long53 + "' != '" + 60L + "'", long53 == 60L);
    ...
    public void test17461() throws Throwable {
        ...
        hikariConfig1.setJdbc4ConnectionTest(false);
        hikariConfig1.idleTimeout = 87L;
        hikariConfig1.dataSourceClassName = "HikariPool-15059";
    ...
    public void test17462() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long5 + "' != '" + 60L + "'", long5 == 60L);
// flaky:         org.junit.Assert.assertEquals("'" + str6 + "' != '" + "HikariPool-47525" + "'", str6, "HikariPool-47525");
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
        org.junit.Assert.assertNull(str8);
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + (-1) + "'", int9 == (-1));
        org.junit.Assert.assertNull(str12);
...
// flaky:             org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
    ...
    public void test17473() throws Throwable {
        ...
        long long10 = hikariConfig1.idleTimeout;
        java.lang.String str11 = hikariConfig1.getConnectionInitSql();
        hikariConfig1.setDataSourceClassName("HikariPool-17217");
        hikariConfig1.connectionCustomizerClassName = "HikariPool-41225";
        org.junit.Assert.assertNull(dataSource6);
        org.junit.Assert.assertNull(iConnectionCustomizer7);
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 60L + "'", long10 == 60L);
        org.junit.Assert.assertEquals("'" + str11 + "' != '" + "hi!" + "'", str11, "hi!");
    ...
    public void test17475() throws Throwable {
        ...
        hikariConfig11.setConnectionInitSql("HikariPool-780");
        hikariConfig11.maxLifetime = 10;
        java.lang.String str22 = hikariConfig11.getConnectionTestQuery();
        hikariConfig11.transactionIsolation = 'a';
        hikariConfig0.addDataSourceProperty("HikariPool-2152", (java.lang.Object) hikariConfig11);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 60 + "'", int1 == 60);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str22);
    }
    ...
    public void test17476() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            com.zaxxer.hikari.HikariConfig hikariConfig1 = new com.zaxxer.hikari.HikariConfig("HikariPool-42999");
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Property file HikariPool-42999 was not found.");
        } catch (java.lang.IllegalArgumentException e) {
        // Expected exception.
        }
    }
    ...
    public void test17478() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int40 + "' != '" + (-1) + "'", int40 == (-1));
        org.junit.Assert.assertNotNull(properties41);
// flaky:         org.junit.Assert.assertEquals("'" + str45 + "' != '" + "HikariPool-47544" + "'", str45, "HikariPool-47544");
        org.junit.Assert.assertNull(str46);
// flaky:         org.junit.Assert.assertTrue("'" + long47 + "' != '" + 60L + "'", long47 == 60L);
        org.junit.Assert.assertNull(str48);
        org.junit.Assert.assertNotNull(properties51);
...
// flaky:         org.junit.Assert.assertTrue("'" + long10 + "' != '" + 10L + "'", long10 == 10L);
    ...
    public void test17480() throws Throwable {
        ...
        javax.sql.DataSource dataSource12 = null;
        hikariConfig1.setDataSource(dataSource12);
        hikariConfig1.connectionInitSql = "HikariPool-14465";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
// flaky:         org.junit.Assert.assertTrue("'" + long7 + "' != '" + 60L + "'", long7 == 60L);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 60 + "'", int10 == 60);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + (-1) + "'", int11 == (-1));
    ...
    public void test17481() throws Throwable {
        ...
        hikariConfig1.setMaximumPoolSize((int) (short) 10);
        hikariConfig1.setJdbc4ConnectionTest(false);
        hikariConfig1.dataSourceClassName = "HikariPool-34630";
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
        org.junit.Assert.assertNull(str13);
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + true + "'", boolean17 == true);
// flaky:         org.junit.Assert.assertTrue("'" + long22 + "' != '" + 10L + "'", long22 == 10L);
        ...
        org.junit.Assert.assertNull(str26);
// flaky:         org.junit.Assert.assertTrue("'" + long28 + "' != '" + 60L + "'", long28 == 60L);
// flaky:         org.junit.Assert.assertEquals("'" + str29 + "' != '" + "HikariPool-47550" + "'", str29, "HikariPool-47550");
    }
    ...
    public void test17484() throws Throwable {
        ...
        hikariConfig1.dataSourceClassName = "HikariPool-19444";
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + 1 + "'", int9 == 1);
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 1 + "'", int10 == 1);
        org.junit.Assert.assertNull(str11);
...
// flaky:         org.junit.Assert.assertTrue("'" + long18 + "' != '" + 60L + "'", long18 == 60L);
    ...
    public void test17485() throws Throwable {
        ...
        long long11 = hikariConfig1.getLeakDetectionThreshold();
        hikariConfig1.maxPoolSize = 1;
        hikariConfig1.setConnectionCustomizerClassName("HikariPool-25064");
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
...
// flaky:         org.junit.Assert.assertTrue("'" + long11 + "' != '" + 10L + "'", long11 == 10L);
    ...
    public void test17487() throws Throwable {
        ...
        hikariConfig1.setCatalog("HikariPool-536");
        javax.sql.DataSource dataSource17 = null;
...
// flaky:         org.junit.Assert.assertTrue("'" + long37 + "' != '" + 60L + "'", long37 == 60L);
    ...
    public void test17492() throws Throwable {
        ...
        hikariConfig6.catalog = "";
        hikariConfig6.idleTimeout = 1800000L;
        hikariConfig6.poolName = "HikariPool-581";
        boolean boolean17 = hikariConfig6.isJdbc4ConnectionTest();
        hikariConfig6.setMaxLifetime(87L);
        java.util.Properties properties20 = hikariConfig6.getDataSourceProperties();
        hikariConfig1.setDataSourceProperties(properties20);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + (-1) + "'", int2 == (-1));
// flaky:         org.junit.Assert.assertEquals("'" + str3 + "' != '" + "HikariPool-47581" + "'", str3, "HikariPool-47581");
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + true + "'", boolean17 == true);
        org.junit.Assert.assertNotNull(properties20);
    }
    ...
    public void test17496() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + true + "'", boolean12 == true);
// flaky:         org.junit.Assert.assertEquals("'" + str17 + "' != '" + "HikariPool-47588" + "'", str17, "HikariPool-47588");
// flaky:         org.junit.Assert.assertEquals("'" + str18 + "' != '" + "HikariPool-47588" + "'", str18, "HikariPool-47588");
    ...
    public void test17497() throws Throwable {
        ...
        org.junit.Assert.assertNotNull(properties58);
        org.junit.Assert.assertEquals("'" + str65 + "' != '" + "HikariPool-489" + "'", str65, "HikariPool-489");
    }
    ...
    public void test17500() throws Throwable {
        ...
        org.junit.Assert.assertNull(str1);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 10 + "'", int2 == 10);
// flaky:         org.junit.Assert.assertEquals("'" + str5 + "' != '" + "HikariPool-47596" + "'", str5, "HikariPool-47596");
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 3 + "'", int6 == 3);
    }
}
