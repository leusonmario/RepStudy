...
public class RegressionTest51 {
    ...
    public void test25666() throws Throwable {
        ...
        java.util.Map.Entry<java.lang.String, java.lang.String> strEntry36 = response26.scanHeaders("hi!");
        ...
        response26.charset = "";
        response26.statusCode = 32;
        org.jsoup.Connection.Response response49 = response26.cookie("hi!", "");
        // The following exception was thrown during execution in test generation
        try {
