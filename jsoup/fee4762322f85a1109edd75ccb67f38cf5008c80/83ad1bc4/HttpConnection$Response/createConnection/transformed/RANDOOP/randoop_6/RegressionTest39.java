...
public class RegressionTest39 {
    ...
    public void test19525() throws Throwable {
        ...
        response10.numRedirects = (short) 100;
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 0 + "'", int2 == 0);
        org.junit.Assert.assertNotNull(strMap5);
    ...
    public void test19537() throws Throwable {
        ...
        java.lang.String str32 = response16.getHeaderCaseInsensitive("hi!");
        java.lang.String str33 = response16.charset;
        response16.statusCode = '4';
        java.nio.ByteBuffer byteBuffer36 = null;
        response16.byteData = byteBuffer36;
...
// flaky:             org.junit.Assert.fail("Expected exception of type java.io.IOException; message: Too many redirects occurred trying to load URL null");
    ...
    public void test19594() throws Throwable {
        ...
        org.jsoup.Connection.Response response34 = response22.cookie("hi!", "hi!");
    ...
    public void test19637() throws Throwable {
        ...
        boolean boolean28 = response13.hasHeaderWithValue("hi!", "hi!");
        org.jsoup.Connection.Response response31 = response13.header("hi!", "hi!");
        boolean boolean32 = response13.executed;
        org.jsoup.Connection.Response response34 = response13.removeHeader("hi!");
        java.lang.String str36 = response13.header("hi!");
        int int37 = response13.statusCode;
        // The following exception was thrown during execution in test generation
        try {
...
// flaky:             org.junit.Assert.fail("Expected exception of type java.io.IOException; message: Too many redirects occurred trying to load URL null");
    ...
    public void test19863() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            response8.setupFromConnection(httpURLConnection9, response10);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        // Expected exception.
        }
