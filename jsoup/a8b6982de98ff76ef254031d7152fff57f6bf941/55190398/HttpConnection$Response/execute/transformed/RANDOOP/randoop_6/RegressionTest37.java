...
public class RegressionTest37 {
    ...
    public void test18501() throws Throwable {
        ...
        boolean boolean20 = response16.hasHeaderWithValue("Location", "hi!");
    ...
    public void test18516() throws Throwable {
        ...
        boolean boolean16 = response14.hasHeader("Location");
        org.junit.Assert.assertNotNull(response4);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
    ...
    public void test18517() throws Throwable {
        ...
        response1.contentType = "Location";
        java.util.Map.Entry<java.lang.String, java.lang.String> strEntry32 = response1.scanHeaders("");
        response1.executed = false;
        org.junit.Assert.assertNull(strEntry5);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 0 + "'", int8 == 0);
        org.junit.Assert.assertNull(byteBuffer11);
    ...
    public void test18569() throws Throwable {
        ...
        org.jsoup.Connection.Response response30 = response16.cookie("Location", "Location");
        int int31 = response16.numRedirects;
        java.lang.String str33 = response16.cookie("Location");
        response16.contentType = "hi!";
        org.jsoup.Connection.Response response37 = response16.removeCookie("Location");
        // The following exception was thrown during execution in test generation
        try {
            response1.setupFromConnection(httpURLConnection14, response37);
    ...
    public void test18602() throws Throwable {
        ...
        java.lang.String str7 = response4.header("Location");
