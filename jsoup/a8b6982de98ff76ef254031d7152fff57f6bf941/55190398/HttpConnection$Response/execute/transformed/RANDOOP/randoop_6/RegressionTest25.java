...
public class RegressionTest25 {
    ...
    public void test12553() throws Throwable {
        ...
        response1.numRedirects = (byte) 100;
        org.jsoup.Connection.Response response10 = response1.header("Location", "hi!");
...
// flaky:             org.junit.Assert.fail("Expected exception of type java.io.IOException; message: Too many redirects occurred trying to load URL null");
    ...
    public void test12632() throws Throwable {
        ...
        response25.charset = "Location";
        boolean boolean30 = response25.hasHeaderWithValue("hi!", "Location");
        response25.numRedirects = (byte) 100;
        java.lang.String str34 = response25.header("hi!");
        org.jsoup.Connection.Request request35 = null;
        response25.req = request35;
        org.jsoup.Connection.Response response39 = response25.cookie("hi!", "hi!");
        // The following exception was thrown during execution in test generation
        try {
            response1.setupFromConnection(httpURLConnection23, response39);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        // Expected exception.
        }
    ...
    public void test12645() throws Throwable {
        ...
        response28.numRedirects = '#';
        org.jsoup.Connection.Response response44 = response28.removeHeader("Location");
        // The following exception was thrown during execution in test generation
        try {
            response1.setupFromConnection(httpURLConnection26, response44);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        // Expected exception.
        }
    ...
    public void test12727() throws Throwable {
        ...
        java.nio.ByteBuffer byteBuffer37 = response1.byteData;
        org.jsoup.Connection.Response response40 = response1.header("Location", "hi!");
        ...
        org.jsoup.Connection.Response response46 = response43.header("hi!", "");
        response43.charset = "";
        response43.statusMessage = "";
        java.lang.String str52 = response43.getHeaderCaseInsensitive("");
        boolean boolean53 = response43.executed;
        java.nio.ByteBuffer byteBuffer54 = response43.byteData;
        java.lang.String str56 = response43.header("Location");
        boolean boolean57 = response43.executed;
        response43.charset = "";
        boolean boolean60 = response43.executed;
        // The following exception was thrown during execution in test generation
        try {
            response1.setupFromConnection(httpURLConnection41, (org.jsoup.Connection.Response) response43);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        // Expected exception.
        }
    ...
    public void test12754() throws Throwable {
        ...
        org.jsoup.Connection.Response response36 = response22.header("hi!", "");
        java.util.Map<java.lang.String, java.lang.String> strMap37 = response22.headers();
        org.jsoup.Connection.Response response40 = response22.cookie("Location", "Location");
    ...
    public void test12875() throws Throwable {
        ...
        org.jsoup.Connection.Response response23 = response2.header("hi!", "hi!");
    ...
    public void test12931() throws Throwable {
        ...
        response2.charset = "Location";
        response2.statusMessage = "";
        boolean boolean25 = response2.hasHeader("Location");
        // The following exception was thrown during execution in test generation
        try {
            org.jsoup.helper.HttpConnection.Response response26 = org.jsoup.helper.HttpConnection.Response.execute(request0, response2);
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalArgumentException; message: Request must not be null");
    ...
    public void test12959() throws Throwable {
        ...
        org.jsoup.Connection.Response response16 = response11.removeCookie("Location");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertNull(strEntry8);
        org.junit.Assert.assertNull(str9);
        org.junit.Assert.assertNull(str10);
    ...
    public void test13000() throws Throwable {
        ...
        java.lang.String str30 = response21.contentType();
        org.junit.Assert.assertNull(strEntry5);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 0 + "'", int8 == 0);
        org.junit.Assert.assertNull(byteBuffer11);
        org.junit.Assert.assertNotNull(response16);
