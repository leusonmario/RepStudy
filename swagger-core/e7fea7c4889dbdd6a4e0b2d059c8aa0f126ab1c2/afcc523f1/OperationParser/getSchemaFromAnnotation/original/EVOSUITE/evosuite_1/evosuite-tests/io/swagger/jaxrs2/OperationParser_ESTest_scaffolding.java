...
public class OperationParser_ESTest_scaffolding {
  ...
  public static void setSystemProperties() {
    ...
    java.lang.System.setProperty("user.dir", "/home/CIN/lmps2/semantic-conflict-study/SMAT/output-test-dest/swagger-core/e7fea7c4889dbdd6a4e0b2d059c8aa0f126ab1c2/evosuite_1"); 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OperationParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "io.swagger.oas.models.media.BooleanSchema",
      ...
      "io.swagger.util.PrimitiveType$DateStub",
      ...
      "io.swagger.oas.models.media.NumberSchema",
      ...
      "io.swagger.converter.ModelConverterContext",
      ...
      "io.swagger.oas.models.media.FileSchema",
      ...
      "io.swagger.jackson.JAXBAnnotationsHelper",
      ...
      "io.swagger.util.PrimitiveType$16",
      "io.swagger.util.PrimitiveType$17",
      "com.fasterxml.jackson.databind.cfg.ConfigFeature",
      "org.apache.commons.lang3.math.NumberUtils",
      "io.swagger.util.PrimitiveType$10",
      "io.swagger.util.PrimitiveType$11",
      "com.fasterxml.jackson.databind.SerializationFeature",
      "io.swagger.util.PrimitiveType$14",
      "io.swagger.util.PrimitiveType$15",
      "io.swagger.util.PrimitiveType$12",
      "io.swagger.util.PrimitiveType$13"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("io.swagger.oas.annotations.ExternalDocumentation", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.Parameter", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.info.Contact", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.info.Info", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.info.License", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.links.Link", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.links.LinkParameters", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.media.ArraySchema", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.media.Content", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.media.ExampleObject", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.media.Schema", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.parameters.RequestBody", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.responses.ApiResponse", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.servers.Server", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.oas.annotations.servers.ServerVariable", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.ws.rs.Produces", false, OperationParser_ESTest_scaffolding.class.getClassLoader()));
  }
