...
public class PushManager_ESTest extends PushManager_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ApnsEnvironment apnsEnvironment0 = new ApnsEnvironment("", (-1813), "", (-1813));
      ...
      try {
        pushManager0 = new PushManager<KnownBadPushNotification>(apnsEnvironment0, (SSLContext) null, (-1813), (NioEventLoopGroup) null, (ExecutorService) null, linkedTransferQueue0);
